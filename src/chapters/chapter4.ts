...
export const chapter4Levels: Chapter4Level[] = [
  {
    name: "Inline display",
    doThis: "Set the display mode of plates to inline",
    selector: "plate",
    cssRulesHidden: {
      ".table-content": ["width: 800px", "min-height: 360px"],
      plate: ["display:block", "padding:10px"],
    },
    cssRules: {},
    wrapperClass: "inline-layout",
    syntax: "display: inline",
    help: `<p>The <code>display</code> property sets whether an element is displayed <b>inline</b> or as a <b>block</b> and what layout is used for its children (<b>flex</b> or <b>grid</b>).</p>
    ...
    This is a line of text including elements that we want to become inline. Here is a plate containing the letter "A":
    <plate>A</plate>, then another plate with a longer label:
    <plate>Plate B</plate> ;
...
border-<dir>-width: <dim>`,
  ...
  },
  {
    ...
    doThis:
      "Add a 20px vertical margin between bentos and center them horizontally",
    selector: "bento",
    cssRulesHidden: {
      ".table-content": ["width: 800px", "min-height: 360px"],
    },
