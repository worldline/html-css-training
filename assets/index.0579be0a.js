(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function s(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerpolicy&&(o.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?o.credentials="include":n.crossorigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(n){if(n.ep)return;n.ep=!0;const o=s(n);fetch(n.href,o)}})();function Zi(e,t){const s=Object.create(null),i=e.split(",");for(let n=0;n<i.length;n++)s[i[n]]=!0;return t?n=>!!s[n.toLowerCase()]:n=>!!s[n]}const fl="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",gl=Zi(fl);function Ao(e){return!!e||e===""}function Ve(e){if(B(e)){const t={};for(let s=0;s<e.length;s++){const i=e[s],n=pe(i)?yl(i):Ve(i);if(n)for(const o in n)t[o]=n[o]}return t}else{if(pe(e))return e;if(ne(e))return e}}const ml=/;(?![^(]*\))/g,bl=/:(.+)/;function yl(e){const t={};return e.split(ml).forEach(s=>{if(s){const i=s.split(bl);i.length>1&&(t[i[0].trim()]=i[1].trim())}}),t}function we(e){let t="";if(pe(e))t=e;else if(B(e))for(let s=0;s<e.length;s++){const i=we(e[s]);i&&(t+=i+" ")}else if(ne(e))for(const s in e)e[s]&&(t+=s+" ");return t.trim()}function Oo(e){if(!e)return null;let{class:t,style:s}=e;return t&&!pe(t)&&(e.class=we(t)),s&&(e.style=Ve(s)),e}const U=e=>pe(e)?e:e==null?"":B(e)||ne(e)&&(e.toString===jo||!q(e.toString))?JSON.stringify(e,Mo,2):String(e),Mo=(e,t)=>t&&t.__v_isRef?Mo(e,t.value):Bt(t)?{[`Map(${t.size})`]:[...t.entries()].reduce((s,[i,n])=>(s[`${i} =>`]=n,s),{})}:Eo(t)?{[`Set(${t.size})`]:[...t.values()]}:ne(t)&&!B(t)&&!No(t)?String(t):t,ee={},zt=[],ze=()=>{},vl=()=>!1,wl=/^on[^a-z]/,Js=e=>wl.test(e),en=e=>e.startsWith("onUpdate:"),Te=Object.assign,tn=(e,t)=>{const s=e.indexOf(t);s>-1&&e.splice(s,1)},xl=Object.prototype.hasOwnProperty,Y=(e,t)=>xl.call(e,t),B=Array.isArray,Bt=e=>Xs(e)==="[object Map]",Eo=e=>Xs(e)==="[object Set]",q=e=>typeof e=="function",pe=e=>typeof e=="string",sn=e=>typeof e=="symbol",ne=e=>e!==null&&typeof e=="object",Ho=e=>ne(e)&&q(e.then)&&q(e.catch),jo=Object.prototype.toString,Xs=e=>jo.call(e),_l=e=>Xs(e).slice(8,-1),No=e=>Xs(e)==="[object Object]",nn=e=>pe(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,Ms=Zi(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Qs=e=>{const t=Object.create(null);return s=>t[s]||(t[s]=e(s))},kl=/-(\w)/g,Ge=Qs(e=>e.replace(kl,(t,s)=>s?s.toUpperCase():"")),Tl=/\B([A-Z])/g,Mt=Qs(e=>e.replace(Tl,"-$1").toLowerCase()),Zs=Qs(e=>e.charAt(0).toUpperCase()+e.slice(1)),yi=Qs(e=>e?`on${Zs(e)}`:""),us=(e,t)=>!Object.is(e,t),vi=(e,t)=>{for(let s=0;s<e.length;s++)e[s](t)},js=(e,t,s)=>{Object.defineProperty(e,t,{configurable:!0,enumerable:!1,value:s})},$l=e=>{const t=parseFloat(e);return isNaN(t)?e:t};let Mn;const Sl=()=>Mn||(Mn=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});let Ie;class Cl{constructor(t=!1){this.active=!0,this.effects=[],this.cleanups=[],!t&&Ie&&(this.parent=Ie,this.index=(Ie.scopes||(Ie.scopes=[])).push(this)-1)}run(t){if(this.active){const s=Ie;try{return Ie=this,t()}finally{Ie=s}}}on(){Ie=this}off(){Ie=this.parent}stop(t){if(this.active){let s,i;for(s=0,i=this.effects.length;s<i;s++)this.effects[s].stop();for(s=0,i=this.cleanups.length;s<i;s++)this.cleanups[s]();if(this.scopes)for(s=0,i=this.scopes.length;s<i;s++)this.scopes[s].stop(!0);if(this.parent&&!t){const n=this.parent.scopes.pop();n&&n!==this&&(this.parent.scopes[this.index]=n,n.index=this.index)}this.active=!1}}}function Pl(e,t=Ie){t&&t.active&&t.effects.push(e)}function Ll(){return Ie}function Rl(e){Ie&&Ie.cleanups.push(e)}const on=e=>{const t=new Set(e);return t.w=0,t.n=0,t},Fo=e=>(e.w&bt)>0,Do=e=>(e.n&bt)>0,Il=({deps:e})=>{if(e.length)for(let t=0;t<e.length;t++)e[t].w|=bt},Al=e=>{const{deps:t}=e;if(t.length){let s=0;for(let i=0;i<t.length;i++){const n=t[i];Fo(n)&&!Do(n)?n.delete(e):t[s++]=n,n.w&=~bt,n.n&=~bt}t.length=s}},Li=new WeakMap;let ls=0,bt=1;const Ri=30;let Fe;const Rt=Symbol(""),Ii=Symbol("");class an{constructor(t,s=null,i){this.fn=t,this.scheduler=s,this.active=!0,this.deps=[],this.parent=void 0,Pl(this,i)}run(){if(!this.active)return this.fn();let t=Fe,s=gt;for(;t;){if(t===this)return;t=t.parent}try{return this.parent=Fe,Fe=this,gt=!0,bt=1<<++ls,ls<=Ri?Il(this):En(this),this.fn()}finally{ls<=Ri&&Al(this),bt=1<<--ls,Fe=this.parent,gt=s,this.parent=void 0,this.deferStop&&this.stop()}}stop(){Fe===this?this.deferStop=!0:this.active&&(En(this),this.onStop&&this.onStop(),this.active=!1)}}function En(e){const{deps:t}=e;if(t.length){for(let s=0;s<t.length;s++)t[s].delete(e);t.length=0}}let gt=!0;const zo=[];function Zt(){zo.push(gt),gt=!1}function es(){const e=zo.pop();gt=e===void 0?!0:e}function Oe(e,t,s){if(gt&&Fe){let i=Li.get(e);i||Li.set(e,i=new Map);let n=i.get(s);n||i.set(s,n=on()),Bo(n)}}function Bo(e,t){let s=!1;ls<=Ri?Do(e)||(e.n|=bt,s=!Fo(e)):s=!e.has(Fe),s&&(e.add(Fe),Fe.deps.push(e))}function nt(e,t,s,i,n,o){const a=Li.get(e);if(!a)return;let l=[];if(t==="clear")l=[...a.values()];else if(s==="length"&&B(e))a.forEach((r,d)=>{(d==="length"||d>=i)&&l.push(r)});else switch(s!==void 0&&l.push(a.get(s)),t){case"add":B(e)?nn(s)&&l.push(a.get("length")):(l.push(a.get(Rt)),Bt(e)&&l.push(a.get(Ii)));break;case"delete":B(e)||(l.push(a.get(Rt)),Bt(e)&&l.push(a.get(Ii)));break;case"set":Bt(e)&&l.push(a.get(Rt));break}if(l.length===1)l[0]&&Ai(l[0]);else{const r=[];for(const d of l)d&&r.push(...d);Ai(on(r))}}function Ai(e,t){const s=B(e)?e:[...e];for(const i of s)i.computed&&Hn(i);for(const i of s)i.computed||Hn(i)}function Hn(e,t){(e!==Fe||e.allowRecurse)&&(e.scheduler?e.scheduler():e.run())}const Ol=Zi("__proto__,__v_isRef,__isVue"),qo=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(sn)),Ml=ln(),El=ln(!1,!0),Hl=ln(!0),jn=jl();function jl(){const e={};return["includes","indexOf","lastIndexOf"].forEach(t=>{e[t]=function(...s){const i=G(this);for(let o=0,a=this.length;o<a;o++)Oe(i,"get",o+"");const n=i[t](...s);return n===-1||n===!1?i[t](...s.map(G)):n}}),["push","pop","shift","unshift","splice"].forEach(t=>{e[t]=function(...s){Zt();const i=G(this)[t].apply(this,s);return es(),i}}),e}function ln(e=!1,t=!1){return function(i,n,o){if(n==="__v_isReactive")return!e;if(n==="__v_isReadonly")return e;if(n==="__v_isShallow")return t;if(n==="__v_raw"&&o===(e?t?Zl:Vo:t?Ko:Yo).get(i))return i;const a=B(i);if(!e&&a&&Y(jn,n))return Reflect.get(jn,n,o);const l=Reflect.get(i,n,o);return(sn(n)?qo.has(n):Ol(n))||(e||Oe(i,"get",n),t)?l:ve(l)?a&&nn(n)?l:l.value:ne(l)?e?Go(l):ti(l):l}}const Nl=Wo(),Fl=Wo(!0);function Wo(e=!1){return function(s,i,n,o){let a=s[i];if(Kt(a)&&ve(a)&&!ve(n))return!1;if(!e&&(!Ns(n)&&!Kt(n)&&(a=G(a),n=G(n)),!B(s)&&ve(a)&&!ve(n)))return a.value=n,!0;const l=B(s)&&nn(i)?Number(i)<s.length:Y(s,i),r=Reflect.set(s,i,n,o);return s===G(o)&&(l?us(n,a)&&nt(s,"set",i,n):nt(s,"add",i,n)),r}}function Dl(e,t){const s=Y(e,t);e[t];const i=Reflect.deleteProperty(e,t);return i&&s&&nt(e,"delete",t,void 0),i}function zl(e,t){const s=Reflect.has(e,t);return(!sn(t)||!qo.has(t))&&Oe(e,"has",t),s}function Bl(e){return Oe(e,"iterate",B(e)?"length":Rt),Reflect.ownKeys(e)}const Uo={get:Ml,set:Nl,deleteProperty:Dl,has:zl,ownKeys:Bl},ql={get:Hl,set(e,t){return!0},deleteProperty(e,t){return!0}},Wl=Te({},Uo,{get:El,set:Fl}),rn=e=>e,ei=e=>Reflect.getPrototypeOf(e);function Ps(e,t,s=!1,i=!1){e=e.__v_raw;const n=G(e),o=G(t);s||(t!==o&&Oe(n,"get",t),Oe(n,"get",o));const{has:a}=ei(n),l=i?rn:s?pn:fs;if(a.call(n,t))return l(e.get(t));if(a.call(n,o))return l(e.get(o));e!==n&&e.get(t)}function Ls(e,t=!1){const s=this.__v_raw,i=G(s),n=G(e);return t||(e!==n&&Oe(i,"has",e),Oe(i,"has",n)),e===n?s.has(e):s.has(e)||s.has(n)}function Rs(e,t=!1){return e=e.__v_raw,!t&&Oe(G(e),"iterate",Rt),Reflect.get(e,"size",e)}function Nn(e){e=G(e);const t=G(this);return ei(t).has.call(t,e)||(t.add(e),nt(t,"add",e,e)),this}function Fn(e,t){t=G(t);const s=G(this),{has:i,get:n}=ei(s);let o=i.call(s,e);o||(e=G(e),o=i.call(s,e));const a=n.call(s,e);return s.set(e,t),o?us(t,a)&&nt(s,"set",e,t):nt(s,"add",e,t),this}function Dn(e){const t=G(this),{has:s,get:i}=ei(t);let n=s.call(t,e);n||(e=G(e),n=s.call(t,e)),i&&i.call(t,e);const o=t.delete(e);return n&&nt(t,"delete",e,void 0),o}function zn(){const e=G(this),t=e.size!==0,s=e.clear();return t&&nt(e,"clear",void 0,void 0),s}function Is(e,t){return function(i,n){const o=this,a=o.__v_raw,l=G(a),r=t?rn:e?pn:fs;return!e&&Oe(l,"iterate",Rt),a.forEach((d,h)=>i.call(n,r(d),r(h),o))}}function As(e,t,s){return function(...i){const n=this.__v_raw,o=G(n),a=Bt(o),l=e==="entries"||e===Symbol.iterator&&a,r=e==="keys"&&a,d=n[e](...i),h=s?rn:t?pn:fs;return!t&&Oe(o,"iterate",r?Ii:Rt),{next(){const{value:u,done:g}=d.next();return g?{value:u,done:g}:{value:l?[h(u[0]),h(u[1])]:h(u),done:g}},[Symbol.iterator](){return this}}}}function pt(e){return function(...t){return e==="delete"?!1:this}}function Ul(){const e={get(o){return Ps(this,o)},get size(){return Rs(this)},has:Ls,add:Nn,set:Fn,delete:Dn,clear:zn,forEach:Is(!1,!1)},t={get(o){return Ps(this,o,!1,!0)},get size(){return Rs(this)},has:Ls,add:Nn,set:Fn,delete:Dn,clear:zn,forEach:Is(!1,!0)},s={get(o){return Ps(this,o,!0)},get size(){return Rs(this,!0)},has(o){return Ls.call(this,o,!0)},add:pt("add"),set:pt("set"),delete:pt("delete"),clear:pt("clear"),forEach:Is(!0,!1)},i={get(o){return Ps(this,o,!0,!0)},get size(){return Rs(this,!0)},has(o){return Ls.call(this,o,!0)},add:pt("add"),set:pt("set"),delete:pt("delete"),clear:pt("clear"),forEach:Is(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(o=>{e[o]=As(o,!1,!1),s[o]=As(o,!0,!1),t[o]=As(o,!1,!0),i[o]=As(o,!0,!0)}),[e,s,t,i]}const[Yl,Kl,Vl,Gl]=Ul();function cn(e,t){const s=t?e?Gl:Vl:e?Kl:Yl;return(i,n,o)=>n==="__v_isReactive"?!e:n==="__v_isReadonly"?e:n==="__v_raw"?i:Reflect.get(Y(s,n)&&n in i?s:i,n,o)}const Jl={get:cn(!1,!1)},Xl={get:cn(!1,!0)},Ql={get:cn(!0,!1)},Yo=new WeakMap,Ko=new WeakMap,Vo=new WeakMap,Zl=new WeakMap;function er(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function tr(e){return e.__v_skip||!Object.isExtensible(e)?0:er(_l(e))}function ti(e){return Kt(e)?e:dn(e,!1,Uo,Jl,Yo)}function sr(e){return dn(e,!1,Wl,Xl,Ko)}function Go(e){return dn(e,!0,ql,Ql,Vo)}function dn(e,t,s,i,n){if(!ne(e)||e.__v_raw&&!(t&&e.__v_isReactive))return e;const o=n.get(e);if(o)return o;const a=tr(e);if(a===0)return e;const l=new Proxy(e,a===2?i:s);return n.set(e,l),l}function qt(e){return Kt(e)?qt(e.__v_raw):!!(e&&e.__v_isReactive)}function Kt(e){return!!(e&&e.__v_isReadonly)}function Ns(e){return!!(e&&e.__v_isShallow)}function Jo(e){return qt(e)||Kt(e)}function G(e){const t=e&&e.__v_raw;return t?G(t):e}function Xo(e){return js(e,"__v_skip",!0),e}const fs=e=>ne(e)?ti(e):e,pn=e=>ne(e)?Go(e):e;function Qo(e){gt&&Fe&&(e=G(e),Bo(e.dep||(e.dep=on())))}function Zo(e,t){e=G(e),e.dep&&Ai(e.dep)}function ve(e){return!!(e&&e.__v_isRef===!0)}function Ee(e){return ir(e,!1)}function ir(e,t){return ve(e)?e:new nr(e,t)}class nr{constructor(t,s){this.__v_isShallow=s,this.dep=void 0,this.__v_isRef=!0,this._rawValue=s?t:G(t),this._value=s?t:fs(t)}get value(){return Qo(this),this._value}set value(t){const s=this.__v_isShallow||Ns(t)||Kt(t);t=s?t:G(t),us(t,this._rawValue)&&(this._rawValue=t,this._value=s?t:fs(t),Zo(this))}}function k(e){return ve(e)?e.value:e}const or={get:(e,t,s)=>k(Reflect.get(e,t,s)),set:(e,t,s,i)=>{const n=e[t];return ve(n)&&!ve(s)?(n.value=s,!0):Reflect.set(e,t,s,i)}};function ea(e){return qt(e)?e:new Proxy(e,or)}var ta;class ar{constructor(t,s,i,n){this._setter=s,this.dep=void 0,this.__v_isRef=!0,this[ta]=!1,this._dirty=!0,this.effect=new an(t,()=>{this._dirty||(this._dirty=!0,Zo(this))}),this.effect.computed=this,this.effect.active=this._cacheable=!n,this.__v_isReadonly=i}get value(){const t=G(this);return Qo(t),(t._dirty||!t._cacheable)&&(t._dirty=!1,t._value=t.effect.run()),t._value}set value(t){this._setter(t)}}ta="__v_isReadonly";function lr(e,t,s=!1){let i,n;const o=q(e);return o?(i=e,n=ze):(i=e.get,n=e.set),new ar(i,n,o||!n,s)}function mt(e,t,s,i){let n;try{n=i?e(...i):e()}catch(o){si(o,t,s)}return n}function Be(e,t,s,i){if(q(e)){const o=mt(e,t,s,i);return o&&Ho(o)&&o.catch(a=>{si(a,t,s)}),o}const n=[];for(let o=0;o<e.length;o++)n.push(Be(e[o],t,s,i));return n}function si(e,t,s,i=!0){const n=t?t.vnode:null;if(t){let o=t.parent;const a=t.proxy,l=s;for(;o;){const d=o.ec;if(d){for(let h=0;h<d.length;h++)if(d[h](e,a,l)===!1)return}o=o.parent}const r=t.appContext.config.errorHandler;if(r){mt(r,null,10,[e,a,l]);return}}rr(e,s,n,i)}function rr(e,t,s,i=!0){console.error(e)}let gs=!1,Oi=!1;const ye=[];let Ke=0;const Wt=[];let et=null,Pt=0;const sa=Promise.resolve();let hn=null;function Je(e){const t=hn||sa;return e?t.then(this?e.bind(this):e):t}function cr(e){let t=Ke+1,s=ye.length;for(;t<s;){const i=t+s>>>1;ms(ye[i])<e?t=i+1:s=i}return t}function un(e){(!ye.length||!ye.includes(e,gs&&e.allowRecurse?Ke+1:Ke))&&(e.id==null?ye.push(e):ye.splice(cr(e.id),0,e),ia())}function ia(){!gs&&!Oi&&(Oi=!0,hn=sa.then(oa))}function dr(e){const t=ye.indexOf(e);t>Ke&&ye.splice(t,1)}function pr(e){B(e)?Wt.push(...e):(!et||!et.includes(e,e.allowRecurse?Pt+1:Pt))&&Wt.push(e),ia()}function Bn(e,t=gs?Ke+1:0){for(;t<ye.length;t++){const s=ye[t];s&&s.pre&&(ye.splice(t,1),t--,s())}}function na(e){if(Wt.length){const t=[...new Set(Wt)];if(Wt.length=0,et){et.push(...t);return}for(et=t,et.sort((s,i)=>ms(s)-ms(i)),Pt=0;Pt<et.length;Pt++)et[Pt]();et=null,Pt=0}}const ms=e=>e.id==null?1/0:e.id,hr=(e,t)=>{const s=ms(e)-ms(t);if(s===0){if(e.pre&&!t.pre)return-1;if(t.pre&&!e.pre)return 1}return s};function oa(e){Oi=!1,gs=!0,ye.sort(hr);const t=ze;try{for(Ke=0;Ke<ye.length;Ke++){const s=ye[Ke];s&&s.active!==!1&&mt(s,null,14)}}finally{Ke=0,ye.length=0,na(),gs=!1,hn=null,(ye.length||Wt.length)&&oa()}}function ur(e,t,...s){if(e.isUnmounted)return;const i=e.vnode.props||ee;let n=s;const o=t.startsWith("update:"),a=o&&t.slice(7);if(a&&a in i){const h=`${a==="modelValue"?"model":a}Modifiers`,{number:u,trim:g}=i[h]||ee;g&&(n=s.map(_=>_.trim())),u&&(n=s.map($l))}let l,r=i[l=yi(t)]||i[l=yi(Ge(t))];!r&&o&&(r=i[l=yi(Mt(t))]),r&&Be(r,e,6,n);const d=i[l+"Once"];if(d){if(!e.emitted)e.emitted={};else if(e.emitted[l])return;e.emitted[l]=!0,Be(d,e,6,n)}}function aa(e,t,s=!1){const i=t.emitsCache,n=i.get(e);if(n!==void 0)return n;const o=e.emits;let a={},l=!1;if(!q(e)){const r=d=>{const h=aa(d,t,!0);h&&(l=!0,Te(a,h))};!s&&t.mixins.length&&t.mixins.forEach(r),e.extends&&r(e.extends),e.mixins&&e.mixins.forEach(r)}return!o&&!l?(ne(e)&&i.set(e,null),null):(B(o)?o.forEach(r=>a[r]=null):Te(a,o),ne(e)&&i.set(e,a),a)}function ii(e,t){return!e||!Js(t)?!1:(t=t.slice(2).replace(/Once$/,""),Y(e,t[0].toLowerCase()+t.slice(1))||Y(e,Mt(t))||Y(e,t))}let Pe=null,ni=null;function Fs(e){const t=Pe;return Pe=e,ni=e&&e.type.__scopeId||null,t}function He(e){ni=e}function je(){ni=null}const fr=e=>Le;function Le(e,t=Pe,s){if(!t||e._n)return e;const i=(...n)=>{i._d&&Qn(-1);const o=Fs(t),a=e(...n);return Fs(o),i._d&&Qn(1),a};return i._n=!0,i._c=!0,i._d=!0,i}function wi(e){const{type:t,vnode:s,proxy:i,withProxy:n,props:o,propsOptions:[a],slots:l,attrs:r,emit:d,render:h,renderCache:u,data:g,setupState:_,ctx:M,inheritAttrs:j}=e;let L,I;const A=Fs(e);try{if(s.shapeFlag&4){const D=n||i;L=Ye(h.call(D,D,u,o,_,g,M)),I=r}else{const D=t;L=Ye(D.length>1?D(o,{attrs:r,slots:l,emit:d}):D(o,null)),I=t.props?r:gr(r)}}catch(D){cs.length=0,si(D,e,1),L=W(vt)}let O=L;if(I&&j!==!1){const D=Object.keys(I),{shapeFlag:oe}=O;D.length&&oe&7&&(a&&D.some(en)&&(I=mr(I,a)),O=Vt(O,I))}return s.dirs&&(O=Vt(O),O.dirs=O.dirs?O.dirs.concat(s.dirs):s.dirs),s.transition&&(O.transition=s.transition),L=O,Fs(A),L}const gr=e=>{let t;for(const s in e)(s==="class"||s==="style"||Js(s))&&((t||(t={}))[s]=e[s]);return t},mr=(e,t)=>{const s={};for(const i in e)(!en(i)||!(i.slice(9)in t))&&(s[i]=e[i]);return s};function br(e,t,s){const{props:i,children:n,component:o}=e,{props:a,children:l,patchFlag:r}=t,d=o.emitsOptions;if(t.dirs||t.transition)return!0;if(s&&r>=0){if(r&1024)return!0;if(r&16)return i?qn(i,a,d):!!a;if(r&8){const h=t.dynamicProps;for(let u=0;u<h.length;u++){const g=h[u];if(a[g]!==i[g]&&!ii(d,g))return!0}}}else return(n||l)&&(!l||!l.$stable)?!0:i===a?!1:i?a?qn(i,a,d):!0:!!a;return!1}function qn(e,t,s){const i=Object.keys(t);if(i.length!==Object.keys(e).length)return!0;for(let n=0;n<i.length;n++){const o=i[n];if(t[o]!==e[o]&&!ii(s,o))return!0}return!1}function yr({vnode:e,parent:t},s){for(;t&&t.subTree===e;)(e=t.vnode).el=s,t=t.parent}const vr=e=>e.__isSuspense;function wr(e,t){t&&t.pendingBranch?B(e)?t.effects.push(...e):t.effects.push(e):pr(e)}function xr(e,t){if(be){let s=be.provides;const i=be.parent&&be.parent.provides;i===s&&(s=be.provides=Object.create(i)),s[e]=t}}function xi(e,t,s=!1){const i=be||Pe;if(i){const n=i.parent==null?i.vnode.appContext&&i.vnode.appContext.provides:i.parent.provides;if(n&&e in n)return n[e];if(arguments.length>1)return s&&q(t)?t.call(i.proxy):t}}const Wn={};function Ut(e,t,s){return la(e,t,s)}function la(e,t,{immediate:s,deep:i,flush:n,onTrack:o,onTrigger:a}=ee){const l=be;let r,d=!1,h=!1;if(ve(e)?(r=()=>e.value,d=Ns(e)):qt(e)?(r=()=>e,i=!0):B(e)?(h=!0,d=e.some(I=>qt(I)||Ns(I)),r=()=>e.map(I=>{if(ve(I))return I.value;if(qt(I))return Dt(I);if(q(I))return mt(I,l,2)})):q(e)?t?r=()=>mt(e,l,2):r=()=>{if(!(l&&l.isUnmounted))return u&&u(),Be(e,l,3,[g])}:r=ze,t&&i){const I=r;r=()=>Dt(I())}let u,g=I=>{u=L.onStop=()=>{mt(I,l,4)}};if(vs)return g=ze,t?s&&Be(t,l,3,[r(),h?[]:void 0,g]):r(),ze;let _=h?[]:Wn;const M=()=>{if(!!L.active)if(t){const I=L.run();(i||d||(h?I.some((A,O)=>us(A,_[O])):us(I,_)))&&(u&&u(),Be(t,l,3,[I,_===Wn?void 0:_,g]),_=I)}else L.run()};M.allowRecurse=!!t;let j;n==="sync"?j=M:n==="post"?j=()=>Se(M,l&&l.suspense):(M.pre=!0,l&&(M.id=l.uid),j=()=>un(M));const L=new an(r,j);return t?s?M():_=L.run():n==="post"?Se(L.run.bind(L),l&&l.suspense):L.run(),()=>{L.stop(),l&&l.scope&&tn(l.scope.effects,L)}}function _r(e,t,s){const i=this.proxy,n=pe(e)?e.includes(".")?ra(i,e):()=>i[e]:e.bind(i,i);let o;q(t)?o=t:(o=t.handler,s=t);const a=be;Gt(this);const l=la(n,o.bind(i),s);return a?Gt(a):It(),l}function ra(e,t){const s=t.split(".");return()=>{let i=e;for(let n=0;n<s.length&&i;n++)i=i[s[n]];return i}}function Dt(e,t){if(!ne(e)||e.__v_skip||(t=t||new Set,t.has(e)))return e;if(t.add(e),ve(e))Dt(e.value,t);else if(B(e))for(let s=0;s<e.length;s++)Dt(e[s],t);else if(Eo(e)||Bt(e))e.forEach(s=>{Dt(s,t)});else if(No(e))for(const s in e)Dt(e[s],t);return e}function Z(e){return q(e)?{setup:e,name:e.name}:e}const rs=e=>!!e.type.__asyncLoader,ca=e=>e.type.__isKeepAlive;function kr(e,t){da(e,"a",t)}function Tr(e,t){da(e,"da",t)}function da(e,t,s=be){const i=e.__wdc||(e.__wdc=()=>{let n=s;for(;n;){if(n.isDeactivated)return;n=n.parent}return e()});if(oi(t,i,s),s){let n=s.parent;for(;n&&n.parent;)ca(n.parent.vnode)&&$r(i,t,s,n),n=n.parent}}function $r(e,t,s,i){const n=oi(t,e,i,!0);ha(()=>{tn(i[t],n)},s)}function oi(e,t,s=be,i=!1){if(s){const n=s[e]||(s[e]=[]),o=t.__weh||(t.__weh=(...a)=>{if(s.isUnmounted)return;Zt(),Gt(s);const l=Be(t,s,e,a);return It(),es(),l});return i?n.unshift(o):n.push(o),o}}const lt=e=>(t,s=be)=>(!vs||e==="sp")&&oi(e,t,s),Sr=lt("bm"),pa=lt("m"),Cr=lt("bu"),Pr=lt("u"),Lr=lt("bum"),ha=lt("um"),Rr=lt("sp"),Ir=lt("rtg"),Ar=lt("rtc");function Or(e,t=be){oi("ec",e,t)}function kt(e,t,s,i){const n=e.dirs,o=t&&t.dirs;for(let a=0;a<n.length;a++){const l=n[a];o&&(l.oldValue=o[a].value);let r=l.dir[i];r&&(Zt(),Be(r,s,8,[e.el,l,e,t]),es())}}const fn="components";function bs(e,t){return ga(fn,e,!0,t)||e}const ua=Symbol();function fa(e){return pe(e)?ga(fn,e,!1)||e:e||ua}function ga(e,t,s=!0,i=!1){const n=Pe||be;if(n){const o=n.type;if(e===fn){const l=ac(o,!1);if(l&&(l===t||l===Ge(t)||l===Zs(Ge(t))))return o}const a=Un(n[e]||o[e],t)||Un(n.appContext[e],t);return!a&&i?o:a}}function Un(e,t){return e&&(e[t]||e[Ge(t)]||e[Zs(Ge(t))])}function Ce(e,t,s,i){let n;const o=s&&s[i];if(B(e)||pe(e)){n=new Array(e.length);for(let a=0,l=e.length;a<l;a++)n[a]=t(e[a],a,void 0,o&&o[a])}else if(typeof e=="number"){n=new Array(e);for(let a=0;a<e;a++)n[a]=t(a+1,a,void 0,o&&o[a])}else if(ne(e))if(e[Symbol.iterator])n=Array.from(e,(a,l)=>t(a,l,void 0,o&&o[l]));else{const a=Object.keys(e);n=new Array(a.length);for(let l=0,r=a.length;l<r;l++){const d=a[l];n[l]=t(e[d],d,l,o&&o[l])}}else n=[];return s&&(s[i]=n),n}function yt(e,t,s={},i,n){if(Pe.isCE||Pe.parent&&rs(Pe.parent)&&Pe.parent.isCE)return W("slot",t==="default"?null:{name:t},i&&i());let o=e[t];o&&o._c&&(o._d=!1),T();const a=o&&ma(o(s)),l=Xe(F,{key:s.key||a&&a.key||`_${t}`},a||(i?i():[]),a&&e._===1?64:-2);return!n&&l.scopeId&&(l.slotScopeIds=[l.scopeId+"-s"]),o&&o._c&&(o._d=!0),l}function ma(e){return e.some(t=>Bs(t)?!(t.type===vt||t.type===F&&!ma(t.children)):!0)?e:null}const Mi=e=>e?Pa(e)?wn(e)||e.proxy:Mi(e.parent):null,Ds=Te(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>Mi(e.parent),$root:e=>Mi(e.root),$emit:e=>e.emit,$options:e=>gn(e),$forceUpdate:e=>e.f||(e.f=()=>un(e.update)),$nextTick:e=>e.n||(e.n=Je.bind(e.proxy)),$watch:e=>_r.bind(e)}),Mr={get({_:e},t){const{ctx:s,setupState:i,data:n,props:o,accessCache:a,type:l,appContext:r}=e;let d;if(t[0]!=="$"){const _=a[t];if(_!==void 0)switch(_){case 1:return i[t];case 2:return n[t];case 4:return s[t];case 3:return o[t]}else{if(i!==ee&&Y(i,t))return a[t]=1,i[t];if(n!==ee&&Y(n,t))return a[t]=2,n[t];if((d=e.propsOptions[0])&&Y(d,t))return a[t]=3,o[t];if(s!==ee&&Y(s,t))return a[t]=4,s[t];Ei&&(a[t]=0)}}const h=Ds[t];let u,g;if(h)return t==="$attrs"&&Oe(e,"get",t),h(e);if((u=l.__cssModules)&&(u=u[t]))return u;if(s!==ee&&Y(s,t))return a[t]=4,s[t];if(g=r.config.globalProperties,Y(g,t))return g[t]},set({_:e},t,s){const{data:i,setupState:n,ctx:o}=e;return n!==ee&&Y(n,t)?(n[t]=s,!0):i!==ee&&Y(i,t)?(i[t]=s,!0):Y(e.props,t)||t[0]==="$"&&t.slice(1)in e?!1:(o[t]=s,!0)},has({_:{data:e,setupState:t,accessCache:s,ctx:i,appContext:n,propsOptions:o}},a){let l;return!!s[a]||e!==ee&&Y(e,a)||t!==ee&&Y(t,a)||(l=o[0])&&Y(l,a)||Y(i,a)||Y(Ds,a)||Y(n.config.globalProperties,a)},defineProperty(e,t,s){return s.get!=null?e._.accessCache[t]=0:Y(s,"value")&&this.set(e,t,s.value,null),Reflect.defineProperty(e,t,s)}};let Ei=!0;function Er(e){const t=gn(e),s=e.proxy,i=e.ctx;Ei=!1,t.beforeCreate&&Yn(t.beforeCreate,e,"bc");const{data:n,computed:o,methods:a,watch:l,provide:r,inject:d,created:h,beforeMount:u,mounted:g,beforeUpdate:_,updated:M,activated:j,deactivated:L,beforeDestroy:I,beforeUnmount:A,destroyed:O,unmounted:D,render:oe,renderTracked:ue,renderTriggered:fe,errorCaptured:ie,serverPrefetch:z,expose:le,inheritAttrs:ae,components:de,directives:xe,filters:ge}=t;if(d&&Hr(d,i,null,e.appContext.config.unwrapInjectedRef),a)for(const re in a){const te=a[re];q(te)&&(i[re]=te.bind(s))}if(n){const re=n.call(s,s);ne(re)&&(e.data=ti(re))}if(Ei=!0,o)for(const re in o){const te=o[re],Qe=q(te)?te.bind(s,s):q(te.get)?te.get.bind(s,s):ze,gi=!q(te)&&q(te.set)?te.set.bind(s):ze,ss=ce({get:Qe,set:gi});Object.defineProperty(i,re,{enumerable:!0,configurable:!0,get:()=>ss.value,set:jt=>ss.value=jt})}if(l)for(const re in l)ba(l[re],i,s,re);if(r){const re=q(r)?r.call(s):r;Reflect.ownKeys(re).forEach(te=>{xr(te,re[te])})}h&&Yn(h,e,"c");function $e(re,te){B(te)?te.forEach(Qe=>re(Qe.bind(s))):te&&re(te.bind(s))}if($e(Sr,u),$e(pa,g),$e(Cr,_),$e(Pr,M),$e(kr,j),$e(Tr,L),$e(Or,ie),$e(Ar,ue),$e(Ir,fe),$e(Lr,A),$e(ha,D),$e(Rr,z),B(le))if(le.length){const re=e.exposed||(e.exposed={});le.forEach(te=>{Object.defineProperty(re,te,{get:()=>s[te],set:Qe=>s[te]=Qe})})}else e.exposed||(e.exposed={});oe&&e.render===ze&&(e.render=oe),ae!=null&&(e.inheritAttrs=ae),de&&(e.components=de),xe&&(e.directives=xe)}function Hr(e,t,s=ze,i=!1){B(e)&&(e=Hi(e));for(const n in e){const o=e[n];let a;ne(o)?"default"in o?a=xi(o.from||n,o.default,!0):a=xi(o.from||n):a=xi(o),ve(a)&&i?Object.defineProperty(t,n,{enumerable:!0,configurable:!0,get:()=>a.value,set:l=>a.value=l}):t[n]=a}}function Yn(e,t,s){Be(B(e)?e.map(i=>i.bind(t.proxy)):e.bind(t.proxy),t,s)}function ba(e,t,s,i){const n=i.includes(".")?ra(s,i):()=>s[i];if(pe(e)){const o=t[e];q(o)&&Ut(n,o)}else if(q(e))Ut(n,e.bind(s));else if(ne(e))if(B(e))e.forEach(o=>ba(o,t,s,i));else{const o=q(e.handler)?e.handler.bind(s):t[e.handler];q(o)&&Ut(n,o,e)}}function gn(e){const t=e.type,{mixins:s,extends:i}=t,{mixins:n,optionsCache:o,config:{optionMergeStrategies:a}}=e.appContext,l=o.get(t);let r;return l?r=l:!n.length&&!s&&!i?r=t:(r={},n.length&&n.forEach(d=>zs(r,d,a,!0)),zs(r,t,a)),ne(t)&&o.set(t,r),r}function zs(e,t,s,i=!1){const{mixins:n,extends:o}=t;o&&zs(e,o,s,!0),n&&n.forEach(a=>zs(e,a,s,!0));for(const a in t)if(!(i&&a==="expose")){const l=jr[a]||s&&s[a];e[a]=l?l(e[a],t[a]):t[a]}return e}const jr={data:Kn,props:St,emits:St,methods:St,computed:St,beforeCreate:_e,created:_e,beforeMount:_e,mounted:_e,beforeUpdate:_e,updated:_e,beforeDestroy:_e,beforeUnmount:_e,destroyed:_e,unmounted:_e,activated:_e,deactivated:_e,errorCaptured:_e,serverPrefetch:_e,components:St,directives:St,watch:Fr,provide:Kn,inject:Nr};function Kn(e,t){return t?e?function(){return Te(q(e)?e.call(this,this):e,q(t)?t.call(this,this):t)}:t:e}function Nr(e,t){return St(Hi(e),Hi(t))}function Hi(e){if(B(e)){const t={};for(let s=0;s<e.length;s++)t[e[s]]=e[s];return t}return e}function _e(e,t){return e?[...new Set([].concat(e,t))]:t}function St(e,t){return e?Te(Te(Object.create(null),e),t):t}function Fr(e,t){if(!e)return t;if(!t)return e;const s=Te(Object.create(null),e);for(const i in t)s[i]=_e(e[i],t[i]);return s}function Dr(e,t,s,i=!1){const n={},o={};js(o,ai,1),e.propsDefaults=Object.create(null),ya(e,t,n,o);for(const a in e.propsOptions[0])a in n||(n[a]=void 0);s?e.props=i?n:sr(n):e.type.props?e.props=n:e.props=o,e.attrs=o}function zr(e,t,s,i){const{props:n,attrs:o,vnode:{patchFlag:a}}=e,l=G(n),[r]=e.propsOptions;let d=!1;if((i||a>0)&&!(a&16)){if(a&8){const h=e.vnode.dynamicProps;for(let u=0;u<h.length;u++){let g=h[u];if(ii(e.emitsOptions,g))continue;const _=t[g];if(r)if(Y(o,g))_!==o[g]&&(o[g]=_,d=!0);else{const M=Ge(g);n[M]=ji(r,l,M,_,e,!1)}else _!==o[g]&&(o[g]=_,d=!0)}}}else{ya(e,t,n,o)&&(d=!0);let h;for(const u in l)(!t||!Y(t,u)&&((h=Mt(u))===u||!Y(t,h)))&&(r?s&&(s[u]!==void 0||s[h]!==void 0)&&(n[u]=ji(r,l,u,void 0,e,!0)):delete n[u]);if(o!==l)for(const u in o)(!t||!Y(t,u)&&!0)&&(delete o[u],d=!0)}d&&nt(e,"set","$attrs")}function ya(e,t,s,i){const[n,o]=e.propsOptions;let a=!1,l;if(t)for(let r in t){if(Ms(r))continue;const d=t[r];let h;n&&Y(n,h=Ge(r))?!o||!o.includes(h)?s[h]=d:(l||(l={}))[h]=d:ii(e.emitsOptions,r)||(!(r in i)||d!==i[r])&&(i[r]=d,a=!0)}if(o){const r=G(s),d=l||ee;for(let h=0;h<o.length;h++){const u=o[h];s[u]=ji(n,r,u,d[u],e,!Y(d,u))}}return a}function ji(e,t,s,i,n,o){const a=e[s];if(a!=null){const l=Y(a,"default");if(l&&i===void 0){const r=a.default;if(a.type!==Function&&q(r)){const{propsDefaults:d}=n;s in d?i=d[s]:(Gt(n),i=d[s]=r.call(null,t),It())}else i=r}a[0]&&(o&&!l?i=!1:a[1]&&(i===""||i===Mt(s))&&(i=!0))}return i}function va(e,t,s=!1){const i=t.propsCache,n=i.get(e);if(n)return n;const o=e.props,a={},l=[];let r=!1;if(!q(e)){const h=u=>{r=!0;const[g,_]=va(u,t,!0);Te(a,g),_&&l.push(..._)};!s&&t.mixins.length&&t.mixins.forEach(h),e.extends&&h(e.extends),e.mixins&&e.mixins.forEach(h)}if(!o&&!r)return ne(e)&&i.set(e,zt),zt;if(B(o))for(let h=0;h<o.length;h++){const u=Ge(o[h]);Vn(u)&&(a[u]=ee)}else if(o)for(const h in o){const u=Ge(h);if(Vn(u)){const g=o[h],_=a[u]=B(g)||q(g)?{type:g}:g;if(_){const M=Xn(Boolean,_.type),j=Xn(String,_.type);_[0]=M>-1,_[1]=j<0||M<j,(M>-1||Y(_,"default"))&&l.push(u)}}}const d=[a,l];return ne(e)&&i.set(e,d),d}function Vn(e){return e[0]!=="$"}function Gn(e){const t=e&&e.toString().match(/^\s*function (\w+)/);return t?t[1]:e===null?"null":""}function Jn(e,t){return Gn(e)===Gn(t)}function Xn(e,t){return B(t)?t.findIndex(s=>Jn(s,e)):q(t)&&Jn(t,e)?0:-1}const wa=e=>e[0]==="_"||e==="$stable",mn=e=>B(e)?e.map(Ye):[Ye(e)],Br=(e,t,s)=>{if(t._n)return t;const i=Le((...n)=>mn(t(...n)),s);return i._c=!1,i},xa=(e,t,s)=>{const i=e._ctx;for(const n in e){if(wa(n))continue;const o=e[n];if(q(o))t[n]=Br(n,o,i);else if(o!=null){const a=mn(o);t[n]=()=>a}}},_a=(e,t)=>{const s=mn(t);e.slots.default=()=>s},qr=(e,t)=>{if(e.vnode.shapeFlag&32){const s=t._;s?(e.slots=G(t),js(t,"_",s)):xa(t,e.slots={})}else e.slots={},t&&_a(e,t);js(e.slots,ai,1)},Wr=(e,t,s)=>{const{vnode:i,slots:n}=e;let o=!0,a=ee;if(i.shapeFlag&32){const l=t._;l?s&&l===1?o=!1:(Te(n,t),!s&&l===1&&delete n._):(o=!t.$stable,xa(t,n)),a=t}else t&&(_a(e,t),a={default:1});if(o)for(const l in n)!wa(l)&&!(l in a)&&delete n[l]};function ka(){return{app:null,config:{isNativeTag:vl,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Ur=0;function Yr(e,t){return function(i,n=null){q(i)||(i=Object.assign({},i)),n!=null&&!ne(n)&&(n=null);const o=ka(),a=new Set;let l=!1;const r=o.app={_uid:Ur++,_component:i,_props:n,_container:null,_context:o,_instance:null,version:cc,get config(){return o.config},set config(d){},use(d,...h){return a.has(d)||(d&&q(d.install)?(a.add(d),d.install(r,...h)):q(d)&&(a.add(d),d(r,...h))),r},mixin(d){return o.mixins.includes(d)||o.mixins.push(d),r},component(d,h){return h?(o.components[d]=h,r):o.components[d]},directive(d,h){return h?(o.directives[d]=h,r):o.directives[d]},mount(d,h,u){if(!l){const g=W(i,n);return g.appContext=o,h&&t?t(g,d):e(g,d,u),l=!0,r._container=d,d.__vue_app__=r,wn(g.component)||g.component.proxy}},unmount(){l&&(e(null,r._container),delete r._container.__vue_app__)},provide(d,h){return o.provides[d]=h,r}};return r}}function Ni(e,t,s,i,n=!1){if(B(e)){e.forEach((g,_)=>Ni(g,t&&(B(t)?t[_]:t),s,i,n));return}if(rs(i)&&!n)return;const o=i.shapeFlag&4?wn(i.component)||i.component.proxy:i.el,a=n?null:o,{i:l,r}=e,d=t&&t.r,h=l.refs===ee?l.refs={}:l.refs,u=l.setupState;if(d!=null&&d!==r&&(pe(d)?(h[d]=null,Y(u,d)&&(u[d]=null)):ve(d)&&(d.value=null)),q(r))mt(r,l,12,[a,h]);else{const g=pe(r),_=ve(r);if(g||_){const M=()=>{if(e.f){const j=g?h[r]:r.value;n?B(j)&&tn(j,o):B(j)?j.includes(o)||j.push(o):g?(h[r]=[o],Y(u,r)&&(u[r]=h[r])):(r.value=[o],e.k&&(h[e.k]=r.value))}else g?(h[r]=a,Y(u,r)&&(u[r]=a)):_&&(r.value=a,e.k&&(h[e.k]=a))};a?(M.id=-1,Se(M,s)):M()}}}const Se=wr;function Kr(e){return Vr(e)}function Vr(e,t){const s=Sl();s.__VUE__=!0;const{insert:i,remove:n,patchProp:o,createElement:a,createText:l,createComment:r,setText:d,setElementText:h,parentNode:u,nextSibling:g,setScopeId:_=ze,cloneNode:M,insertStaticContent:j}=e,L=(c,p,f,y=null,b=null,x=null,S=!1,w=null,$=!!p.dynamicChildren)=>{if(c===p)return;c&&!ns(c,p)&&(y=Cs(c),dt(c,b,x,!0),c=null),p.patchFlag===-2&&($=!1,p.dynamicChildren=null);const{type:v,ref:E,shapeFlag:R}=p;switch(v){case bn:I(c,p,f,y);break;case vt:A(c,p,f,y);break;case _i:c==null&&O(p,f,y,S);break;case F:xe(c,p,f,y,b,x,S,w,$);break;default:R&1?ue(c,p,f,y,b,x,S,w,$):R&6?ge(c,p,f,y,b,x,S,w,$):(R&64||R&128)&&v.process(c,p,f,y,b,x,S,w,$,Nt)}E!=null&&b&&Ni(E,c&&c.ref,x,p||c,!p)},I=(c,p,f,y)=>{if(c==null)i(p.el=l(p.children),f,y);else{const b=p.el=c.el;p.children!==c.children&&d(b,p.children)}},A=(c,p,f,y)=>{c==null?i(p.el=r(p.children||""),f,y):p.el=c.el},O=(c,p,f,y)=>{[c.el,c.anchor]=j(c.children,p,f,y,c.el,c.anchor)},D=({el:c,anchor:p},f,y)=>{let b;for(;c&&c!==p;)b=g(c),i(c,f,y),c=b;i(p,f,y)},oe=({el:c,anchor:p})=>{let f;for(;c&&c!==p;)f=g(c),n(c),c=f;n(p)},ue=(c,p,f,y,b,x,S,w,$)=>{S=S||p.type==="svg",c==null?fe(p,f,y,b,x,S,w,$):le(c,p,b,x,S,w,$)},fe=(c,p,f,y,b,x,S,w)=>{let $,v;const{type:E,props:R,shapeFlag:H,transition:N,patchFlag:K,dirs:J}=c;if(c.el&&M!==void 0&&K===-1)$=c.el=M(c.el);else{if($=c.el=a(c.type,x,R&&R.is,R),H&8?h($,c.children):H&16&&z(c.children,$,null,y,b,x&&E!=="foreignObject",S,w),J&&kt(c,null,y,"created"),R){for(const se in R)se!=="value"&&!Ms(se)&&o($,se,null,R[se],x,c.children,y,b,Ze);"value"in R&&o($,"value",null,R.value),(v=R.onVnodeBeforeMount)&&We(v,y,c)}ie($,c,c.scopeId,S,y)}J&&kt(c,null,y,"beforeMount");const X=(!b||b&&!b.pendingBranch)&&N&&!N.persisted;X&&N.beforeEnter($),i($,p,f),((v=R&&R.onVnodeMounted)||X||J)&&Se(()=>{v&&We(v,y,c),X&&N.enter($),J&&kt(c,null,y,"mounted")},b)},ie=(c,p,f,y,b)=>{if(f&&_(c,f),y)for(let x=0;x<y.length;x++)_(c,y[x]);if(b){let x=b.subTree;if(p===x){const S=b.vnode;ie(c,S,S.scopeId,S.slotScopeIds,b.parent)}}},z=(c,p,f,y,b,x,S,w,$=0)=>{for(let v=$;v<c.length;v++){const E=c[v]=w?ft(c[v]):Ye(c[v]);L(null,E,p,f,y,b,x,S,w)}},le=(c,p,f,y,b,x,S)=>{const w=p.el=c.el;let{patchFlag:$,dynamicChildren:v,dirs:E}=p;$|=c.patchFlag&16;const R=c.props||ee,H=p.props||ee;let N;f&&Tt(f,!1),(N=H.onVnodeBeforeUpdate)&&We(N,f,p,c),E&&kt(p,c,f,"beforeUpdate"),f&&Tt(f,!0);const K=b&&p.type!=="foreignObject";if(v?ae(c.dynamicChildren,v,w,f,y,K,x):S||Qe(c,p,w,null,f,y,K,x,!1),$>0){if($&16)de(w,p,R,H,f,y,b);else if($&2&&R.class!==H.class&&o(w,"class",null,H.class,b),$&4&&o(w,"style",R.style,H.style,b),$&8){const J=p.dynamicProps;for(let X=0;X<J.length;X++){const se=J[X],Ne=R[se],Ft=H[se];(Ft!==Ne||se==="value")&&o(w,se,Ne,Ft,b,c.children,f,y,Ze)}}$&1&&c.children!==p.children&&h(w,p.children)}else!S&&v==null&&de(w,p,R,H,f,y,b);((N=H.onVnodeUpdated)||E)&&Se(()=>{N&&We(N,f,p,c),E&&kt(p,c,f,"updated")},y)},ae=(c,p,f,y,b,x,S)=>{for(let w=0;w<p.length;w++){const $=c[w],v=p[w],E=$.el&&($.type===F||!ns($,v)||$.shapeFlag&70)?u($.el):f;L($,v,E,null,y,b,x,S,!0)}},de=(c,p,f,y,b,x,S)=>{if(f!==y){for(const w in y){if(Ms(w))continue;const $=y[w],v=f[w];$!==v&&w!=="value"&&o(c,w,v,$,S,p.children,b,x,Ze)}if(f!==ee)for(const w in f)!Ms(w)&&!(w in y)&&o(c,w,f[w],null,S,p.children,b,x,Ze);"value"in y&&o(c,"value",f.value,y.value)}},xe=(c,p,f,y,b,x,S,w,$)=>{const v=p.el=c?c.el:l(""),E=p.anchor=c?c.anchor:l("");let{patchFlag:R,dynamicChildren:H,slotScopeIds:N}=p;N&&(w=w?w.concat(N):N),c==null?(i(v,f,y),i(E,f,y),z(p.children,f,E,b,x,S,w,$)):R>0&&R&64&&H&&c.dynamicChildren?(ae(c.dynamicChildren,H,f,b,x,S,w),(p.key!=null||b&&p===b.subTree)&&Ta(c,p,!0)):Qe(c,p,f,E,b,x,S,w,$)},ge=(c,p,f,y,b,x,S,w,$)=>{p.slotScopeIds=w,c==null?p.shapeFlag&512?b.ctx.activate(p,f,y,S,$):_t(p,f,y,b,x,S,$):$e(c,p,$)},_t=(c,p,f,y,b,x,S)=>{const w=c.component=tc(c,y,b);if(ca(c)&&(w.ctx.renderer=Nt),sc(w),w.asyncDep){if(b&&b.registerDep(w,re),!c.el){const $=w.subTree=W(vt);A(null,$,p,f)}return}re(w,c,p,f,b,x,S)},$e=(c,p,f)=>{const y=p.component=c.component;if(br(c,p,f))if(y.asyncDep&&!y.asyncResolved){te(y,p,f);return}else y.next=p,dr(y.update),y.update();else p.el=c.el,y.vnode=p},re=(c,p,f,y,b,x,S)=>{const w=()=>{if(c.isMounted){let{next:E,bu:R,u:H,parent:N,vnode:K}=c,J=E,X;Tt(c,!1),E?(E.el=K.el,te(c,E,S)):E=K,R&&vi(R),(X=E.props&&E.props.onVnodeBeforeUpdate)&&We(X,N,E,K),Tt(c,!0);const se=wi(c),Ne=c.subTree;c.subTree=se,L(Ne,se,u(Ne.el),Cs(Ne),c,b,x),E.el=se.el,J===null&&yr(c,se.el),H&&Se(H,b),(X=E.props&&E.props.onVnodeUpdated)&&Se(()=>We(X,N,E,K),b)}else{let E;const{el:R,props:H}=p,{bm:N,m:K,parent:J}=c,X=rs(p);if(Tt(c,!1),N&&vi(N),!X&&(E=H&&H.onVnodeBeforeMount)&&We(E,J,p),Tt(c,!0),R&&bi){const se=()=>{c.subTree=wi(c),bi(R,c.subTree,c,b,null)};X?p.type.__asyncLoader().then(()=>!c.isUnmounted&&se()):se()}else{const se=c.subTree=wi(c);L(null,se,f,y,c,b,x),p.el=se.el}if(K&&Se(K,b),!X&&(E=H&&H.onVnodeMounted)){const se=p;Se(()=>We(E,J,se),b)}(p.shapeFlag&256||J&&rs(J.vnode)&&J.vnode.shapeFlag&256)&&c.a&&Se(c.a,b),c.isMounted=!0,p=f=y=null}},$=c.effect=new an(w,()=>un(v),c.scope),v=c.update=()=>$.run();v.id=c.uid,Tt(c,!0),v()},te=(c,p,f)=>{p.component=c;const y=c.vnode.props;c.vnode=p,c.next=null,zr(c,p.props,y,f),Wr(c,p.children,f),Zt(),Bn(),es()},Qe=(c,p,f,y,b,x,S,w,$=!1)=>{const v=c&&c.children,E=c?c.shapeFlag:0,R=p.children,{patchFlag:H,shapeFlag:N}=p;if(H>0){if(H&128){ss(v,R,f,y,b,x,S,w,$);return}else if(H&256){gi(v,R,f,y,b,x,S,w,$);return}}N&8?(E&16&&Ze(v,b,x),R!==v&&h(f,R)):E&16?N&16?ss(v,R,f,y,b,x,S,w,$):Ze(v,b,x,!0):(E&8&&h(f,""),N&16&&z(R,f,y,b,x,S,w,$))},gi=(c,p,f,y,b,x,S,w,$)=>{c=c||zt,p=p||zt;const v=c.length,E=p.length,R=Math.min(v,E);let H;for(H=0;H<R;H++){const N=p[H]=$?ft(p[H]):Ye(p[H]);L(c[H],N,f,null,b,x,S,w,$)}v>E?Ze(c,b,x,!0,!1,R):z(p,f,y,b,x,S,w,$,R)},ss=(c,p,f,y,b,x,S,w,$)=>{let v=0;const E=p.length;let R=c.length-1,H=E-1;for(;v<=R&&v<=H;){const N=c[v],K=p[v]=$?ft(p[v]):Ye(p[v]);if(ns(N,K))L(N,K,f,null,b,x,S,w,$);else break;v++}for(;v<=R&&v<=H;){const N=c[R],K=p[H]=$?ft(p[H]):Ye(p[H]);if(ns(N,K))L(N,K,f,null,b,x,S,w,$);else break;R--,H--}if(v>R){if(v<=H){const N=H+1,K=N<E?p[N].el:y;for(;v<=H;)L(null,p[v]=$?ft(p[v]):Ye(p[v]),f,K,b,x,S,w,$),v++}}else if(v>H)for(;v<=R;)dt(c[v],b,x,!0),v++;else{const N=v,K=v,J=new Map;for(v=K;v<=H;v++){const Re=p[v]=$?ft(p[v]):Ye(p[v]);Re.key!=null&&J.set(Re.key,v)}let X,se=0;const Ne=H-K+1;let Ft=!1,In=0;const is=new Array(Ne);for(v=0;v<Ne;v++)is[v]=0;for(v=N;v<=R;v++){const Re=c[v];if(se>=Ne){dt(Re,b,x,!0);continue}let qe;if(Re.key!=null)qe=J.get(Re.key);else for(X=K;X<=H;X++)if(is[X-K]===0&&ns(Re,p[X])){qe=X;break}qe===void 0?dt(Re,b,x,!0):(is[qe-K]=v+1,qe>=In?In=qe:Ft=!0,L(Re,p[qe],f,null,b,x,S,w,$),se++)}const An=Ft?Gr(is):zt;for(X=An.length-1,v=Ne-1;v>=0;v--){const Re=K+v,qe=p[Re],On=Re+1<E?p[Re+1].el:y;is[v]===0?L(null,qe,f,On,b,x,S,w,$):Ft&&(X<0||v!==An[X]?jt(qe,f,On,2):X--)}}},jt=(c,p,f,y,b=null)=>{const{el:x,type:S,transition:w,children:$,shapeFlag:v}=c;if(v&6){jt(c.component.subTree,p,f,y);return}if(v&128){c.suspense.move(p,f,y);return}if(v&64){S.move(c,p,f,Nt);return}if(S===F){i(x,p,f);for(let R=0;R<$.length;R++)jt($[R],p,f,y);i(c.anchor,p,f);return}if(S===_i){D(c,p,f);return}if(y!==2&&v&1&&w)if(y===0)w.beforeEnter(x),i(x,p,f),Se(()=>w.enter(x),b);else{const{leave:R,delayLeave:H,afterLeave:N}=w,K=()=>i(x,p,f),J=()=>{R(x,()=>{K(),N&&N()})};H?H(x,K,J):J()}else i(x,p,f)},dt=(c,p,f,y=!1,b=!1)=>{const{type:x,props:S,ref:w,children:$,dynamicChildren:v,shapeFlag:E,patchFlag:R,dirs:H}=c;if(w!=null&&Ni(w,null,f,c,!0),E&256){p.ctx.deactivate(c);return}const N=E&1&&H,K=!rs(c);let J;if(K&&(J=S&&S.onVnodeBeforeUnmount)&&We(J,p,c),E&6)ul(c.component,f,y);else{if(E&128){c.suspense.unmount(f,y);return}N&&kt(c,null,p,"beforeUnmount"),E&64?c.type.remove(c,p,f,b,Nt,y):v&&(x!==F||R>0&&R&64)?Ze(v,p,f,!1,!0):(x===F&&R&384||!b&&E&16)&&Ze($,p,f),y&&Ln(c)}(K&&(J=S&&S.onVnodeUnmounted)||N)&&Se(()=>{J&&We(J,p,c),N&&kt(c,null,p,"unmounted")},f)},Ln=c=>{const{type:p,el:f,anchor:y,transition:b}=c;if(p===F){hl(f,y);return}if(p===_i){oe(c);return}const x=()=>{n(f),b&&!b.persisted&&b.afterLeave&&b.afterLeave()};if(c.shapeFlag&1&&b&&!b.persisted){const{leave:S,delayLeave:w}=b,$=()=>S(f,x);w?w(c.el,x,$):$()}else x()},hl=(c,p)=>{let f;for(;c!==p;)f=g(c),n(c),c=f;n(p)},ul=(c,p,f)=>{const{bum:y,scope:b,update:x,subTree:S,um:w}=c;y&&vi(y),b.stop(),x&&(x.active=!1,dt(S,c,p,f)),w&&Se(w,p),Se(()=>{c.isUnmounted=!0},p),p&&p.pendingBranch&&!p.isUnmounted&&c.asyncDep&&!c.asyncResolved&&c.suspenseId===p.pendingId&&(p.deps--,p.deps===0&&p.resolve())},Ze=(c,p,f,y=!1,b=!1,x=0)=>{for(let S=x;S<c.length;S++)dt(c[S],p,f,y,b)},Cs=c=>c.shapeFlag&6?Cs(c.component.subTree):c.shapeFlag&128?c.suspense.next():g(c.anchor||c.el),Rn=(c,p,f)=>{c==null?p._vnode&&dt(p._vnode,null,null,!0):L(p._vnode||null,c,p,null,null,null,f),Bn(),na(),p._vnode=c},Nt={p:L,um:dt,m:jt,r:Ln,mt:_t,mc:z,pc:Qe,pbc:ae,n:Cs,o:e};let mi,bi;return t&&([mi,bi]=t(Nt)),{render:Rn,hydrate:mi,createApp:Yr(Rn,mi)}}function Tt({effect:e,update:t},s){e.allowRecurse=t.allowRecurse=s}function Ta(e,t,s=!1){const i=e.children,n=t.children;if(B(i)&&B(n))for(let o=0;o<i.length;o++){const a=i[o];let l=n[o];l.shapeFlag&1&&!l.dynamicChildren&&((l.patchFlag<=0||l.patchFlag===32)&&(l=n[o]=ft(n[o]),l.el=a.el),s||Ta(a,l))}}function Gr(e){const t=e.slice(),s=[0];let i,n,o,a,l;const r=e.length;for(i=0;i<r;i++){const d=e[i];if(d!==0){if(n=s[s.length-1],e[n]<d){t[i]=n,s.push(i);continue}for(o=0,a=s.length-1;o<a;)l=o+a>>1,e[s[l]]<d?o=l+1:a=l;d<e[s[o]]&&(o>0&&(t[i]=s[o-1]),s[o]=i)}}for(o=s.length,a=s[o-1];o-- >0;)s[o]=a,a=t[a];return s}const Jr=e=>e.__isTeleport,F=Symbol(void 0),bn=Symbol(void 0),vt=Symbol(void 0),_i=Symbol(void 0),cs=[];let De=null;function T(e=!1){cs.push(De=e?null:[])}function Xr(){cs.pop(),De=cs[cs.length-1]||null}let ys=1;function Qn(e){ys+=e}function $a(e){return e.dynamicChildren=ys>0?De||zt:null,Xr(),ys>0&&De&&De.push(e),e}function C(e,t,s,i,n,o){return $a(m(e,t,s,i,n,o,!0))}function Xe(e,t,s,i,n){return $a(W(e,t,s,i,n,!0))}function Bs(e){return e?e.__v_isVNode===!0:!1}function ns(e,t){return e.type===t.type&&e.key===t.key}const ai="__vInternal",Sa=({key:e})=>e!=null?e:null,Es=({ref:e,ref_key:t,ref_for:s})=>e!=null?pe(e)||ve(e)||q(e)?{i:Pe,r:e,k:t,f:!!s}:e:null;function m(e,t=null,s=null,i=0,n=null,o=e===F?0:1,a=!1,l=!1){const r={__v_isVNode:!0,__v_skip:!0,type:e,props:t,key:t&&Sa(t),ref:t&&Es(t),scopeId:ni,slotScopeIds:null,children:s,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:o,patchFlag:i,dynamicProps:n,dynamicChildren:null,appContext:null};return l?(vn(r,s),o&128&&e.normalize(r)):s&&(r.shapeFlag|=pe(s)?8:16),ys>0&&!a&&De&&(r.patchFlag>0||o&6)&&r.patchFlag!==32&&De.push(r),r}const W=Qr;function Qr(e,t=null,s=null,i=0,n=null,o=!1){if((!e||e===ua)&&(e=vt),Bs(e)){const l=Vt(e,t,!0);return s&&vn(l,s),ys>0&&!o&&De&&(l.shapeFlag&6?De[De.indexOf(e)]=l:De.push(l)),l.patchFlag|=-2,l}if(lc(e)&&(e=e.__vccOpts),t){t=yn(t);let{class:l,style:r}=t;l&&!pe(l)&&(t.class=we(l)),ne(r)&&(Jo(r)&&!B(r)&&(r=Te({},r)),t.style=Ve(r))}const a=pe(e)?1:vr(e)?128:Jr(e)?64:ne(e)?4:q(e)?2:0;return m(e,t,s,i,n,a,o,!0)}function yn(e){return e?Jo(e)||ai in e?Te({},e):e:null}function Vt(e,t,s=!1){const{props:i,ref:n,patchFlag:o,children:a}=e,l=t?Ca(i||{},t):i;return{__v_isVNode:!0,__v_skip:!0,type:e.type,props:l,key:l&&Sa(l),ref:t&&t.ref?s&&n?B(n)?n.concat(Es(t)):[n,Es(t)]:Es(t):n,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:a,target:e.target,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:t&&e.type!==F?o===-1?16:o|16:o,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:e.transition,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&Vt(e.ssContent),ssFallback:e.ssFallback&&Vt(e.ssFallback),el:e.el,anchor:e.anchor}}function Q(e=" ",t=0){return W(bn,null,e,t)}function ke(e="",t=!1){return t?(T(),Xe(vt,null,e)):W(vt,null,e)}function Ye(e){return e==null||typeof e=="boolean"?W(vt):B(e)?W(F,null,e.slice()):typeof e=="object"?ft(e):W(bn,null,String(e))}function ft(e){return e.el===null||e.memo?e:Vt(e)}function vn(e,t){let s=0;const{shapeFlag:i}=e;if(t==null)t=null;else if(B(t))s=16;else if(typeof t=="object")if(i&65){const n=t.default;n&&(n._c&&(n._d=!1),vn(e,n()),n._c&&(n._d=!0));return}else{s=32;const n=t._;!n&&!(ai in t)?t._ctx=Pe:n===3&&Pe&&(Pe.slots._===1?t._=1:(t._=2,e.patchFlag|=1024))}else q(t)?(t={default:t,_ctx:Pe},s=32):(t=String(t),i&64?(s=16,t=[Q(t)]):s=8);e.children=t,e.shapeFlag|=s}function Ca(...e){const t={};for(let s=0;s<e.length;s++){const i=e[s];for(const n in i)if(n==="class")t.class!==i.class&&(t.class=we([t.class,i.class]));else if(n==="style")t.style=Ve([t.style,i.style]);else if(Js(n)){const o=t[n],a=i[n];a&&o!==a&&!(B(o)&&o.includes(a))&&(t[n]=o?[].concat(o,a):a)}else n!==""&&(t[n]=i[n])}return t}function We(e,t,s,i=null){Be(e,t,7,[s,i])}const Zr=ka();let ec=0;function tc(e,t,s){const i=e.type,n=(t?t.appContext:e.appContext)||Zr,o={uid:ec++,vnode:e,type:i,parent:t,appContext:n,root:null,next:null,subTree:null,effect:null,update:null,scope:new Cl(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:t?t.provides:Object.create(n.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:va(i,n),emitsOptions:aa(i,n),emit:null,emitted:null,propsDefaults:ee,inheritAttrs:i.inheritAttrs,ctx:ee,data:ee,props:ee,attrs:ee,slots:ee,refs:ee,setupState:ee,setupContext:null,suspense:s,suspenseId:s?s.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return o.ctx={_:o},o.root=t?t.root:o,o.emit=ur.bind(null,o),e.ce&&e.ce(o),o}let be=null;const Gt=e=>{be=e,e.scope.on()},It=()=>{be&&be.scope.off(),be=null};function Pa(e){return e.vnode.shapeFlag&4}let vs=!1;function sc(e,t=!1){vs=t;const{props:s,children:i}=e.vnode,n=Pa(e);Dr(e,s,n,t),qr(e,i);const o=n?ic(e,t):void 0;return vs=!1,o}function ic(e,t){const s=e.type;e.accessCache=Object.create(null),e.proxy=Xo(new Proxy(e.ctx,Mr));const{setup:i}=s;if(i){const n=e.setupContext=i.length>1?oc(e):null;Gt(e),Zt();const o=mt(i,e,0,[e.props,n]);if(es(),It(),Ho(o)){if(o.then(It,It),t)return o.then(a=>{Zn(e,a,t)}).catch(a=>{si(a,e,0)});e.asyncDep=o}else Zn(e,o,t)}else La(e,t)}function Zn(e,t,s){q(t)?e.type.__ssrInlineRender?e.ssrRender=t:e.render=t:ne(t)&&(e.setupState=ea(t)),La(e,s)}let eo;function La(e,t,s){const i=e.type;if(!e.render){if(!t&&eo&&!i.render){const n=i.template||gn(e).template;if(n){const{isCustomElement:o,compilerOptions:a}=e.appContext.config,{delimiters:l,compilerOptions:r}=i,d=Te(Te({isCustomElement:o,delimiters:l},a),r);i.render=eo(n,d)}}e.render=i.render||ze}Gt(e),Zt(),Er(e),es(),It()}function nc(e){return new Proxy(e.attrs,{get(t,s){return Oe(e,"get","$attrs"),t[s]}})}function oc(e){const t=i=>{e.exposed=i||{}};let s;return{get attrs(){return s||(s=nc(e))},slots:e.slots,emit:e.emit,expose:t}}function wn(e){if(e.exposed)return e.exposeProxy||(e.exposeProxy=new Proxy(ea(Xo(e.exposed)),{get(t,s){if(s in t)return t[s];if(s in Ds)return Ds[s](e)}}))}function ac(e,t=!0){return q(e)?e.displayName||e.name:e.name||t&&e.__name}function lc(e){return q(e)&&"__vccOpts"in e}const ce=(e,t)=>lr(e,t,vs);function rc(e,t,s){const i=arguments.length;return i===2?ne(t)&&!B(t)?Bs(t)?W(e,null,[t]):W(e,t):W(e,null,t):(i>3?s=Array.prototype.slice.call(arguments,2):i===3&&Bs(s)&&(s=[s]),W(e,t,s))}const cc="3.2.39",dc="http://www.w3.org/2000/svg",Lt=typeof document<"u"?document:null,to=Lt&&Lt.createElement("template"),pc={insert:(e,t,s)=>{t.insertBefore(e,s||null)},remove:e=>{const t=e.parentNode;t&&t.removeChild(e)},createElement:(e,t,s,i)=>{const n=t?Lt.createElementNS(dc,e):Lt.createElement(e,s?{is:s}:void 0);return e==="select"&&i&&i.multiple!=null&&n.setAttribute("multiple",i.multiple),n},createText:e=>Lt.createTextNode(e),createComment:e=>Lt.createComment(e),setText:(e,t)=>{e.nodeValue=t},setElementText:(e,t)=>{e.textContent=t},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>Lt.querySelector(e),setScopeId(e,t){e.setAttribute(t,"")},cloneNode(e){const t=e.cloneNode(!0);return"_value"in e&&(t._value=e._value),t},insertStaticContent(e,t,s,i,n,o){const a=s?s.previousSibling:t.lastChild;if(n&&(n===o||n.nextSibling))for(;t.insertBefore(n.cloneNode(!0),s),!(n===o||!(n=n.nextSibling)););else{to.innerHTML=i?`<svg>${e}</svg>`:e;const l=to.content;if(i){const r=l.firstChild;for(;r.firstChild;)l.appendChild(r.firstChild);l.removeChild(r)}t.insertBefore(l,s)}return[a?a.nextSibling:t.firstChild,s?s.previousSibling:t.lastChild]}};function hc(e,t,s){const i=e._vtc;i&&(t=(t?[t,...i]:[...i]).join(" ")),t==null?e.removeAttribute("class"):s?e.setAttribute("class",t):e.className=t}function uc(e,t,s){const i=e.style,n=pe(s);if(s&&!n){for(const o in s)Fi(i,o,s[o]);if(t&&!pe(t))for(const o in t)s[o]==null&&Fi(i,o,"")}else{const o=i.display;n?t!==s&&(i.cssText=s):t&&e.removeAttribute("style"),"_vod"in e&&(i.display=o)}}const so=/\s*!important$/;function Fi(e,t,s){if(B(s))s.forEach(i=>Fi(e,t,i));else if(s==null&&(s=""),t.startsWith("--"))e.setProperty(t,s);else{const i=fc(e,t);so.test(s)?e.setProperty(Mt(i),s.replace(so,""),"important"):e[i]=s}}const io=["Webkit","Moz","ms"],ki={};function fc(e,t){const s=ki[t];if(s)return s;let i=Ge(t);if(i!=="filter"&&i in e)return ki[t]=i;i=Zs(i);for(let n=0;n<io.length;n++){const o=io[n]+i;if(o in e)return ki[t]=o}return t}const no="http://www.w3.org/1999/xlink";function gc(e,t,s,i,n){if(i&&t.startsWith("xlink:"))s==null?e.removeAttributeNS(no,t.slice(6,t.length)):e.setAttributeNS(no,t,s);else{const o=gl(t);s==null||o&&!Ao(s)?e.removeAttribute(t):e.setAttribute(t,o?"":s)}}function mc(e,t,s,i,n,o,a){if(t==="innerHTML"||t==="textContent"){i&&a(i,n,o),e[t]=s==null?"":s;return}if(t==="value"&&e.tagName!=="PROGRESS"&&!e.tagName.includes("-")){e._value=s;const r=s==null?"":s;(e.value!==r||e.tagName==="OPTION")&&(e.value=r),s==null&&e.removeAttribute(t);return}let l=!1;if(s===""||s==null){const r=typeof e[t];r==="boolean"?s=Ao(s):s==null&&r==="string"?(s="",l=!0):r==="number"&&(s=0,l=!0)}try{e[t]=s}catch{}l&&e.removeAttribute(t)}const[Ra,bc]=(()=>{let e=Date.now,t=!1;if(typeof window<"u"){Date.now()>document.createEvent("Event").timeStamp&&(e=performance.now.bind(performance));const s=navigator.userAgent.match(/firefox\/(\d+)/i);t=!!(s&&Number(s[1])<=53)}return[e,t]})();let Di=0;const yc=Promise.resolve(),vc=()=>{Di=0},wc=()=>Di||(yc.then(vc),Di=Ra());function xc(e,t,s,i){e.addEventListener(t,s,i)}function _c(e,t,s,i){e.removeEventListener(t,s,i)}function kc(e,t,s,i,n=null){const o=e._vei||(e._vei={}),a=o[t];if(i&&a)a.value=i;else{const[l,r]=Tc(t);if(i){const d=o[t]=$c(i,n);xc(e,l,d,r)}else a&&(_c(e,l,a,r),o[t]=void 0)}}const oo=/(?:Once|Passive|Capture)$/;function Tc(e){let t;if(oo.test(e)){t={};let i;for(;i=e.match(oo);)e=e.slice(0,e.length-i[0].length),t[i[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):Mt(e.slice(2)),t]}function $c(e,t){const s=i=>{const n=i.timeStamp||Ra();(bc||n>=s.attached-1)&&Be(Sc(i,s.value),t,5,[i])};return s.value=e,s.attached=wc(),s}function Sc(e,t){if(B(t)){const s=e.stopImmediatePropagation;return e.stopImmediatePropagation=()=>{s.call(e),e._stopped=!0},t.map(i=>n=>!n._stopped&&i&&i(n))}else return t}const ao=/^on[a-z]/,Cc=(e,t,s,i,n=!1,o,a,l,r)=>{t==="class"?hc(e,i,n):t==="style"?uc(e,s,i):Js(t)?en(t)||kc(e,t,s,i,a):(t[0]==="."?(t=t.slice(1),!0):t[0]==="^"?(t=t.slice(1),!1):Pc(e,t,i,n))?mc(e,t,i,o,a,l,r):(t==="true-value"?e._trueValue=i:t==="false-value"&&(e._falseValue=i),gc(e,t,i,n))};function Pc(e,t,s,i){return i?!!(t==="innerHTML"||t==="textContent"||t in e&&ao.test(t)&&q(s)):t==="spellcheck"||t==="draggable"||t==="translate"||t==="form"||t==="list"&&e.tagName==="INPUT"||t==="type"&&e.tagName==="TEXTAREA"||ao.test(t)&&pe(s)?!1:t in e}const Lc=["ctrl","shift","alt","meta"],Rc={stop:e=>e.stopPropagation(),prevent:e=>e.preventDefault(),self:e=>e.target!==e.currentTarget,ctrl:e=>!e.ctrlKey,shift:e=>!e.shiftKey,alt:e=>!e.altKey,meta:e=>!e.metaKey,left:e=>"button"in e&&e.button!==0,middle:e=>"button"in e&&e.button!==1,right:e=>"button"in e&&e.button!==2,exact:(e,t)=>Lc.some(s=>e[`${s}Key`]&&!t.includes(s))},qs=(e,t)=>(s,...i)=>{for(let n=0;n<t.length;n++){const o=Rc[t[n]];if(o&&o(s,t))return}return e(s,...i)},Ic={esc:"escape",space:" ",up:"arrow-up",left:"arrow-left",right:"arrow-right",down:"arrow-down",delete:"backspace"},Ia=(e,t)=>s=>{if(!("key"in s))return;const i=Mt(s.key);if(t.some(n=>n===i||Ic[n]===i))return e(s)},Ac=Te({patchProp:Cc},pc);let lo;function Oc(){return lo||(lo=Kr(Ac))}const Aa=(...e)=>{const t=Oc().createApp(...e),{mount:s}=t;return t.mount=i=>{const n=Mc(i);if(!n)return;const o=t._component;!q(o)&&!o.render&&!o.template&&(o.template=n.innerHTML),n.innerHTML="";const a=s(n,!1,n instanceof SVGElement);return n instanceof Element&&(n.removeAttribute("v-cloak"),n.setAttribute("data-v-app","")),a},t};function Mc(e){return pe(e)?document.querySelector(e):e}function Ec(e,t){return(!t.tag||e.tag===t.tag)&&(!t.type||e.type===t.type)}const Oa=[{name:"HTML and the DOM",skippable:!0,instructions:`<img src="img/chef.png" style="width: 88px; margin: 0 auto"/>
        ...
        `}],Hc={name:"HTML - Semantics",description:"Why semantics matter",intro:`
    <p>HTML is the markup language that describes the <strong>content</strong> of web pages.</p>
    <p>In this chapter, we will look at the different elements available in HTML and why understanding the purpose of each of them is important for you and your visitors.</p>`,levels:Oa};function Et(){const e=document.querySelector(".editor textarea");e instanceof HTMLTextAreaElement&&(e.value="",e.focus())}function rt(e){return e.split("-")[0]}function Yt(e){return e.split("-")[1]}function _s(e){return["top","bottom"].includes(rt(e))?"x":"y"}function xn(e){return e==="y"?"height":"width"}function ro(e){let{reference:t,floating:s,placement:i}=e;const n=t.x+t.width/2-s.width/2,o=t.y+t.height/2-s.height/2;let a;switch(rt(i)){case"top":a={x:n,y:t.y-s.height};break;case"bottom":a={x:n,y:t.y+t.height};break;case"right":a={x:t.x+t.width,y:o};break;case"left":a={x:t.x-s.width,y:o};break;default:a={x:t.x,y:t.y}}const l=_s(i),r=xn(l);switch(Yt(i)){case"start":a[l]=a[l]-(t[r]/2-s[r]/2);break;case"end":a[l]=a[l]+(t[r]/2-s[r]/2);break}return a}const jc=async(e,t,s)=>{const{placement:i="bottom",strategy:n="absolute",middleware:o=[],platform:a}=s;let l=await a.getElementRects({reference:e,floating:t,strategy:n}),{x:r,y:d}=ro({...l,placement:i}),h=i,u={};for(let g=0;g<o.length;g++){const{name:_,fn:M}=o[g],{x:j,y:L,data:I,reset:A}=await M({x:r,y:d,initialPlacement:i,placement:h,strategy:n,middlewareData:u,rects:l,platform:a,elements:{reference:e,floating:t}});if(r=j!=null?j:r,d=L!=null?L:d,u={...u,[_]:I!=null?I:{}},A){typeof A=="object"&&(A.placement&&(h=A.placement),A.rects&&(l=A.rects===!0?await a.getElementRects({reference:e,floating:t,strategy:n}):A.rects),{x:r,y:d}=ro({...l,placement:h})),g=-1;continue}}return{x:r,y:d,placement:h,strategy:n,middlewareData:u}};function Nc(e){return{top:0,right:0,bottom:0,left:0,...e}}function Ma(e){return typeof e!="number"?Nc(e):{top:e,right:e,bottom:e,left:e}}function zi(e){return{...e,top:e.y,left:e.x,right:e.x+e.width,bottom:e.y+e.height}}async function li(e,t){t===void 0&&(t={});const{x:s,y:i,platform:n,rects:o,elements:a,strategy:l}=e,{boundary:r="clippingParents",rootBoundary:d="viewport",elementContext:h="floating",altBoundary:u=!1,padding:g=0}=t,_=Ma(g),j=a[u?h==="floating"?"reference":"floating":h],L=await n.getClippingClientRect({element:await n.isElement(j)?j:j.contextElement||await n.getDocumentElement({element:a.floating}),boundary:r,rootBoundary:d}),I=zi(await n.convertOffsetParentRelativeRectToViewportRelativeRect({rect:h==="floating"?{...o.floating,x:s,y:i}:o.reference,offsetParent:await n.getOffsetParent({element:a.floating}),strategy:l}));return{top:L.top-I.top+_.top,bottom:I.bottom-L.bottom+_.bottom,left:L.left-I.left+_.left,right:I.right-L.right+_.right}}const Fc=Math.min,Ct=Math.max;function Bi(e,t,s){return Ct(e,Fc(t,s))}const Dc=e=>({name:"arrow",options:e,async fn(t){const{element:s,padding:i=0}=e!=null?e:{},{x:n,y:o,placement:a,rects:l,platform:r}=t;if(s==null)return{};const d=Ma(i),h={x:n,y:o},u=rt(a),g=_s(u),_=xn(g),M=await r.getDimensions({element:s}),j=g==="y"?"top":"left",L=g==="y"?"bottom":"right",I=l.reference[_]+l.reference[g]-h[g]-l.floating[_],A=h[g]-l.reference[g],O=await r.getOffsetParent({element:s}),D=O?g==="y"?O.clientHeight||0:O.clientWidth||0:0,oe=I/2-A/2,ue=d[j],fe=D-M[_]-d[L],ie=D/2-M[_]/2+oe,z=Bi(ue,ie,fe);return{data:{[g]:z,centerOffset:ie-z}}}}),zc={left:"right",right:"left",bottom:"top",top:"bottom"};function Ws(e){return e.replace(/left|right|bottom|top/g,t=>zc[t])}function Ea(e,t){const s=Yt(e)==="start",i=_s(e),n=xn(i);let o=i==="x"?s?"right":"left":s?"bottom":"top";return t.reference[n]>t.floating[n]&&(o=Ws(o)),{main:o,cross:Ws(o)}}const Bc={start:"end",end:"start"};function qi(e){return e.replace(/start|end/g,t=>Bc[t])}const qc=["top","right","bottom","left"],Wc=qc.reduce((e,t)=>e.concat(t,t+"-start",t+"-end"),[]);function Uc(e,t,s){return(e?[...s.filter(n=>Yt(n)===e),...s.filter(n=>Yt(n)!==e)]:s.filter(n=>rt(n)===n)).filter(n=>e?Yt(n)===e||(t?qi(n)!==n:!1):!0)}const Yc=function(e){return e===void 0&&(e={}),{name:"autoPlacement",options:e,async fn(t){var s,i,n,o,a,l;const{x:r,y:d,rects:h,middlewareData:u,placement:g}=t,{alignment:_=null,allowedPlacements:M=Wc,autoAlignment:j=!0,...L}=e;if((s=u.autoPlacement)!=null&&s.skip)return{};const I=Uc(_,j,M),A=await li(t,L),O=(i=(n=u.autoPlacement)==null?void 0:n.index)!=null?i:0,D=I[O],{main:oe,cross:ue}=Ea(D,h);if(g!==D)return{x:r,y:d,reset:{placement:I[0]}};const fe=[A[rt(D)],A[oe],A[ue]],ie=[...(o=(a=u.autoPlacement)==null?void 0:a.overflows)!=null?o:[],{placement:D,overflows:fe}],z=I[O+1];if(z)return{data:{index:O+1,overflows:ie},reset:{placement:z}};const le=ie.slice().sort((de,xe)=>de.overflows[0]-xe.overflows[0]),ae=(l=le.find(de=>{let{overflows:xe}=de;return xe.every(ge=>ge<=0)}))==null?void 0:l.placement;return{data:{skip:!0},reset:{placement:ae!=null?ae:le[0].placement}}}}};function Kc(e){const t=Ws(e);return[qi(e),t,qi(t)]}const Vc=function(e){return e===void 0&&(e={}),{name:"flip",options:e,async fn(t){var s,i;const{placement:n,middlewareData:o,rects:a,initialPlacement:l}=t;if((s=o.flip)!=null&&s.skip)return{};const{mainAxis:r=!0,crossAxis:d=!0,fallbackPlacements:h,fallbackStrategy:u="bestFit",flipAlignment:g=!0,..._}=e,M=rt(n),L=h||(M===l||!g?[Ws(l)]:Kc(l)),I=[l,...L],A=await li(t,_),O=[];let D=((i=o.flip)==null?void 0:i.overflows)||[];if(r&&O.push(A[M]),d){const{main:ie,cross:z}=Ea(n,a);O.push(A[ie],A[z])}if(D=[...D,{placement:n,overflows:O}],!O.every(ie=>ie<=0)){var oe,ue;const ie=((oe=(ue=o.flip)==null?void 0:ue.index)!=null?oe:0)+1,z=I[ie];if(z)return{data:{index:ie,overflows:D},reset:{placement:z}};let le="bottom";switch(u){case"bestFit":{var fe;const ae=(fe=D.slice().sort((de,xe)=>de.overflows.filter(ge=>ge>0).reduce((ge,_t)=>ge+_t,0)-xe.overflows.filter(ge=>ge>0).reduce((ge,_t)=>ge+_t,0))[0])==null?void 0:fe.placement;ae&&(le=ae);break}case"initialPlacement":le=l;break}return{data:{skip:!0},reset:{placement:le}}}return{}}}};function Gc(e){let{placement:t,rects:s,value:i}=e;const n=rt(t),o=["left","top"].includes(n)?-1:1,a=typeof i=="function"?i({...s,placement:t}):i,{mainAxis:l,crossAxis:r}=typeof a=="number"?{mainAxis:a,crossAxis:0}:{mainAxis:0,crossAxis:0,...a};return _s(n)==="x"?{x:r,y:l*o}:{x:l*o,y:r}}const Jc=function(e){return e===void 0&&(e=0),{name:"offset",options:e,fn(t){const{x:s,y:i,placement:n,rects:o}=t,a=Gc({placement:n,rects:o,value:e});return{x:s+a.x,y:i+a.y,data:a}}}};function Xc(e){return e==="x"?"y":"x"}const Qc=function(e){return e===void 0&&(e={}),{name:"shift",options:e,async fn(t){const{x:s,y:i,placement:n}=t,{mainAxis:o=!0,crossAxis:a=!1,limiter:l={fn:L=>{let{x:I,y:A}=L;return{x:I,y:A}}},...r}=e,d={x:s,y:i},h=await li(t,r),u=_s(rt(n)),g=Xc(u);let _=d[u],M=d[g];if(o){const L=u==="y"?"top":"left",I=u==="y"?"bottom":"right",A=_+h[L],O=_-h[I];_=Bi(A,_,O)}if(a){const L=g==="y"?"top":"left",I=g==="y"?"bottom":"right",A=M+h[L],O=M-h[I];M=Bi(A,M,O)}const j=l.fn({...t,[u]:_,[g]:M});return{...j,data:{x:j.x-s,y:j.y-i}}}}},Zc=function(e){return e===void 0&&(e={}),{name:"size",options:e,async fn(t){var s;const{placement:i,rects:n,middlewareData:o}=t,{apply:a,...l}=e;if((s=o.size)!=null&&s.skip)return{};const r=await li(t,l),d=rt(i),h=Yt(i)==="end";let u,g;d==="top"||d==="bottom"?(u=d,g=h?"left":"right"):(g=d,u=h?"top":"bottom");const _=Ct(r.left,0),M=Ct(r.right,0),j=Ct(r.top,0),L=Ct(r.bottom,0),I={height:n.floating.height-(["left","right"].includes(i)?2*(j!==0||L!==0?j+L:Ct(r.top,r.bottom)):r[u]),width:n.floating.width-(["top","bottom"].includes(i)?2*(_!==0||M!==0?_+M:Ct(r.left,r.right)):r[g])};return a==null||a({...I,...n}),{data:{skip:!0},reset:{rects:!0}}}}};function _n(e){return(e==null?void 0:e.toString())==="[object Window]"}function wt(e){if(e==null)return window;if(!_n(e)){const t=e.ownerDocument;return t&&t.defaultView||window}return e}function ri(e){return wt(e).getComputedStyle(e)}function ot(e){return _n(e)?"":e?(e.nodeName||"").toLowerCase():""}function at(e){return e instanceof wt(e).HTMLElement}function Us(e){return e instanceof wt(e).Element}function ed(e){return e instanceof wt(e).Node}function Ha(e){const t=wt(e).ShadowRoot;return e instanceof t||e instanceof ShadowRoot}function ci(e){const{overflow:t,overflowX:s,overflowY:i}=ri(e);return/auto|scroll|overlay|hidden/.test(t+i+s)}function td(e){return["table","td","th"].includes(ot(e))}function ja(e){const t=navigator.userAgent.toLowerCase().includes("firefox"),s=ri(e);return s.transform!=="none"||s.perspective!=="none"||s.contain==="paint"||["transform","perspective"].includes(s.willChange)||t&&s.willChange==="filter"||t&&(s.filter?s.filter!=="none":!1)}const co=Math.min,ds=Math.max,Ys=Math.round;function Jt(e,t){t===void 0&&(t=!1);const s=e.getBoundingClientRect();let i=1,n=1;return t&&at(e)&&(i=e.offsetWidth>0&&Ys(s.width)/e.offsetWidth||1,n=e.offsetHeight>0&&Ys(s.height)/e.offsetHeight||1),{width:s.width/i,height:s.height/n,top:s.top/n,right:s.right/i,bottom:s.bottom/n,left:s.left/i,x:s.left/i,y:s.top/n}}function xt(e){return((ed(e)?e.ownerDocument:e.document)||window.document).documentElement}function di(e){return _n(e)?{scrollLeft:e.pageXOffset,scrollTop:e.pageYOffset}:{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}}function Na(e){return Jt(xt(e)).left+di(e).scrollLeft}function sd(e){const t=Jt(e);return Ys(t.width)!==e.offsetWidth||Ys(t.height)!==e.offsetHeight}function id(e,t,s){const i=at(t),n=xt(t),o=Jt(e,i&&sd(t));let a={scrollLeft:0,scrollTop:0};const l={x:0,y:0};if(i||!i&&s!=="fixed")if((ot(t)!=="body"||ci(n))&&(a=di(t)),at(t)){const r=Jt(t,!0);l.x=r.x+t.clientLeft,l.y=r.y+t.clientTop}else n&&(l.x=Na(n));return{x:o.left+a.scrollLeft-l.x,y:o.top+a.scrollTop-l.y,width:o.width,height:o.height}}function pi(e){return ot(e)==="html"?e:e.assignedSlot||e.parentNode||(Ha(e)?e.host:null)||xt(e)}function po(e){return!at(e)||getComputedStyle(e).position==="fixed"?null:e.offsetParent}function nd(e){let t=pi(e);for(;at(t)&&!["html","body"].includes(ot(t));){if(ja(t))return t;t=t.parentNode}return null}function Wi(e){const t=wt(e);let s=po(e);for(;s&&td(s)&&getComputedStyle(s).position==="static";)s=po(s);return s&&(ot(s)==="html"||ot(s)==="body"&&getComputedStyle(s).position==="static"&&!ja(s))?t:s||nd(e)||t}function ho(e){return{width:e.offsetWidth,height:e.offsetHeight}}function od(e){let{rect:t,offsetParent:s,strategy:i}=e;const n=at(s),o=xt(s);if(s===o)return t;let a={scrollLeft:0,scrollTop:0};const l={x:0,y:0};if((n||!n&&i!=="fixed")&&((ot(s)!=="body"||ci(o))&&(a=di(s)),at(s))){const r=Jt(s,!0);l.x=r.x+s.clientLeft,l.y=r.y+s.clientTop}return{...t,x:t.x-a.scrollLeft+l.x,y:t.y-a.scrollTop+l.y}}function ad(e){const t=wt(e),s=xt(e),i=t.visualViewport;let n=s.clientWidth,o=s.clientHeight,a=0,l=0;return i&&(n=i.width,o=i.height,Math.abs(t.innerWidth/i.scale-i.width)<.01&&(a=i.offsetLeft,l=i.offsetTop)),{width:n,height:o,x:a,y:l}}function ld(e){var t;const s=xt(e),i=di(e),n=(t=e.ownerDocument)==null?void 0:t.body,o=ds(s.scrollWidth,s.clientWidth,n?n.scrollWidth:0,n?n.clientWidth:0),a=ds(s.scrollHeight,s.clientHeight,n?n.scrollHeight:0,n?n.clientHeight:0);let l=-i.scrollLeft+Na(e);const r=-i.scrollTop;return ri(n||s).direction==="rtl"&&(l+=ds(s.clientWidth,n?n.clientWidth:0)-o),{width:o,height:a,x:l,y:r}}function Fa(e){return["html","body","#document"].includes(ot(e))?e.ownerDocument.body:at(e)&&ci(e)?e:Fa(pi(e))}function Ks(e,t){var s;t===void 0&&(t=[]);const i=Fa(e),n=i===((s=e.ownerDocument)==null?void 0:s.body),o=wt(i),a=n?[o].concat(o.visualViewport||[],ci(i)?i:[]):i,l=t.concat(a);return n?l:l.concat(Ks(pi(a)))}function rd(e,t){const s=t.getRootNode==null?void 0:t.getRootNode();if(e.contains(t))return!0;if(s&&Ha(s)){let i=t;do{if(i&&e===i)return!0;i=i.parentNode||i.host}while(i)}return!1}function cd(e){const t=Jt(e),s=t.top+e.clientTop,i=t.left+e.clientLeft;return{top:s,left:i,x:i,y:s,right:i+e.clientWidth,bottom:s+e.clientHeight,width:e.clientWidth,height:e.clientHeight}}function uo(e,t){return t==="viewport"?zi(ad(e)):Us(t)?cd(t):zi(ld(xt(e)))}function dd(e){const t=Ks(pi(e)),i=["absolute","fixed"].includes(ri(e).position)&&at(e)?Wi(e):e;return Us(i)?t.filter(n=>Us(n)&&rd(n,i)&&ot(n)!=="body"):[]}function pd(e){let{element:t,boundary:s,rootBoundary:i}=e;const o=[...s==="clippingParents"?dd(t):[].concat(s),i],a=o[0],l=o.reduce((r,d)=>{const h=uo(t,d);return r.top=ds(h.top,r.top),r.right=co(h.right,r.right),r.bottom=co(h.bottom,r.bottom),r.left=ds(h.left,r.left),r},uo(t,a));return l.width=l.right-l.left,l.height=l.bottom-l.top,l.x=l.left,l.y=l.top,l}const hd={getElementRects:e=>{let{reference:t,floating:s,strategy:i}=e;return{reference:id(t,Wi(s),i),floating:{...ho(s),x:0,y:0}}},convertOffsetParentRelativeRectToViewportRelativeRect:e=>od(e),getOffsetParent:e=>{let{element:t}=e;return Wi(t)},isElement:e=>Us(e),getDocumentElement:e=>{let{element:t}=e;return xt(t)},getClippingClientRect:e=>pd(e),getDimensions:e=>{let{element:t}=e;return ho(t)},getClientRects:e=>{let{element:t}=e;return t.getClientRects()}},ud=(e,t,s)=>jc(e,t,{platform:hd,...s});var fd=Object.defineProperty,gd=Object.defineProperties,md=Object.getOwnPropertyDescriptors,fo=Object.getOwnPropertySymbols,bd=Object.prototype.hasOwnProperty,yd=Object.prototype.propertyIsEnumerable,go=(e,t,s)=>t in e?fd(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s,tt=(e,t)=>{for(var s in t||(t={}))bd.call(t,s)&&go(e,s,t[s]);if(fo)for(var s of fo(t))yd.call(t,s)&&go(e,s,t[s]);return e},ks=(e,t)=>gd(e,md(t));function Da(e,t){for(const s in t)Object.prototype.hasOwnProperty.call(t,s)&&(typeof t[s]=="object"&&e[s]?Da(e[s],t[s]):e[s]=t[s])}const it={disabled:!1,distance:5,skidding:0,container:"body",boundary:void 0,instantMove:!1,disposeTimeout:5e3,popperTriggers:[],strategy:"absolute",preventOverflow:!0,flip:!0,shift:!0,overflowPadding:0,arrowPadding:0,arrowOverflow:!0,themes:{tooltip:{placement:"top",triggers:["hover","focus","touch"],hideTriggers:e=>[...e,"click"],delay:{show:200,hide:0},handleResize:!1,html:!1,loadingContent:"..."},dropdown:{placement:"bottom",triggers:["click"],delay:0,handleResize:!0,autoHide:!0},menu:{$extend:"dropdown",triggers:["hover","focus"],popperTriggers:["hover","focus"],delay:{show:0,hide:400}}}};function Xt(e,t){let s=it.themes[e]||{},i;do i=s[t],typeof i>"u"?s.$extend?s=it.themes[s.$extend]||{}:(s=null,i=it[t]):s=null;while(s);return i}function vd(e){const t=[e];let s=it.themes[e]||{};do s.$extend&&!s.$resetCss?(t.push(s.$extend),s=it.themes[s.$extend]||{}):s=null;while(s);return t.map(i=>`v-popper--theme-${i}`)}function mo(e){const t=[e];let s=it.themes[e]||{};do s.$extend?(t.push(s.$extend),s=it.themes[s.$extend]||{}):s=null;while(s);return t}let At=!1;if(typeof window<"u"){At=!1;try{const e=Object.defineProperty({},"passive",{get(){At=!0}});window.addEventListener("test",null,e)}catch{}}let za=!1;typeof window<"u"&&typeof navigator<"u"&&(za=/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream);const Ba=["auto","top","bottom","left","right"].reduce((e,t)=>e.concat([t,`${t}-start`,`${t}-end`]),[]),bo={hover:"mouseenter",focus:"focus",click:"click",touch:"touchstart"},yo={hover:"mouseleave",focus:"blur",click:"click",touch:"touchend"};function vo(e,t){const s=e.indexOf(t);s!==-1&&e.splice(s,1)}function Ti(){return new Promise(e=>requestAnimationFrame(()=>{requestAnimationFrame(e)}))}const Ae=[];let $t=null;const wo={};function xo(e){let t=wo[e];return t||(t=wo[e]=[]),t}let Ui=function(){};typeof window<"u"&&(Ui=window.Element);function V(e){return function(t){return Xt(t.theme,e)}}const $i="__floating-vue__popper";var qa=()=>Z({name:"VPopper",provide(){return{[$i]:{parentPopper:this}}},inject:{[$i]:{default:null}},props:{theme:{type:String,required:!0},targetNodes:{type:Function,required:!0},referenceNode:{type:Function,default:null},popperNode:{type:Function,required:!0},shown:{type:Boolean,default:!1},showGroup:{type:String,default:null},ariaId:{default:null},disabled:{type:Boolean,default:V("disabled")},positioningDisabled:{type:Boolean,default:V("positioningDisabled")},placement:{type:String,default:V("placement"),validator:e=>Ba.includes(e)},delay:{type:[String,Number,Object],default:V("delay")},distance:{type:[Number,String],default:V("distance")},skidding:{type:[Number,String],default:V("skidding")},triggers:{type:Array,default:V("triggers")},showTriggers:{type:[Array,Function],default:V("showTriggers")},hideTriggers:{type:[Array,Function],default:V("hideTriggers")},popperTriggers:{type:Array,default:V("popperTriggers")},popperShowTriggers:{type:[Array,Function],default:V("popperShowTriggers")},popperHideTriggers:{type:[Array,Function],default:V("popperHideTriggers")},container:{type:[String,Object,Ui,Boolean],default:V("container")},boundary:{type:[String,Ui],default:V("boundary")},strategy:{type:String,validator:e=>["absolute","fixed"].includes(e),default:V("strategy")},autoHide:{type:[Boolean,Function],default:V("autoHide")},handleResize:{type:Boolean,default:V("handleResize")},instantMove:{type:Boolean,default:V("instantMove")},eagerMount:{type:Boolean,default:V("eagerMount")},popperClass:{type:[String,Array,Object],default:V("popperClass")},computeTransformOrigin:{type:Boolean,default:V("computeTransformOrigin")},autoMinSize:{type:Boolean,default:V("autoMinSize")},autoSize:{type:[Boolean,String],default:V("autoSize")},autoMaxSize:{type:Boolean,default:V("autoMaxSize")},autoBoundaryMaxSize:{type:Boolean,default:V("autoBoundaryMaxSize")},preventOverflow:{type:Boolean,default:V("preventOverflow")},overflowPadding:{type:[Number,String],default:V("overflowPadding")},arrowPadding:{type:[Number,String],default:V("arrowPadding")},arrowOverflow:{type:Boolean,default:V("arrowOverflow")},flip:{type:Boolean,default:V("flip")},shift:{type:Boolean,default:V("shift")},shiftCrossAxis:{type:Boolean,default:V("shiftCrossAxis")},noAutoFocus:{type:Boolean,default:V("noAutoFocus")}},emits:["show","hide","update:shown","apply-show","apply-hide","close-group","close-directive","auto-hide","resize","dispose"],data(){return{isShown:!1,isMounted:!1,skipTransition:!1,classes:{showFrom:!1,showTo:!1,hideFrom:!1,hideTo:!0},result:{x:0,y:0,placement:"",strategy:this.strategy,arrow:{x:0,y:0,centerOffset:0},transformOrigin:null},shownChildren:new Set,lastAutoHide:!0}},computed:{popperId(){return this.ariaId!=null?this.ariaId:this.randomId},shouldMountContent(){return this.eagerMount||this.isMounted},slotData(){return{popperId:this.popperId,isShown:this.isShown,shouldMountContent:this.shouldMountContent,skipTransition:this.skipTransition,autoHide:typeof this.autoHide=="function"?this.lastAutoHide:this.autoHide,show:this.show,hide:this.hide,handleResize:this.handleResize,onResize:this.onResize,classes:ks(tt({},this.classes),{popperClass:this.popperClass}),result:this.positioningDisabled?null:this.result,attrs:this.$attrs}},parentPopper(){var e;return(e=this[$i])==null?void 0:e.parentPopper},hasPopperShowTriggerHover(){var e,t;return((e=this.popperTriggers)==null?void 0:e.includes("hover"))||((t=this.popperShowTriggers)==null?void 0:t.includes("hover"))}},watch:tt(tt({shown:"$_autoShowHide",disabled(e){e?this.dispose():this.init()},async container(){this.isShown&&(this.$_ensureTeleport(),await this.$_computePosition())}},["triggers","positioningDisabled"].reduce((e,t)=>(e[t]="$_refreshListeners",e),{})),["placement","distance","skidding","boundary","strategy","overflowPadding","arrowPadding","preventOverflow","shift","shiftCrossAxis","flip"].reduce((e,t)=>(e[t]="$_computePosition",e),{})),created(){this.$_isDisposed=!0,this.randomId=`popper_${[Math.random(),Date.now()].map(e=>e.toString(36).substring(2,10)).join("_")}`,this.autoMinSize&&console.warn('[floating-vue] `autoMinSize` option is deprecated. Use `autoSize="min"` instead.'),this.autoMaxSize&&console.warn("[floating-vue] `autoMaxSize` option is deprecated. Use `autoBoundaryMaxSize` instead.")},mounted(){this.init(),this.$_detachPopperNode()},activated(){this.$_autoShowHide()},deactivated(){this.hide()},beforeUnmount(){this.dispose()},methods:{show({event:e=null,skipDelay:t=!1,force:s=!1}={}){var i,n;((i=this.parentPopper)==null?void 0:i.lockedChild)&&this.parentPopper.lockedChild!==this||(this.$_pendingHide=!1,(s||!this.disabled)&&(((n=this.parentPopper)==null?void 0:n.lockedChild)===this&&(this.parentPopper.lockedChild=null),this.$_scheduleShow(e,t),this.$emit("show"),this.$_showFrameLocked=!0,requestAnimationFrame(()=>{this.$_showFrameLocked=!1})),this.$emit("update:shown",!0))},hide({event:e=null,skipDelay:t=!1}={}){var s;if(!this.$_hideInProgress){if(this.shownChildren.size>0){this.$_pendingHide=!0;return}if(this.hasPopperShowTriggerHover&&this.$_isAimingPopper()){this.parentPopper&&(this.parentPopper.lockedChild=this,clearTimeout(this.parentPopper.lockedChildTimer),this.parentPopper.lockedChildTimer=setTimeout(()=>{this.parentPopper.lockedChild===this&&(this.parentPopper.lockedChild.hide({skipDelay:t}),this.parentPopper.lockedChild=null)},1e3));return}((s=this.parentPopper)==null?void 0:s.lockedChild)===this&&(this.parentPopper.lockedChild=null),this.$_pendingHide=!1,this.$_scheduleHide(e,t),this.$emit("hide"),this.$emit("update:shown",!1)}},init(){var e,t;!this.$_isDisposed||(this.$_isDisposed=!1,this.isMounted=!1,this.$_events=[],this.$_preventShow=!1,this.$_referenceNode=(t=(e=this.referenceNode)==null?void 0:e.call(this))!=null?t:this.$el,this.$_targetNodes=this.targetNodes().filter(s=>s.nodeType===s.ELEMENT_NODE),this.$_popperNode=this.popperNode(),this.$_innerNode=this.$_popperNode.querySelector(".v-popper__inner"),this.$_arrowNode=this.$_popperNode.querySelector(".v-popper__arrow-container"),this.$_swapTargetAttrs("title","data-original-title"),this.$_detachPopperNode(),this.triggers.length&&this.$_addEventListeners(),this.shown&&this.show())},dispose(){this.$_isDisposed||(this.$_isDisposed=!0,this.$_removeEventListeners(),this.hide({skipDelay:!0}),this.$_detachPopperNode(),this.isMounted=!1,this.isShown=!1,this.$_updateParentShownChildren(!1),this.$_swapTargetAttrs("data-original-title","title"),this.$emit("dispose"))},async onResize(){this.isShown&&(await this.$_computePosition(),this.$emit("resize"))},async $_computePosition(){var e;if(this.$_isDisposed||this.positioningDisabled)return;const t={strategy:this.strategy,middleware:[]};(this.distance||this.skidding)&&t.middleware.push(Jc({mainAxis:this.distance,crossAxis:this.skidding}));const s=this.placement.startsWith("auto");if(s?t.middleware.push(Yc({alignment:(e=this.placement.split("-")[1])!=null?e:""})):t.placement=this.placement,this.preventOverflow&&(this.shift&&t.middleware.push(Qc({padding:this.overflowPadding,boundary:this.boundary,crossAxis:this.shiftCrossAxis})),!s&&this.flip&&t.middleware.push(Vc({padding:this.overflowPadding,boundary:this.boundary}))),t.middleware.push(Dc({element:this.$_arrowNode,padding:this.arrowPadding})),this.arrowOverflow&&t.middleware.push({name:"arrowOverflow",fn:({placement:n,rects:o,middlewareData:a})=>{let l;const{centerOffset:r}=a.arrow;return n.startsWith("top")||n.startsWith("bottom")?l=Math.abs(r)>o.reference.width/2:l=Math.abs(r)>o.reference.height/2,{data:{overflow:l}}}}),this.autoMinSize||this.autoSize){const n=this.autoSize?this.autoSize:this.autoMinSize?"min":null;t.middleware.push({name:"autoSize",fn:({rects:o,placement:a,middlewareData:l})=>{var r;if((r=l.autoSize)!=null&&r.skip)return{};let d,h;return a.startsWith("top")||a.startsWith("bottom")?d=o.reference.width:h=o.reference.height,this.$_innerNode.style[n==="min"?"minWidth":n==="max"?"maxWidth":"width"]=d!=null?`${d}px`:null,this.$_innerNode.style[n==="min"?"minHeight":n==="max"?"maxHeight":"height"]=h!=null?`${h}px`:null,{data:{skip:!0},reset:{rects:!0}}}})}(this.autoMaxSize||this.autoBoundaryMaxSize)&&(this.$_innerNode.style.maxWidth=null,this.$_innerNode.style.maxHeight=null,t.middleware.push(Zc({boundary:this.boundary,padding:this.overflowPadding,apply:({width:n,height:o})=>{this.$_innerNode.style.maxWidth=n!=null?`${n}px`:null,this.$_innerNode.style.maxHeight=o!=null?`${o}px`:null}})));const i=await ud(this.$_referenceNode,this.$_popperNode,t);Object.assign(this.result,{x:i.x,y:i.y,placement:i.placement,strategy:i.strategy,arrow:tt(tt({},i.middlewareData.arrow),i.middlewareData.arrowOverflow)})},$_scheduleShow(e=null,t=!1){if(this.$_updateParentShownChildren(!0),this.$_hideInProgress=!1,clearTimeout(this.$_scheduleTimer),$t&&this.instantMove&&$t.instantMove&&$t!==this.parentPopper){$t.$_applyHide(!0),this.$_applyShow(!0);return}t?this.$_applyShow():this.$_scheduleTimer=setTimeout(this.$_applyShow.bind(this),this.$_computeDelay("show"))},$_scheduleHide(e=null,t=!1){if(this.shownChildren.size>0){this.$_pendingHide=!0;return}this.$_updateParentShownChildren(!1),this.$_hideInProgress=!0,clearTimeout(this.$_scheduleTimer),this.isShown&&($t=this),t?this.$_applyHide():this.$_scheduleTimer=setTimeout(this.$_applyHide.bind(this),this.$_computeDelay("hide"))},$_computeDelay(e){const t=this.delay;return parseInt(t&&t[e]||t||0)},async $_applyShow(e=!1){clearTimeout(this.$_disposeTimer),clearTimeout(this.$_scheduleTimer),this.skipTransition=e,!this.isShown&&(this.$_ensureTeleport(),await Ti(),await this.$_computePosition(),await this.$_applyShowEffect(),this.positioningDisabled||this.$_registerEventListeners([...Ks(this.$_referenceNode),...Ks(this.$_popperNode)],"scroll",()=>{this.$_computePosition()}))},async $_applyShowEffect(){if(this.$_hideInProgress)return;if(this.computeTransformOrigin){const t=this.$_referenceNode.getBoundingClientRect(),s=this.$_popperNode.querySelector(".v-popper__wrapper"),i=s.parentNode.getBoundingClientRect(),n=t.x+t.width/2-(i.left+s.offsetLeft),o=t.y+t.height/2-(i.top+s.offsetTop);this.result.transformOrigin=`${n}px ${o}px`}this.isShown=!0,this.$_applyAttrsToTarget({"aria-describedby":this.popperId,"data-popper-shown":""});const e=this.showGroup;if(e){let t;for(let s=0;s<Ae.length;s++)t=Ae[s],t.showGroup!==e&&(t.hide(),t.$emit("close-group"))}Ae.push(this),document.body.classList.add("v-popper--some-open");for(const t of mo(this.theme))xo(t).push(this),document.body.classList.add(`v-popper--some-open--${t}`);this.$emit("apply-show"),this.classes.showFrom=!0,this.classes.showTo=!1,this.classes.hideFrom=!1,this.classes.hideTo=!1,await Ti(),this.classes.showFrom=!1,this.classes.showTo=!0,this.noAutoFocus||this.$_popperNode.focus()},async $_applyHide(e=!1){if(this.shownChildren.size>0){this.$_pendingHide=!0,this.$_hideInProgress=!1;return}if(clearTimeout(this.$_scheduleTimer),!this.isShown)return;this.skipTransition=e,vo(Ae,this),Ae.length===0&&document.body.classList.remove("v-popper--some-open");for(const s of mo(this.theme)){const i=xo(s);vo(i,this),i.length===0&&document.body.classList.remove(`v-popper--some-open--${s}`)}$t===this&&($t=null),this.isShown=!1,this.$_applyAttrsToTarget({"aria-describedby":void 0,"data-popper-shown":void 0}),clearTimeout(this.$_disposeTimer);const t=Xt(this.theme,"disposeTimeout");t!==null&&(this.$_disposeTimer=setTimeout(()=>{this.$_popperNode&&(this.$_detachPopperNode(),this.isMounted=!1)},t)),this.$_removeEventListeners("scroll"),this.$emit("apply-hide"),this.classes.showFrom=!1,this.classes.showTo=!1,this.classes.hideFrom=!0,this.classes.hideTo=!1,await Ti(),this.classes.hideFrom=!1,this.classes.hideTo=!0},$_autoShowHide(){this.shown?this.show():this.hide()},$_ensureTeleport(){if(this.$_isDisposed)return;let e=this.container;if(typeof e=="string"?e=window.document.querySelector(e):e===!1&&(e=this.$_targetNodes[0].parentNode),!e)throw new Error("No container for popover: "+this.container);e.appendChild(this.$_popperNode),this.isMounted=!0},$_addEventListeners(){const e=s=>{this.isShown&&!this.$_hideInProgress||(s.usedByTooltip=!0,!this.$_preventShow&&this.show({event:s}))};this.$_registerTriggerListeners(this.$_targetNodes,bo,this.triggers,this.showTriggers,e),this.$_registerTriggerListeners([this.$_popperNode],bo,this.popperTriggers,this.popperShowTriggers,e);const t=s=>{s.usedByTooltip||this.hide({event:s})};this.$_registerTriggerListeners(this.$_targetNodes,yo,this.triggers,this.hideTriggers,t),this.$_registerTriggerListeners([this.$_popperNode],yo,this.popperTriggers,this.popperHideTriggers,t)},$_registerEventListeners(e,t,s){this.$_events.push({targetNodes:e,eventType:t,handler:s}),e.forEach(i=>i.addEventListener(t,s,At?{passive:!0}:void 0))},$_registerTriggerListeners(e,t,s,i,n){let o=s;i!=null&&(o=typeof i=="function"?i(o):i),o.forEach(a=>{const l=t[a];l&&this.$_registerEventListeners(e,l,n)})},$_removeEventListeners(e){const t=[];this.$_events.forEach(s=>{const{targetNodes:i,eventType:n,handler:o}=s;!e||e===n?i.forEach(a=>a.removeEventListener(n,o)):t.push(s)}),this.$_events=t},$_refreshListeners(){this.$_isDisposed||(this.$_removeEventListeners(),this.$_addEventListeners())},$_handleGlobalClose(e,t=!1){this.$_showFrameLocked||(this.hide({event:e}),e.closePopover?this.$emit("close-directive"):this.$emit("auto-hide"),t&&(this.$_preventShow=!0,setTimeout(()=>{this.$_preventShow=!1},300)))},$_detachPopperNode(){this.$_popperNode.parentNode&&this.$_popperNode.parentNode.removeChild(this.$_popperNode)},$_swapTargetAttrs(e,t){for(const s of this.$_targetNodes){const i=s.getAttribute(e);i&&(s.removeAttribute(e),s.setAttribute(t,i))}},$_applyAttrsToTarget(e){for(const t of this.$_targetNodes)for(const s in e){const i=e[s];i==null?t.removeAttribute(s):t.setAttribute(s,i)}},$_updateParentShownChildren(e){let t=this.parentPopper;for(;t;)e?t.shownChildren.add(this.randomId):(t.shownChildren.delete(this.randomId),t.$_pendingHide&&t.hide()),t=t.parentPopper},$_isAimingPopper(){const e=this.$_referenceNode.getBoundingClientRect();if(ps>=e.left&&ps<=e.right&&hs>=e.top&&hs<=e.bottom){const t=this.$_popperNode.getBoundingClientRect(),s=ps-ht,i=hs-ut,o=t.left+t.width/2-ht+(t.top+t.height/2)-ut+t.width+t.height,a=ht+s*o,l=ut+i*o;return Os(ht,ut,a,l,t.left,t.top,t.left,t.bottom)||Os(ht,ut,a,l,t.left,t.top,t.right,t.top)||Os(ht,ut,a,l,t.right,t.top,t.right,t.bottom)||Os(ht,ut,a,l,t.left,t.bottom,t.right,t.bottom)}return!1}},render(){return this.$slots.default(this.slotData)}});typeof document<"u"&&typeof window<"u"&&(za?(document.addEventListener("touchstart",_o,At?{passive:!0,capture:!0}:!0),document.addEventListener("touchend",xd,At?{passive:!0,capture:!0}:!0)):(window.addEventListener("mousedown",_o,!0),window.addEventListener("click",wd,!0)),window.addEventListener("resize",Td));function _o(e){for(let t=0;t<Ae.length;t++){const s=Ae[t];try{const i=s.popperNode();s.$_mouseDownContains=i.contains(e.target)}catch{}}}function wd(e){Wa(e)}function xd(e){Wa(e,!0)}function Wa(e,t=!1){const s={};for(let i=Ae.length-1;i>=0;i--){const n=Ae[i];try{const o=n.$_containsGlobalTarget=_d(n,e);n.$_pendingHide=!1,requestAnimationFrame(()=>{if(n.$_pendingHide=!1,!s[n.randomId]&&ko(n,o,e)){if(n.$_handleGlobalClose(e,t),!e.closeAllPopover&&e.closePopover&&o){let l=n.parentPopper;for(;l;)s[l.randomId]=!0,l=l.parentPopper;return}let a=n.parentPopper;for(;a&&ko(a,a.$_containsGlobalTarget,e);){a.$_handleGlobalClose(e,t);a=a.parentPopper}}})}catch{}}}function _d(e,t){const s=e.popperNode();return e.$_mouseDownContains||s.contains(t.target)}function ko(e,t,s){return s.closeAllPopover||s.closePopover&&t||kd(e,s)&&!t}function kd(e,t){if(typeof e.autoHide=="function"){const s=e.autoHide(t);return e.lastAutoHide=s,s}return e.autoHide}function Td(e){for(let t=0;t<Ae.length;t++)Ae[t].$_computePosition(e)}function Yi(){for(let e=0;e<Ae.length;e++)Ae[e].hide()}let ht=0,ut=0,ps=0,hs=0;typeof window<"u"&&window.addEventListener("mousemove",e=>{ht=ps,ut=hs,ps=e.clientX,hs=e.clientY},At?{passive:!0}:void 0);function Os(e,t,s,i,n,o,a,l){const r=((a-n)*(t-o)-(l-o)*(e-n))/((l-o)*(s-e)-(a-n)*(i-t)),d=((s-e)*(t-o)-(i-t)*(e-n))/((l-o)*(s-e)-(a-n)*(i-t));return r>=0&&r<=1&&d>=0&&d<=1}var hi=(e,t)=>{const s=e.__vccOpts||e;for(const[i,n]of t)s[i]=n;return s};const $d={extends:qa()};function Sd(e,t,s,i,n,o){return T(),C("div",{ref:"reference",class:we(["v-popper",{"v-popper--shown":e.slotData.isShown}])},[yt(e.$slots,"default",Oo(yn(e.slotData)))],2)}var Cd=hi($d,[["render",Sd]]);function Pd(){var e=window.navigator.userAgent,t=e.indexOf("MSIE ");if(t>0)return parseInt(e.substring(t+5,e.indexOf(".",t)),10);var s=e.indexOf("Trident/");if(s>0){var i=e.indexOf("rv:");return parseInt(e.substring(i+3,e.indexOf(".",i)),10)}var n=e.indexOf("Edge/");return n>0?parseInt(e.substring(n+5,e.indexOf(".",n)),10):-1}let Hs;function Ki(){Ki.init||(Ki.init=!0,Hs=Pd()!==-1)}var ui={name:"ResizeObserver",props:{emitOnMount:{type:Boolean,default:!1},ignoreWidth:{type:Boolean,default:!1},ignoreHeight:{type:Boolean,default:!1}},emits:["notify"],mounted(){Ki(),Je(()=>{this._w=this.$el.offsetWidth,this._h=this.$el.offsetHeight,this.emitOnMount&&this.emitSize()});const e=document.createElement("object");this._resizeObject=e,e.setAttribute("aria-hidden","true"),e.setAttribute("tabindex",-1),e.onload=this.addResizeHandlers,e.type="text/html",Hs&&this.$el.appendChild(e),e.data="about:blank",Hs||this.$el.appendChild(e)},beforeUnmount(){this.removeResizeHandlers()},methods:{compareAndNotify(){(!this.ignoreWidth&&this._w!==this.$el.offsetWidth||!this.ignoreHeight&&this._h!==this.$el.offsetHeight)&&(this._w=this.$el.offsetWidth,this._h=this.$el.offsetHeight,this.emitSize())},emitSize(){this.$emit("notify",{width:this._w,height:this._h})},addResizeHandlers(){this._resizeObject.contentDocument.defaultView.addEventListener("resize",this.compareAndNotify),this.compareAndNotify()},removeResizeHandlers(){this._resizeObject&&this._resizeObject.onload&&(!Hs&&this._resizeObject.contentDocument&&this._resizeObject.contentDocument.defaultView.removeEventListener("resize",this.compareAndNotify),this.$el.removeChild(this._resizeObject),this._resizeObject.onload=null,this._resizeObject=null)}}};const Ld=fr();He("data-v-b329ee4c");const Rd={class:"resize-observer",tabindex:"-1"};je();const Id=Ld((e,t,s,i,n,o)=>(T(),Xe("div",Rd)));ui.render=Id;ui.__scopeId="data-v-b329ee4c";ui.__file="src/components/ResizeObserver.vue";var Ua=(e="theme")=>({computed:{themeClass(){return vd(this[e])}}});const Ad=Z({name:"VPopperContent",components:{ResizeObserver:ui},mixins:[Ua()],props:{popperId:String,theme:String,shown:Boolean,mounted:Boolean,skipTransition:Boolean,autoHide:Boolean,handleResize:Boolean,classes:Object,result:Object},emits:["hide","resize"],methods:{toPx(e){return e!=null&&!isNaN(e)?`${e}px`:null}}}),Od=["id","aria-hidden","tabindex","data-popper-placement"],Md={ref:"inner",class:"v-popper__inner"},Ed=m("div",{class:"v-popper__arrow-outer"},null,-1),Hd=m("div",{class:"v-popper__arrow-inner"},null,-1),jd=[Ed,Hd];function Nd(e,t,s,i,n,o){const a=bs("ResizeObserver");return T(),C("div",{id:e.popperId,ref:"popover",class:we(["v-popper__popper",[e.themeClass,e.classes.popperClass,{"v-popper__popper--shown":e.shown,"v-popper__popper--hidden":!e.shown,"v-popper__popper--show-from":e.classes.showFrom,"v-popper__popper--show-to":e.classes.showTo,"v-popper__popper--hide-from":e.classes.hideFrom,"v-popper__popper--hide-to":e.classes.hideTo,"v-popper__popper--skip-transition":e.skipTransition,"v-popper__popper--arrow-overflow":e.result&&e.result.arrow.overflow,"v-popper__popper--no-positioning":!e.result}]]),style:Ve(e.result?{position:e.result.strategy,transform:`translate3d(${Math.round(e.result.x)}px,${Math.round(e.result.y)}px,0)`}:void 0),"aria-hidden":e.shown?"false":"true",tabindex:e.autoHide?0:void 0,"data-popper-placement":e.result?e.result.placement:void 0,onKeyup:t[2]||(t[2]=Ia(l=>e.autoHide&&e.$emit("hide"),["esc"]))},[m("div",{class:"v-popper__backdrop",onClick:t[0]||(t[0]=l=>e.autoHide&&e.$emit("hide"))}),m("div",{class:"v-popper__wrapper",style:Ve(e.result?{transformOrigin:e.result.transformOrigin}:void 0)},[m("div",Md,[e.mounted?(T(),C(F,{key:0},[m("div",null,[yt(e.$slots,"default")]),e.handleResize?(T(),Xe(a,{key:0,onNotify:t[1]||(t[1]=l=>e.$emit("resize",l))})):ke("",!0)],64)):ke("",!0)],512),m("div",{ref:"arrow",class:"v-popper__arrow-container",style:Ve(e.result?{left:e.toPx(e.result.arrow.x),top:e.toPx(e.result.arrow.y)}:void 0)},jd,4)],4)],46,Od)}var Ya=hi(Ad,[["render",Nd]]),Ka={methods:{show(...e){return this.$refs.popper.show(...e)},hide(...e){return this.$refs.popper.hide(...e)},dispose(...e){return this.$refs.popper.dispose(...e)},onResize(...e){return this.$refs.popper.onResize(...e)}}};const Fd=Z({name:"VPopperWrapper",components:{Popper:Cd,PopperContent:Ya},mixins:[Ka,Ua("finalTheme")],props:{theme:{type:String,default:null}},computed:{finalTheme(){var e;return(e=this.theme)!=null?e:this.$options.vPopperTheme}},methods:{getTargetNodes(){return Array.from(this.$el.children).filter(e=>e!==this.$refs.popperContent.$el)}}});function Dd(e,t,s,i,n,o){const a=bs("PopperContent"),l=bs("Popper");return T(),Xe(l,{ref:"popper",theme:e.finalTheme,"target-nodes":e.getTargetNodes,"popper-node":()=>e.$refs.popperContent.$el,class:we([e.themeClass])},{default:Le(({popperId:r,isShown:d,shouldMountContent:h,skipTransition:u,autoHide:g,show:_,hide:M,handleResize:j,onResize:L,classes:I,result:A})=>[yt(e.$slots,"default",{shown:d,show:_,hide:M}),W(a,{ref:"popperContent","popper-id":r,theme:e.finalTheme,shown:d,mounted:h,"skip-transition":u,"auto-hide":g,"handle-resize":j,classes:I,result:A,onHide:M,onResize:L},{default:Le(()=>[yt(e.$slots,"popper",{shown:d,hide:M})]),_:2},1032,["popper-id","theme","shown","mounted","skip-transition","auto-hide","handle-resize","classes","result","onHide","onResize"])]),_:3},8,["theme","target-nodes","popper-node","class"])}var kn=hi(Fd,[["render",Dd]]);const zd=Z(ks(tt({},kn),{name:"VDropdown",vPopperTheme:"dropdown"})),Bd=Z(ks(tt({},kn),{name:"VMenu",vPopperTheme:"menu"})),qd=Z(ks(tt({},kn),{name:"VTooltip",vPopperTheme:"tooltip"})),Wd=Z({name:"VTooltipDirective",components:{Popper:qa(),PopperContent:Ya},mixins:[Ka],inheritAttrs:!1,props:{theme:{type:String,default:"tooltip"},html:{type:Boolean,default:e=>Xt(e.theme,"html")},content:{type:[String,Number,Function],default:null},loadingContent:{type:String,default:e=>Xt(e.theme,"loadingContent")}},data(){return{asyncContent:null}},computed:{isContentAsync(){return typeof this.content=="function"},loading(){return this.isContentAsync&&this.asyncContent==null},finalContent(){return this.isContentAsync?this.loading?this.loadingContent:this.asyncContent:this.content}},watch:{content:{handler(){this.fetchContent(!0)},immediate:!0},async finalContent(){await this.$nextTick(),this.$refs.popper.onResize()}},created(){this.$_fetchId=0},methods:{fetchContent(e){if(typeof this.content=="function"&&this.$_isShown&&(e||!this.$_loading&&this.asyncContent==null)){this.asyncContent=null,this.$_loading=!0;const t=++this.$_fetchId,s=this.content(this);s.then?s.then(i=>this.onResult(t,i)):this.onResult(t,s)}},onResult(e,t){e===this.$_fetchId&&(this.$_loading=!1,this.asyncContent=t)},onShow(){this.$_isShown=!0,this.fetchContent()},onHide(){this.$_isShown=!1}}}),Ud=["innerHTML"],Yd=["textContent"];function Kd(e,t,s,i,n,o){const a=bs("PopperContent"),l=bs("Popper");return T(),Xe(l,Ca({ref:"popper"},e.$attrs,{theme:e.theme,"popper-node":()=>e.$refs.popperContent.$el,onApplyShow:e.onShow,onApplyHide:e.onHide}),{default:Le(({popperId:r,isShown:d,shouldMountContent:h,skipTransition:u,autoHide:g,hide:_,handleResize:M,onResize:j,classes:L,result:I})=>[W(a,{ref:"popperContent",class:we({"v-popper--tooltip-loading":e.loading}),"popper-id":r,theme:e.theme,shown:d,mounted:h,"skip-transition":u,"auto-hide":g,"handle-resize":M,classes:L,result:I,onHide:_,onResize:j},{default:Le(()=>[e.html?(T(),C("div",{key:0,innerHTML:e.finalContent},null,8,Ud)):(T(),C("div",{key:1,textContent:U(e.finalContent)},null,8,Yd))]),_:2},1032,["class","popper-id","theme","shown","mounted","skip-transition","auto-hide","handle-resize","classes","result","onHide","onResize"])]),_:1},16,["theme","popper-node","onApplyShow","onApplyHide"])}var Vd=hi(Wd,[["render",Kd]]);const Va="v-popper--has-tooltip";function Gd(e,t){let s=e.placement;if(!s&&t)for(const i of Ba)t[i]&&(s=i);return s||(s=Xt(e.theme||"tooltip","placement")),s}function Ga(e,t,s){let i;const n=typeof t;return n==="string"?i={content:t}:t&&n==="object"?i=t:i={content:!1},i.placement=Gd(i,s),i.targetNodes=()=>[e],i.referenceNode=()=>e,i}let Si,ws,Jd=0;function Xd(){if(Si)return;ws=Ee([]),Si=Aa({name:"VTooltipDirectiveApp",setup(){return{directives:ws}},render(){return this.directives.map(t=>rc(Vd,ks(tt({},t.options),{shown:t.shown||t.options.shown,key:t.id})))},devtools:{hide:!0}});const e=document.createElement("div");document.body.appendChild(e),Si.mount(e)}function Ja(e,t,s){Xd();const i=Ee(Ga(e,t,s)),n=Ee(!1),o={id:Jd++,options:i,shown:n};return ws.value.push(o),e.classList&&e.classList.add(Va),e.$_popper={options:i,item:o,show(){n.value=!0},hide(){n.value=!1}}}function Xa(e){if(e.$_popper){const t=ws.value.indexOf(e.$_popper.item);t!==-1&&ws.value.splice(t,1),delete e.$_popper,delete e.$_popperOldShown,delete e.$_popperMountTarget}e.classList&&e.classList.remove(Va)}function To(e,{value:t,modifiers:s}){const i=Ga(e,t,s);if(!i.content||Xt(i.theme||"tooltip","disabled"))Xa(e);else{let n;e.$_popper?(n=e.$_popper,n.options.value=i):n=Ja(e,t,s),typeof t.shown<"u"&&t.shown!==e.$_popperOldShown&&(e.$_popperOldShown=t.shown,t.shown?n.show():n.hide())}}var Qd={beforeMount:To,updated:To,beforeUnmount(e){Xa(e)}};function $o(e){e.addEventListener("click",Qa),e.addEventListener("touchstart",Za,At?{passive:!0}:!1)}function So(e){e.removeEventListener("click",Qa),e.removeEventListener("touchstart",Za),e.removeEventListener("touchend",el),e.removeEventListener("touchcancel",tl)}function Qa(e){const t=e.currentTarget;e.closePopover=!t.$_vclosepopover_touch,e.closeAllPopover=t.$_closePopoverModifiers&&!!t.$_closePopoverModifiers.all}function Za(e){if(e.changedTouches.length===1){const t=e.currentTarget;t.$_vclosepopover_touch=!0;const s=e.changedTouches[0];t.$_vclosepopover_touchPoint=s,t.addEventListener("touchend",el),t.addEventListener("touchcancel",tl)}}function el(e){const t=e.currentTarget;if(t.$_vclosepopover_touch=!1,e.changedTouches.length===1){const s=e.changedTouches[0],i=t.$_vclosepopover_touchPoint;e.closePopover=Math.abs(s.screenY-i.screenY)<20&&Math.abs(s.screenX-i.screenX)<20,e.closeAllPopover=t.$_closePopoverModifiers&&!!t.$_closePopoverModifiers.all}}function tl(e){const t=e.currentTarget;t.$_vclosepopover_touch=!1}var Zd={beforeMount(e,{value:t,modifiers:s}){e.$_closePopoverModifiers=s,(typeof t>"u"||t)&&$o(e)},updated(e,{value:t,oldValue:s,modifiers:i}){e.$_closePopoverModifiers=i,t!==s&&(typeof t>"u"||t?$o(e):So(e))},beforeUnmount(e){So(e)}};function ep(e,t={}){e.$_vTooltipInstalled||(e.$_vTooltipInstalled=!0,Da(it,t),e.directive("tooltip",Qd),e.directive("close-popper",Zd),e.component("VTooltip",qd),e.component("VDropdown",zd),e.component("VMenu",Bd))}const tp={version:"2.0.0-beta.20",install:ep,options:it};function Ts(){Array.from(document.querySelectorAll(".table *")).forEach(t=>{Ja(t,{triggers:["hover"],content:sp(t),delay:0},null),t.addEventListener("mouseover",s=>{s.stopPropagation(),Yi()}),t.addEventListener("mouseenter",s=>{s.stopPropagation(),Yi()})})}function sp(e){const t=e.tagName.toLowerCase(),s=e.getAttribute("class"),i=e.getAttribute("id");return`<${t}${i?` id="${i}"`:""}${s?` class="${s}"`:""}>`}const ip=[{name:"Type Selector",helpTitle:"Select elements by their type",doThis:"Select the plates",selector:"plate",syntax:"tagname",help:"Selects all elements of a type. Type refers to the type of tag, so <tag>div</tag>, <tag>p</tag> and <tag>ul</tag> are all different element types.",examples:["<strong>div</strong> selects all <tag>div</tag> elements.","<strong>p</strong> selects all <tag>p</tag> elements."],markup:`
<plate></plate>
<plate></plate>
<bento></bento>
<plate></plate>
    ...
    <plate></plate>
    <plate></plate>
    `}],sl={name:"CSS Selectors",levels:ip,credits:'Credits: <a href="http://www.twitter.com/flukeout">@flukeout</a> for his work on <a href="https://flukeout.github.io/" target="_blank">CSS diner</a> that served as the foundation for this website',intro:`
    <p>To apply CSS to an element you need to select this element with a <b>selector</b>.</p>
    <p>CSS provides you with a number of different ways to do this, and you can explore them in this chapter.</p>`,onLevelStart(){Et(),Je(()=>Ts())}},Vs=(e,t,s)=>Math.min(Math.max(e,t),s);function Gs(){Array.from(document.querySelectorAll(".shake, .strobe")).forEach(e=>e.classList.remove("shake","strobe"))}const xs=e=>{!e||(e.classList.add("shake"),setTimeout(()=>{e.classList.remove("shake")},500))},Vi="html_css_training_progress";function Tn(e,t){return Array.isArray(P.progress.completed[e])&&P.progress.completed[e].includes(t)}function np(){const e=P.progress.currentChapter,t=P.progress.currentLevel;Tn(e,t)||(P.progress.completed.hasOwnProperty(e)||(P.progress.completed[e]=[]),P.progress.completed[e].push(t),$n())}function op(e){return Array.isArray(P.progress.completed[e])?Vs(P.progress.completed[e].length/st[e-1].levels.length*100,0,100):0}function ap(){var e;try{Object.assign(P.progress,JSON.parse((e=localStorage.getItem(Vi))!=null?e:"{}"))}catch{localStorage.removeItem(Vi),Gi()}}function $n(){localStorage.setItem(Vi,JSON.stringify(P.progress))}function Gi(){P.progress={currentChapter:1,currentLevel:0,completed:{}},$n()}function il(){P.menuOpened=!1}function Qt(){np(),Ot(P.progress.currentChapter,P.progress.currentLevel+1)}function Ot(e,t){const s=st[e-1];t>s.levels.length&&e<st.length?(e++,t=0):t<0&&e>1&&(e=Math.max(1,e-1),t=st[e-1].levels.length);const i=Vs(e,1,st.length),n=Vs(t,0,st[e-1].levels.length);(n!==P.progress.currentLevel||i!==P.progress.currentChapter)&&(P.progress.currentChapter=i,P.progress.currentLevel=n,Yi(),nl(),il())}function nl(){const e=Me.value,t=e.levels;P.progress.currentLevel=Vs(P.progress.currentLevel,0,t.length),P.level=t[P.progress.currentLevel-1],$n(),e.onLevelStart&&e.onLevelStart(P.level)}function lp(e){const t=P.level,s=document.querySelector(".game-wrapper");Gs();const i=document.querySelectorAll(".table-content plate");e.length===t.solution.length&&t.solution.every((o,a)=>e[a]===o)?(s.classList.add("win"),i.forEach(o=>{o.classList.add("clean")}),setTimeout(function(){s.classList.remove("win"),Qt()},1e3)):e.forEach((o,a)=>{if(t.solution[a]!==o){const l=i[a];xs(l)}})}const rp=[{name:"ID vs tag",markup:`
            <bento><plate></plate></bento>
    ...
    <p>To help you, here is a <a target="_blank" href="img/specifishity.png">cheat sheet on specificity explained with fish</a>.</p>`,levels:rp,onLevelStart(){Je(()=>Ts())}};function ts(e){var a,l,r,d;const t=P.level;if(!t)return;const s=Me.value.wrapperClass?`.${Me.value.wrapperClass}`:"",i=new Set([t.selector,...Object.keys((a=t.cssRules)!=null?a:{}),...Object.keys((l=t.cssRulesHidden)!=null?l:{})]);let n="";for(let h of i)n+=`
${s} ${h} {
${[...t.cssRules?(r=t.cssRules[h])!=null?r:[]:[],...t.cssRulesHidden?(d=t.cssRulesHidden[h])!=null?d:[]:[]].map(u=>`  ${u};`).join(`
`)}
}`;e&&e.length>0&&(n+=`
${s} ${t.selector} {
  ${e.join(`
`)}
}`);const o=document.getElementById("css-editor-stylesheet");o.innerHTML=n}function ol(e){const t=P.level;Gs();const s=document.querySelector(".game-wrapper"),i=Array.from(s.querySelectorAll(t.selector));ts(e),dp(e,t)?(s.classList.add("win"),i.forEach(o=>{o.classList.remove("strobe")}),setTimeout(function(){s.classList.remove("win"),Qt()},1500)):i.forEach(o=>{o.classList.remove("strobe"),xs(document.querySelector(".table-content"))})}function Co(e){return typeof e!="string"?e:e.replaceAll(/,\s+/g,",").replaceAll(/\s*\/\s*/g,"/").replaceAll(/'/g,'"').replace(/;$/,"").toLowerCase().trim()}function dp(e,t){if(!t.check)return!0;const s=Object.fromEntries(e.map(i=>[i.split(":")[0],i.split(":")[1]]).map(([i,n])=>[i.trim(),Co(n)]));return t.check.every(([i,...n])=>{const o=s[i];return n.some(a=>(a=Co(a),typeof o=="string"&&o===a||typeof a=="function"&&a(o)?!0:(console.log(`Expected ${i} to be ${a}, got ${o}`),!1)))})}const pp=[{name:"Inline display",doThis:"Set the display mode of apples to inline",selector:"apple",cssRulesHidden:{".table-content":["width: 800px","min-height: 360px"]},cssRules:{apple:["display: block"]},wrapperClass:"inline-layout",syntax:"display: inline",help:`<p>The <code>display</code> property does two things. The first thing it does is determine if the box it is applied to acts as <b>inline</b> or <b>block</b>. The second is to determine how the element's children should behave.</p>
...
`,markup:`
    ...
    <bento style="height: 200px;"><plate></plate></bento>
    `,check:[["vertical-align","middle"]]}],hp={name:"Inline & Block Layout",description:"Basic display modes of HTML content",levels:pp,intro:"<p>Let's learn the different ways to position elements in CSS !</p>",onLevelStart(){Je(()=>{Ts(),Et(),ts()})}},up=[{name:"Flex display",doThis:"Put the sushis on the plates",selector:"bento",wrapperClass:"flex-game",cssRules:{},syntax:"display: flex;",help:`<p>Flex layout lets you control the sizing and positioning of its direct child elements, that we will refer to as <b>items</b>. By default, flex layout has this behavior:
    <ul>
...
align-content: <value>`,help:"<p>Combine all what you learned to place the items correctly !</p>",markup:`
    ...
    <plate class="egg"></plate>
    <plate class="egg"></plate>
    </div>`,inputLinesNumber:4,check:[["flex-wrap","wrap"],["flex-direction","column"],["justify-content","center"],["align-content","space-evenly"]]}],fp={name:"Flex Layout",description:"One-directional content flow",levels:up,credits:'Credits: <a href="https://github.com/thomaspark">Thomas Park</a> for its inspiring <a target="_blank" href="https://flexboxfroggy.com/">Flexbox Froggy</a> game.',intro:`<p>Let's learn the different ways to position elements in CSS !</p>
...
grid-auto-columns: <dims>...`,examples:["<code>grid-auto-rows: minmax(100px, auto);</code> will automatically create rows at a minimum size of 100px.","<code>grid-auto-columns: 100px 200px</code> will automatically create columns alternating between 100px and 200px."],help:`<p>When you are not explicitely declaring a grid with <code>grid-template</code> properties, or when the explicit grid is full, the items are placed in new tracks, automatically created. These tracks are referred to as the <strong>implicit grid</strong>.</p>
    ...
    `,hintMarkup:`<div class="hint-wrapper" style='grid-auto-flow: column; grid-template-rows: 100%; grid-auto-columns: 100px 1fr'>
      ...
      <div title="broccoli"></div>
      <div title="rice (100px wide)"></div>
    </div>`,check:[["grid-auto-columns","100px 1fr","100px auto","100px 1fr 100px 1fr 100px"]]},{name:"Implicit Grid - auto-fit / auto-fill",doThis:"Distribute the food in the correct areas of the bento",selector:"bento",wrapperClass:"grid-game",cssRules:{bento:["display: grid"]},syntax:`repeat(
  auto-fit,
  minmax(100px, 1fr)
    ...
    `,hintMarkup:`<div class="hint-wrapper" style='grid-auto-flow: row dense;'>      
      ...
      <div title="fruits"></div>
    </div>`,check:[["grid-auto-flow","dense","row dense"]]}],mp={name:"Grid Layout",description:"Powerful 2D layouts",levels:gp,credits:'Credits: inspired from <a href="https://cssgridgarden.com/" target="_blank">CSS Grid Garden</a> by <a href="https://codepip.com" target="_blank">Codepip</a>',intro:`<p>Let's learn the different ways to position elements in CSS !</p>
  <p>While flexbox is a great layout tool for <b>one-directional</b> flow, we still need a solution for complex 2D placement.</p>
  <p>CSS Grid is this solution. It consists of around 24 new CSS properties that provides a powerful way to create two-dimensional layouts. Let's dig in !</p>`,onLevelStart(){Je(()=>{Ts(),Et(),ts()})}},me=`
...
`,bp=[{name:"Font Families",selector:"h1",cssImports:["https://fonts.googleapis.com/css?family=Reggae+One"],cssRules:{},syntax:'font-family: "MyFontName"',help:`<p>Use the <code>font-family</code> property to change the typeface of the text in an element.</p>
...
filter: sepia(<val>)`,help:`
  ...
  <img src="img/sushis/4.png" width="300" />`,onLevelStart(){Je(()=>{Et(),ts()})}},st=[Hc,sl,cp,hp,fp,mp,yp,wp],P=ti({progress:{completed:{},currentChapter:1,currentLevel:0},level:Oa[0],menuOpened:!1});window.state=P;const Me=ce(()=>st[P.progress.currentChapter-1]);var Po;const $s=typeof window<"u",xp=e=>typeof e=="string",Ci=()=>{};$s&&((Po=window==null?void 0:window.navigator)==null?void 0:Po.userAgent)&&/iP(ad|hone|od)/.test(window.navigator.userAgent);function _p(e){return typeof e=="function"?e():k(e)}function kp(e){return e}function Tp(e){return Ll()?(Rl(e),!0):!1}function $p(e){var t;const s=_p(e);return(t=s==null?void 0:s.$el)!=null?t:s}const al=$s?window:void 0;$s&&window.document;$s&&window.navigator;$s&&window.location;function ll(...e){let t,s,i,n;if(xp(e[0])?([s,i,n]=e,t=al):[t,s,i,n]=e,!t)return Ci;let o=Ci;const a=Ut(()=>$p(t),r=>{o(),r&&(r.addEventListener(s,i,n),o=()=>{r.removeEventListener(s,i,n),o=Ci})},{immediate:!0,flush:"post"}),l=()=>{a(),o()};return Tp(l),l}const Sp=e=>typeof e=="function"?e:typeof e=="string"?t=>t.key===e:Array.isArray(e)?t=>e.includes(t.key):e?()=>!0:()=>!1;function Pi(e,t,s={}){const{target:i=al,eventName:n="keydown",passive:o=!1}=s,a=Sp(e);return ll(i,n,r=>{a(r)&&t(r)},o)}const Ji=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},Xi="__vueuse_ssr_handlers__";Ji[Xi]=Ji[Xi]||{};Ji[Xi];var Lo;(function(e){e.UP="UP",e.RIGHT="RIGHT",e.DOWN="DOWN",e.LEFT="LEFT",e.NONE="NONE"})(Lo||(Lo={}));var Cp=Object.defineProperty,Ro=Object.getOwnPropertySymbols,Pp=Object.prototype.hasOwnProperty,Lp=Object.prototype.propertyIsEnumerable,Io=(e,t,s)=>t in e?Cp(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s,Rp=(e,t)=>{for(var s in t||(t={}))Pp.call(t,s)&&Io(e,s,t[s]);if(Ro)for(var s of Ro(t))Lp.call(t,s)&&Io(e,s,t[s]);return e};const Ip={easeInSine:[.12,0,.39,0],easeOutSine:[.61,1,.88,1],easeInOutSine:[.37,0,.63,1],easeInQuad:[.11,0,.5,0],easeOutQuad:[.5,1,.89,1],easeInOutQuad:[.45,0,.55,1],easeInCubic:[.32,0,.67,0],easeOutCubic:[.33,1,.68,1],easeInOutCubic:[.65,0,.35,1],easeInQuart:[.5,0,.75,0],easeOutQuart:[.25,1,.5,1],easeInOutQuart:[.76,0,.24,1],easeInQuint:[.64,0,.78,0],easeOutQuint:[.22,1,.36,1],easeInOutQuint:[.83,0,.17,1],easeInExpo:[.7,0,.84,0],easeOutExpo:[.16,1,.3,1],easeInOutExpo:[.87,0,.13,1],easeInCirc:[.55,0,1,.45],easeOutCirc:[0,.55,.45,1],easeInOutCirc:[.85,0,.15,1],easeInBack:[.36,0,.66,-.56],easeOutBack:[.34,1.56,.64,1],easeInOutBack:[.68,-.6,.32,1.6]};Rp({linear:kp},Ip);const Ap={key:0,class:"credits"},Op=["innerHTML"],Mp=Z({__name:"About",setup(e){const t=ce(()=>Me.value.credits);return(s,i)=>k(t)?(T(),C("div",Ap,[m("p",{innerHTML:k(t)},null,8,Op)])):ke("",!0)}});const he=(e,t)=>{const s=e.__vccOpts||e;for(const[i,n]of t)s[i]=n;return s},Ep=he(Mp,[["__scopeId","data-v-9c9636d8"]]);const Hp={},rl=e=>(He("data-v-a0de842d"),e=e(),je(),e),jp=Q(" HTML/CSS Training "),Np=rl(()=>m("div",{class:"logo"},[m("img",{src:""})],-1)),Fp=rl(()=>m("span",{class:"share-menu"},[Q(" Repository "),m("a",{class:"share-github",type:"github",href:"#"})],-1)),Dp=[jp,Np,Fp];function zp(e,t){return T(),C("header",null,Dp)}const Bp=he(Hp,[["render",zp],["__scopeId","data-v-a0de842d"]]),qp=e=>(He("data-v-5e4fbae2"),e=e(),je(),e),Wp={class:"chapter-intro"},Up={class:"chapter-name"},Yp=qp(()=>m("hr",null,null,-1)),Kp=Z({__name:"ChapterIntro",setup(e){return(t,s)=>(T(),C("div",Wp,[m("h1",null,[Q("Chapter "+U(k(P).progress.currentChapter)+": ",1),m("p",Up,U(k(Me).name),1)]),Yp,m("p",null,U(k(Me).description),1)]))}});const Vp=he(Kp,[["__scopeId","data-v-5e4fbae2"]]);let Gp=(e=21)=>crypto.getRandomValues(new Uint8Array(e)).reduce((t,s)=>(s&=63,s<36?t+=s.toString(36):s<62?t+=(s-26).toString(36).toUpperCase():s>62?t+="-":t+="_",t),"");function Jp(e){const t=e.contentDocument,s=e.contentWindow;((i,n)=>{const o="div",a=["#c33","#ea4c88","#639","#06c","#690","#fc3","#f90","#963"];function l(A){return a[A%(a.length-1)]}function r(A,O,D,oe,ue,fe,ie,z){const le=t.createElement(o);return le.dataset.faceFor=z,new Map().set("position","absolute").set("transform-origin",["left","top"]).set("background",ie).set("width",`${oe}px`).set("height",`${ue}px`).set("opacity","0.8").set("transform",`translate3d(${A}px, ${O}px, ${D}px) rotateX(270deg) rotateY(${fe}deg)`).forEach((ae,de)=>le.style[de]=Array.isArray(ae)?ae.join(" "):ae),le.outerHTML}const d=.001;let h="";function u(A,O,D,oe){const ue=A.childNodes,fe=ue.length;for(let ie=0;ie<fe;ie++){const z=ue[ie];if(z.nodeType===Node.ELEMENT_NODE){const le=Gp();z.dataset.uid=le,z.style.overflow="visible",z.style.transformStyle="preserve-3d",z.style.transform=`translateZ(${(i+(fe-ie)*d).toFixed(3)}px)`;let ae=D,de=oe;z.offsetParent===A&&(ae+=A.offsetLeft,de+=A.offsetTop),u(z,O+1,ae,de);const xe=(O+1)*i,ge=l(O);h+=r(ae+z.offsetLeft,de+z.offsetTop,xe,z.offsetWidth,i,0,ge,le),h+=r(ae+z.offsetLeft+z.offsetWidth,de+z.offsetTop,xe,z.offsetHeight,i,270,ge,le),h+=r(ae+z.offsetLeft,de+z.offsetTop+z.offsetHeight,xe,z.offsetWidth,i,0,ge,le),h+=r(ae+z.offsetLeft,de+z.offsetTop,xe,z.offsetHeight,i,270,ge,le)}}}const g=t.body;g.style.overflow="visible",g.style.transformStyle="preserve-3d",g.style.perspective=n.toString();const _=A=>(A/2).toFixed(2),M=`${_(s.innerWidth)}px ${_(s.innerHeight)}px`;g.style.perspectiveOrigin=M,g.style.transformOrigin=M,u(g,0,0,0),t.addEventListener("mousemove",A=>{if(!A.ctrlKey){const O=A.clientX/s.innerWidth,D=1-A.clientY/s.innerHeight,oe=120,ue=fe=>((fe-.5)*oe).toFixed(2);g.style.transform=`rotateX(${ue(D)}deg) rotateY(${ue(O)}deg)`}},!0),t.addEventListener("mouseover",A=>{if(A.ctrlKey){const O=A.target,D=O.dataset.uid||O.dataset.faceFor;O.dataset.faceFor&&Array.from(t.querySelectorAll(`[data-uid="${D}"], [data-face-for="${D}"]`)).forEach(oe=>oe.classList.add("hovered"))}}),t.addEventListener("mouseleave",A=>{t.querySelectorAll(".hovered").forEach(O=>O.classList.remove("hovered"))}),t.addEventListener("mouseout",A=>{const O=A.target,D=O.dataset.uid||O.dataset.faceFor;Array.from(t.querySelectorAll(`[data-uid="${D}"], [data-face-for="${D}"]`)).forEach(oe=>oe.classList.remove("hovered"))}),t.addEventListener("click",A=>{var D;let O=A.target;O.nodeName==="A"&&A.preventDefault(),O.dataset.faceFor&&(O=t.querySelector(`[data-uid="${O.dataset.faceFor}"]`)),O&&((D=s.top)==null||D.postMessage({event:"elementClick",tag:O.tagName.toLowerCase(),type:O.getAttribute("type")}))});const j=t.createElement(o);j.style.position="absolute",j.style.transformStyle="preserve-3d";const{marginTop:L,marginLeft:I}=getComputedStyle(g);j.style.top=`-${L}`,j.style.left=`-${I}`,j.innerHTML=h,g.appendChild(j),g.style.transition="transform 400ms ease-in-out",g.style.transform="rotateX(-22.5deg) rotateY(12.5deg)",setTimeout(()=>{g.style.transition=""},400)})(50,5e3)}const Xp={},Qp={id:"correct-animation"};function Zp(e,t){return T(),C("div",Qp," \u2714\uFE0F Correct ")}const Ss=he(Xp,[["render",Zp]]),cl=e=>(He("data-v-7c679098"),e=e(),je(),e),eh={key:0},th=Q("Use the "),sh=cl(()=>m("b",null,"3D",-1)),ih=Q(" view and the "),nh=cl(()=>m("b",null,"Ctrl",-1)),oh=Q(" key to select elements in the DOM."),ah=[th,sh,ih,nh,oh],lh=Z({__name:"InteractiveDOM",setup(e){const t=ce(()=>P.level),s=Ee(!1),i=Ee(null),n=Ee(!1);function o(){if(!i.value)return;const a=i.value;s.value===!0&&a.contentWindow?(a.contentWindow.location.reload(),s.value=!1):(Jp(a),s.value=!0)}return ll("message",a=>{if(a.data.event==="elementClick"){const l=a.data,r=l.tag,d=P.level;if(r==null||!d.tag)return;Ec(l,d)?(n.value=!0,setTimeout(()=>{n.value=!1,Qt()},600)):xs(document.querySelector("iframe"))}}),(a,l)=>(T(),C(F,null,[m("p",{class:"order",style:Ve({opacity:k(t).order&&!n.value?1:0})},U(k(t).order||"\xA0"),5),m("div",{class:we(["game-wrapper",{win:n.value}])},[W(Ss),m("iframe",{src:"demo/chapter1.html",ref_key:"iframe",ref:i,scrolling:"no"},null,512)],2),k(t).order&&k(t).tag?(T(),C("p",eh,ah)):ke("",!0),m("button",{onClick:o,id:"button-3d"},U(s.value?"2D":"3D"),1)],64))}});const rh=he(lh,[["__scopeId","data-v-7c679098"]]),ch={class:"input-header"},dh={key:0,class:"file-name"},ph={class:"file-window"},hh={class:"line-numbers"},uh=m("br",null,null,-1),Qi=Z({__name:"EditorPane",props:{title:String,fileName:{type:String,required:!1},lang:String,nbLines:{type:Number,default:20}},setup(e){return(t,s)=>(T(),C("div",{class:we(["editor-pane",e.lang+"-view"])},[m("div",ch,[e.fileName?(T(),C("div",dh,U(e.fileName),1)):ke("",!0),Q(" "+U(e.title),1)]),m("div",ph,[m("div",hh,[(T(!0),C(F,null,Ce(e.nbLines,i=>(T(),C(F,null,[Q(U(i),1),uh],64))),256))]),yt(t.$slots,"default")])],2))}});const fh={class:"markup"},dl=Z({__name:"HTMLMarkup",props:{markup:String},setup(e){const t=e,s=Ee(null);pa(i),Ut(()=>t.markup,i);function i(){var a;const o=document.createElement("div");o.innerHTML=(a=t.markup)!=null?a:"",s.value&&(s.value.innerHTML=n(o,!0).innerHTML)}function n(o,a){if(o instanceof HTMLElement){const l=document.createElement("div"),r=o.tagName.toLowerCase(),d=o.getAttributeNames().map(u=>`${u}="${o.getAttribute(u)}"`).join(" "),h=Array.from(o.childNodes);return h.length>0?(a||(l.textContent=`<${r}${d?" "+d:""}>`),h.forEach(u=>l.appendChild(n(u,!1))),a||l.appendChild(document.createTextNode(`</${r}>`))):l.textContent=`<${r}${d?" "+d:""} />`,l}else{const l=document.createElement("span");return l.textContent=o.textContent,l}}return(o,a)=>(T(),C("div",fh,[m("div",{ref_key:"container",ref:s},null,512)]))}});const gh=e=>(He("data-v-fbbaf797"),e=e(),je(),e),mh=["onKeydown","onKeyup","placeholder"],bh=gh(()=>m("span",{class:"plus"},"+",-1)),yh=Z({__name:"Editor",props:{placeholder:String},emits:["input"],setup(e,{emit:t}){const s=()=>n.value?n.value.value:"",i=Ee(null),n=Ee(null),o=ce(()=>P.level),a=ce(()=>{var d;return{height:((d=P.level.inputLinesNumber)!=null?d:1)*1.5+"em"}});function l(d){var g;const u=s().split(`
`).map(_=>_.trim()).map(_=>Me.value===sl||_.endsWith(";")?_:_+";");if(u.length>=((g=o.value.inputLinesNumber)!=null?g:1)){d.preventDefault();const _=i.value;_.classList.remove("enterhit"),setTimeout(()=>_.classList.add("enterhit"),0)}n.value&&(n.value.value=u.join(`
`)),t("input",u)}function r(){const d=n.value;d.classList.toggle("input-strobe",d.value.length>0)}return(d,h)=>(T(),C("div",{class:"editor",onClick:h[0]||(h[0]=u=>{var g;return(g=n.value)==null?void 0:g.focus()})},[W(Qi,{title:"CSS Editor",fileName:"style.css",lang:"css"},{default:Le(()=>[yt(d.$slots,"code-before",{},void 0,!0),m("textarea",{id:"editor-input",class:"input-strobe",type:"text",ref_key:"inputElement",ref:n,onKeydown:Ia(l,["enter"]),onKeyup:qs(r,["prevent"]),placeholder:e.placeholder,style:Ve(k(a))},null,44,mh),bh,m("div",{class:"enter-button",onClick:l,ref_key:"enterButton",ref:i},"enter",512),yt(d.$slots,"code-after",{},void 0,!0)]),_:3}),W(Qi,{title:"HTML Viewer",fileName:"table.html",lang:"html"},{default:Le(()=>[W(dl,{markup:k(o).markup},null,8,["markup"])]),_:1})]))}});const Sn=he(yh,[["__scopeId","data-v-fbbaf797"]]),vh={name:"Table",props:["content","hintContent"]};const pl=e=>(He("data-v-1e2c3b82"),e=e(),je(),e),wh={class:"table-wrapper"},xh={class:"table-surface",ref:"surface"},_h={class:"table-content"},kh=["innerHTML"],Th=["innerHTML"],$h={key:2,ref:"board",class:"table"},Sh={class:"table-edge",ref:"edge"},Ch=pl(()=>m("div",{class:"table-leg"},null,-1)),Ph=pl(()=>m("div",{class:"table-leg"},null,-1)),Lh=[Ch,Ph];function Rh(e,t,s,i,n,o){return T(),C("div",wh,[m("div",xh,null,512),m("div",_h,[s.hintContent?(T(),C("div",{key:0,class:"hint-content",innerHTML:s.hintContent},null,8,kh)):ke("",!0),s.content?(T(),C("div",{key:1,innerHTML:s.content,ref:"board",class:"table"},null,8,Th)):(T(),C("div",$h,[yt(e.$slots,"default",{},void 0,!0)],512))]),m("div",Sh,Lh,512)])}const Cn=he(vh,[["render",Rh],["__scopeId","data-v-1e2c3b82"]]),Pn=e=>(He("data-v-0dd7850c"),e=e(),je(),e),Ih={class:"order"},Ah={class:"game-container"},Oh={class:"game-wrapper"},Mh=Pn(()=>m("br",null,null,-1)),Eh=Q("{"),Hh=Pn(()=>m("br",null,null,-1)),jh=Q(" /* Styles would go here. */"),Nh=Pn(()=>m("br",null,null,-1)),Fh=Q(" } "),Dh=Z({__name:"SelectorGame",setup(e){const t=ce(()=>P.level);function s(n){const o=P.level;Gs();const a=document.querySelector(".table-content"),l=document.querySelector(".game-wrapper");try{a.querySelectorAll(n)}catch{n=""}const r=n?Array.from(a.querySelectorAll(n)):[],d=Array.from(a.querySelectorAll(o.selector));let h=!1;r.length==0&&xs(document.querySelector(".editor")),r.length===d.length&&r.length>0&&(h=i(r,d)),h?(l.classList.add("win"),r.forEach(u=>{u.classList.remove("strobe"),u.classList.add("clean")}),Et(),setTimeout(function(){l.classList.remove("win"),Qt()},1e3)):(r.forEach(u=>{u.classList.remove("strobe"),xs(u)}),setTimeout(function(){Gs(),d.forEach(u=>{u.classList.add("strobe")})},500))}function i(n,o){return n.length===o.length&&n.every(a=>o.includes(a))}return(n,o)=>(T(),C(F,null,[m("p",Ih,U(k(t).doThis),1),m("div",Ah,[m("div",Oh,[W(Ss),W(Cn,{content:k(t).markup},null,8,["content"])])]),W(Sn,{placeholder:"Type in a CSS selector",onInput:o[0]||(o[0]=a=>s(a[0]))},{"code-after":Le(()=>[Mh,Eh,Hh,jh,Nh,Fh]),_:1})],64))}});const zh=he(Dh,[["__scopeId","data-v-0dd7850c"]]),Bh={class:"customer-wrapper"},qh={class:"customer-speech-bubble"},Wh={class:"customer-body"},Uh={class:"code"},Yh=Z({__name:"Customer",props:{request:String,selector:String,meal:String},setup(e){return(t,s)=>(T(),C("div",Bh,[m("div",qh,U(e.request),1),m("div",Wh,[m("div",Uh,[m("pre",null,U(e.selector)+` {\r
  meal: `+U(e.meal)+`;\r
}`,1)])])]))}});const Kh=he(Yh,[["__scopeId","data-v-c1c4318a"]]),Vh={class:"game-container"},Gh={class:"game-wrapper"},Jh={class:"customers"},Xh={class:"editor"},Qh=Z({__name:"SpecificityGame",setup(e){const t=ce(()=>P.level);function s(l){const r=l.target.closest("plate");r&&n(r)}const i=["sushi","toast","apple","pickle"];function n(l){var h,u;const r=l.firstChild,d=i[i.indexOf((u=(h=r==null?void 0:r.tagName)==null?void 0:h.toLowerCase())!=null?u:"soup")+1]||"sushi";r==null?l.appendChild(document.createElement(d)):l.replaceChild(document.createElement(d),r)}const o=Ee(null);function a(){const r=[...o.value.$el.querySelectorAll("plate")].map(d=>d.firstElementChild?d.firstElementChild.tagName.toLowerCase():"");lp(r)}return(l,r)=>(T(),C("div",Vh,[m("div",Gh,[W(Ss),W(Cn,{content:k(t).markup,onClick:s,ref_key:"table",ref:o},null,8,["content"]),m("div",{class:"actions"},[m("button",{onClick:a,id:"submit-button"},"Validate")]),m("div",Jh,[(T(!0),C(F,null,Ce(k(t).customers,d=>(T(),Xe(Kh,Oo(yn(d)),null,16))),256))]),m("div",Xh,[W(Qi,{title:"HTML Viewer",fileName:"table.html",lang:"html"},{default:Le(()=>[W(dl,{markup:k(t).markup},null,8,["markup"])]),_:1})])])]))}});const Zh=he(Qh,[["__scopeId","data-v-00d68f52"]]),Ht=e=>(He("data-v-4ea136c9"),e=e(),je(),e),eu={class:"order"},tu={class:"game-container"},su={class:"game-wrapper"},iu=Ht(()=>m("br",null,null,-1)),nu=Ht(()=>m("br",null,null,-1)),ou=Q(" }"),au=Ht(()=>m("br",null,null,-1)),lu=Ht(()=>m("br",null,null,-1)),ru=Ht(()=>m("br",null,null,-1)),cu=Ht(()=>m("br",null,null,-1)),du=Ht(()=>m("br",null,null,-1)),pu=Q("} "),hu=Z({__name:"LayoutGame",setup(e){const t=ce(()=>P.level),s=ce(()=>{var n;return Object.fromEntries(Object.entries((n=t.value.cssRules)!=null?n:{}).filter(([o])=>o!==t.value.selector))}),i=n=>t.value.cssRules?t.value.cssRules[n]||[]:[];return(n,o)=>(T(),C(F,null,[m("p",eu,U(k(t).doThis),1),m("div",tu,[m("div",su,[W(Ss),(T(),Xe(Cn,{content:k(t).markup,hintContent:k(t).hintMarkup,key:k(t).name,class:we(k(t).wrapperClass||k(Me).wrapperClass)},null,8,["content","hintContent","class"]))])]),W(Sn,{placeholder:"Type styles here",onInput:o[0]||(o[0]=a=>k(ol)(a))},{"code-before":Le(()=>[(T(!0),C(F,null,Ce(k(s),(a,l)=>(T(),C(F,{key:"selector_"+l},[Q(U(l)+" {",1),iu,(T(!0),C(F,null,Ce(a,r=>(T(),C(F,{key:l+"_"+r},[Q("\xA0\xA0"+U(r)+";",1),nu],64))),128)),ou,au,lu],64))),128)),Q(" "+U(k(t).selector)+" {",1),ru,(T(!0),C(F,null,Ce(i(k(t).selector),a=>(T(),C(F,{key:k(t).selector+"_"+a},[Q("\xA0\xA0"+U(a)+";",1),cu],64))),128))]),"code-after":Le(()=>[du,pu]),_:1})],64))}});const uu=he(hu,[["__scopeId","data-v-4ea136c9"]]),ct=e=>(He("data-v-68061d69"),e=e(),je(),e),fu={class:"order"},gu={class:"game-container"},mu={class:"game-wrapper"},bu=["innerHTML"],yu={class:"expected-result"},vu=ct(()=>m("p",null,"Expected result:",-1)),wu=["src"],xu=["href"],_u=["href"],ku=ct(()=>m("br",null,null,-1)),Tu={key:0},$u=ct(()=>m("br",null,null,-1)),Su=ct(()=>m("br",null,null,-1)),Cu=Q(" }"),Pu=ct(()=>m("br",null,null,-1)),Lu=ct(()=>m("br",null,null,-1)),Ru=ct(()=>m("br",null,null,-1)),Iu=ct(()=>m("br",null,null,-1)),Au=ct(()=>m("br",null,null,-1)),Ou=Q("} "),Mu=Z({__name:"ReproduceGame",setup(e){const t=ce(()=>P.level),s=ce(()=>{var a;return Object.fromEntries(Object.entries((a=t.value.cssRules)!=null?a:{}).filter(([l])=>l!==t.value.selector))}),i=ce(()=>t.value.cssImports),n=ce(()=>t.value.cssImportsHidden),o=Ee("");return Ut(()=>t,()=>{o.value="",Je(()=>{var a;o.value=(a=t.value.markup)!=null?a:""})}),(a,l)=>(T(),C(F,null,[m("p",fu,U(k(t).doThis),1),m("div",gu,[m("div",mu,[W(Ss),m("div",{class:we(["game-content",k(t).wrapperClass||k(Me).wrapperClass]),innerHTML:k(t).markup},null,10,bu),m("div",yu,[vu,m("img",{src:k(t).expectedScreenshot},null,8,wu)])])]),W(Sn,{placeholder:"Type styles here",onInput:l[0]||(l[0]=r=>k(ol)(r))},{"code-before":Le(()=>{var r,d;return[(T(!0),C(F,null,Ce(k(n),h=>(T(),C("link",{rel:"stylesheet",href:h},null,8,xu))),256)),(T(!0),C(F,null,Ce(k(i),h=>(T(),C("link",{rel:"stylesheet",href:h},null,8,_u))),256)),(T(!0),C(F,null,Ce(k(i),h=>(T(),C(F,null,[Q('@import "'+U(h)+'";',1),ku],64))),256)),k(i)?(T(),C("br",Tu)):ke("",!0),(T(!0),C(F,null,Ce(k(s),(h,u)=>(T(),C(F,{key:"selector_"+u},[Q(U(u)+" {",1),$u,(T(!0),C(F,null,Ce(h,g=>(T(),C(F,{key:u+"_"+g},[Q("\xA0\xA0"+U(g)+";",1),Su],64))),128)),Cu,Pu,Lu],64))),128)),Q(" "+U(k(t).selector)+" {",1),Ru,(T(!0),C(F,null,Ce((d=((r=k(t).cssRules)!=null?r:{})[k(t).selector])!=null?d:[],h=>(T(),C(F,{key:k(t).selector+"_"+h},[Q("\xA0\xA0"+U(h)+";",1),Iu],64))),128))]}),"code-after":Le(()=>[Au,Ou]),_:1})],64))}});const Eu=he(Mu,[["__scopeId","data-v-68061d69"]]),Hu={class:"left-col"},ju={class:"left-panel"},Nu=Z({__name:"LeftCol",setup(e){const t=ce(()=>{if(P.progress.currentLevel===0)return Vp;switch(P.progress.currentChapter){case 1:return rh;case 2:return zh;case 3:return Zh;case 4:case 5:case 6:return uu;case 7:case 8:return Eu}});return(s,i)=>(T(),C("div",Hu,[W(Bp),m("div",ju,[(T(),Xe(fa(k(t))))]),W(Ep)]))}});const Fu=he(Nu,[["__scopeId","data-v-12bae500"]]),Du={class:"chapter-header"},zu=Z({__name:"ChapterHeader",setup(e){const t=ce(()=>st[P.progress.currentChapter-1]);return(s,i)=>(T(),C("h1",Du,"Chapter "+U(k(P).progress.currentChapter)+": "+U(k(t).name),1))}});const Bu=he(zu,[["__scopeId","data-v-e62a0f1e"]]),qu={class:"level-text"},Wu={key:0,class:"checkmark"},Uu={class:"level-nav"},Yu={key:1,class:"level-progress"},Ku=Z({__name:"LevelHeader",setup(e){const t=ce(()=>Me.value.levels),s=ce(()=>Tn(P.progress.currentChapter,P.progress.currentLevel));function i(n="next",o){const a=o.target;a.classList.add("link-jiggle"),setTimeout(()=>{a.classList.remove("link-jiggle")},1e3),n==="next"?Ot(P.progress.currentChapter,P.progress.currentLevel+1):Ot(P.progress.currentChapter,P.progress.currentLevel-1)}return(n,o)=>(T(),C(F,null,[k(P).progress.currentLevel>0?(T(),C("h2",{key:0,class:we(["level-header",{completed:k(s)}])},[m("span",qu," Level "+U(k(P).progress.currentLevel)+" of "+U(k(t).length),1),k(s)?(T(),C("span",Wu,"\u2714\uFE0F")):ke("",!0)],2)):ke("",!0),m("div",Uu,[m("a",{class:"previous",href:"#",onClick:o[0]||(o[0]=qs(a=>i("previous",a),["prevent"]))}),m("a",{class:"next",href:"#",onClick:o[1]||(o[1]=qs(a=>i("next",a),["prevent"]))})]),k(P).progress.currentLevel>0?(T(),C("div",Yu,[m("div",{class:"progress",style:Ve({width:k(op)(k(P).progress.currentChapter)+"%"})},null,4)])):ke("",!0)],64))}});const Vu=he(Ku,[["__scopeId","data-v-80b5bec5"]]),fi=e=>(He("data-v-01318d24"),e=e(),je(),e),Gu={class:"level-menu"},Ju=fi(()=>m("h2",null,"Choose a level",-1)),Xu={class:"chapters-list"},Qu={class:"chapters"},Zu=["onClick"],ef={class:"chapter-number"},tf=fi(()=>m("div",{class:"chapter-toggle"},null,-1)),sf={key:0,class:"levels"},nf=["onClick"],of=fi(()=>m("span",{class:"checkmark"},"\u2714\uFE0F",-1)),af={class:"level-number"},lf=fi(()=>m("div",{class:"level-menu-toggle"},null,-1)),rf=[lf],cf=Z({__name:"LevelMenu",setup(e){const t=Ee(P.progress.currentChapter);function s(n){n===t.value?t.value=0:t.value=n}function i(){P.menuOpened=!P.menuOpened}return(n,o)=>(T(),C(F,null,[m("div",Gu,[Ju,m("div",Xu,[m("ul",Qu,[(T(!0),C(F,null,Ce(k(st),(a,l)=>(T(),C("li",{key:"chapter_"+a.name},[m("a",{class:we([{current:l+1===k(P).progress.currentChapter,opened:l+1===t.value},"chapter-name"]),onClick:r=>s(l+1)},[m("span",ef,U(l+1),1),Q(" "+U(a.name)+" ",1),tf],10,Zu),l+1===t.value?(T(),C("ul",sf,[(T(!0),C(F,null,Ce(a.levels,(r,d)=>(T(),C("li",{key:"level_"+r.name},[m("a",{class:we({current:d+1===k(P).progress.currentLevel,completed:k(Tn)(l+1,d+1)}),onClick:h=>k(Ot)(l+1,d+1)},[of,m("span",af,U(d+1),1),Q(" "+U(r.name),1)],10,nf)]))),128))])):ke("",!0)]))),128))])]),m("a",{class:"reset-progress",href:"#",onClick:o[0]||(o[0]=qs((...a)=>k(Gi)&&k(Gi)(...a),["prevent"]))},"Reset Progress")]),m("div",{class:"level-menu-toggle-wrapper",onClick:i},rf)],64))}});const df=he(cf,[["__scopeId","data-v-01318d24"]]),pf=e=>(He("data-v-c2c1120b"),e=e(),je(),e),hf=pf(()=>m("hr",null,null,-1)),uf={class:"instructions"},ff=["innerHTML"],gf=Z({__name:"ChapterInstructions",setup(e){function t(){Ot(P.progress.currentChapter,1)}return(s,i)=>(T(),C(F,null,[hf,m("div",uf,[m("div",{innerHTML:k(Me).intro},null,8,ff)]),m("div",{class:"actions"},[m("button",{onClick:t},"Next")])],64))}});const mf=he(gf,[["__scopeId","data-v-c2c1120b"]]),bf=e=>(He("data-v-8f587bef"),e=e(),je(),e),yf={class:"instructions"},vf=["innerHTML"],wf=bf(()=>m("hr",null,null,-1)),xf={class:"title"},_f=["innerHTML"],kf={class:"actions"},Tf=Z({__name:"LevelInstructions",setup(e){const t=ce(()=>P.level);return(s,i)=>(T(),C(F,null,[m("div",yf,[k(Me).instructions?(T(),C(F,{key:0},[m("div",{innerHTML:k(Me).instructions},null,8,vf),wf],64)):ke("",!0),m("h3",xf,U(k(t).name),1),m("div",{innerHTML:k(P).level.instructions},null,8,_f)]),m("div",kf,[k(t).skippable?(T(),C("button",{key:0,onClick:i[0]||(i[0]=(...n)=>k(Qt)&&k(Qt)(...n))},"Next")):ke("",!0)])],64))}});const $f=he(Tf,[["__scopeId","data-v-8f587bef"]]),Sf={class:"display-help"},Cf={class:"title"},Pf={key:0,class:"syntax"},Lf=["innerHTML"],Rf={key:1,class:"examples-title"},If={class:"examples"},Af=["innerHTML"],Of=Z({__name:"SyntaxLevelInstructions",setup(e){const t=ce(()=>P.level);return(s,i)=>(T(),C("div",Sf,[m("h3",Cf,U(k(t).helpTitle||k(t).name),1),k(t).syntax?(T(),C("p",Pf,[m("pre",null,U(k(t).syntax),1)])):ke("",!0),m("div",{class:"hint",innerHTML:k(t).help},null,8,Lf),k(t).examples&&k(t).examples.length>0?(T(),C("h4",Rf,"Examples")):ke("",!0),m("div",If,[(T(!0),C(F,null,Ce(k(t).examples,n=>(T(),C("div",{class:"example",key:n,innerHTML:n},null,8,Af))),128))])]))}});const Mf=he(Of,[["__scopeId","data-v-ffb05728"]]),Ef={class:"doc-wrapper"},Hf=Z({__name:"RightCol",setup(e){const t=ce(()=>{if(P.progress.currentLevel===0)return mf;switch(P.progress.currentChapter){case 2:case 4:case 5:case 6:case 7:case 8:return Mf;case 1:case 3:default:return $f}});return(s,i)=>(T(),C("div",{class:we(["right-col",{"menu-open":k(P).menuOpened}])},[m("div",Ef,[W(Bu),W(Vu),(T(),Xe(fa(k(t))))]),W(df)],2))}});const jf=he(Hf,[["__scopeId","data-v-f319e6bc"]]),Nf=Z({__name:"App",setup(e){return Pi("Escape",t=>{t.preventDefault(),il()}),Pi("PageUp",t=>{t.preventDefault(),Ot(P.progress.currentChapter,P.progress.currentLevel-1)}),Pi("PageDown",t=>{t.preventDefault(),Ot(P.progress.currentChapter,P.progress.currentLevel+1)}),ap(),nl(),(t,s)=>(T(),C(F,null,[W(Fu),W(jf)],64))}});Aa(Nf).use(tp).mount("#app");
