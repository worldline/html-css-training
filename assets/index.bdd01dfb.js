(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function s(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerpolicy&&(o.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?o.credentials="include":n.crossorigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(n){if(n.ep)return;n.ep=!0;const o=s(n);fetch(n.href,o)}})();function an(e,t){const s=Object.create(null),i=e.split(",");for(let n=0;n<i.length;n++)s[i[n]]=!0;return t?n=>!!s[n.toLowerCase()]:n=>!!s[n]}const xr="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",_r=an(xr);function jo(e){return!!e||e===""}function tt(e){if(B(e)){const t={};for(let s=0;s<e.length;s++){const i=e[s],n=pe(i)?$r(i):tt(i);if(n)for(const o in n)t[o]=n[o]}return t}else{if(pe(e))return e;if(ne(e))return e}}const kr=/;(?![^(]*\))/g,Tr=/:(.+)/;function $r(e){const t={};return e.split(kr).forEach(s=>{if(s){const i=s.split(Tr);i.length>1&&(t[i[0].trim()]=i[1].trim())}}),t}function ye(e){let t="";if(pe(e))t=e;else if(B(e))for(let s=0;s<e.length;s++){const i=ye(e[s]);i&&(t+=i+" ")}else if(ne(e))for(const s in e)e[s]&&(t+=s+" ");return t.trim()}function Fo(e){if(!e)return null;let{class:t,style:s}=e;return t&&!pe(t)&&(e.class=ye(t)),s&&(e.style=tt(s)),e}const U=e=>pe(e)?e:e==null?"":B(e)||ne(e)&&(e.toString===qo||!q(e.toString))?JSON.stringify(e,zo,2):String(e),zo=(e,t)=>t&&t.__v_isRef?zo(e,t.value):Wt(t)?{[`Map(${t.size})`]:[...t.entries()].reduce((s,[i,n])=>(s[`${i} =>`]=n,s),{})}:Bo(t)?{[`Set(${t.size})`]:[...t.values()]}:ne(t)&&!B(t)&&!Wo(t)?String(t):t,Q={},qt=[],Be=()=>{},Cr=()=>!1,Sr=/^on[^a-z]/,ei=e=>Sr.test(e),rn=e=>e.startsWith("onUpdate:"),$e=Object.assign,ln=(e,t)=>{const s=e.indexOf(t);s>-1&&e.splice(s,1)},Pr=Object.prototype.hasOwnProperty,Y=(e,t)=>Pr.call(e,t),B=Array.isArray,Wt=e=>ti(e)==="[object Map]",Bo=e=>ti(e)==="[object Set]",q=e=>typeof e=="function",pe=e=>typeof e=="string",cn=e=>typeof e=="symbol",ne=e=>e!==null&&typeof e=="object",Do=e=>ne(e)&&q(e.then)&&q(e.catch),qo=Object.prototype.toString,ti=e=>qo.call(e),Lr=e=>ti(e).slice(8,-1),Wo=e=>ti(e)==="[object Object]",dn=e=>pe(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,js=an(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),si=e=>{const t=Object.create(null);return s=>t[s]||(t[s]=e(s))},Ar=/-(\w)/g,Ve=si(e=>e.replace(Ar,(t,s)=>s?s.toUpperCase():"")),Rr=/\B([A-Z])/g,Nt=si(e=>e.replace(Rr,"-$1").toLowerCase()),ii=si(e=>e.charAt(0).toUpperCase()+e.slice(1)),Ti=si(e=>e?`on${ii(e)}`:""),ms=(e,t)=>!Object.is(e,t),Fs=(e,t)=>{for(let s=0;s<e.length;s++)e[s](t)},Ds=(e,t,s)=>{Object.defineProperty(e,t,{configurable:!0,enumerable:!1,value:s})},Ei=e=>{const t=parseFloat(e);return isNaN(t)?e:t};let jn;const Ir=()=>jn||(jn=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});let Re;class Or{constructor(t=!1){this.active=!0,this.effects=[],this.cleanups=[],!t&&Re&&(this.parent=Re,this.index=(Re.scopes||(Re.scopes=[])).push(this)-1)}run(t){if(this.active){const s=Re;try{return Re=this,t()}finally{Re=s}}}on(){Re=this}off(){Re=this.parent}stop(t){if(this.active){let s,i;for(s=0,i=this.effects.length;s<i;s++)this.effects[s].stop();for(s=0,i=this.cleanups.length;s<i;s++)this.cleanups[s]();if(this.scopes)for(s=0,i=this.scopes.length;s<i;s++)this.scopes[s].stop(!0);if(this.parent&&!t){const n=this.parent.scopes.pop();n&&n!==this&&(this.parent.scopes[this.index]=n,n.index=this.index)}this.active=!1}}}function Er(e,t=Re){t&&t.active&&t.effects.push(e)}function Mr(){return Re}function Hr(e){Re&&Re.cleanups.push(e)}const pn=e=>{const t=new Set(e);return t.w=0,t.n=0,t},Uo=e=>(e.w&yt)>0,Yo=e=>(e.n&yt)>0,Nr=({deps:e})=>{if(e.length)for(let t=0;t<e.length;t++)e[t].w|=yt},jr=e=>{const{deps:t}=e;if(t.length){let s=0;for(let i=0;i<t.length;i++){const n=t[i];Uo(n)&&!Yo(n)?n.delete(e):t[s++]=n,n.w&=~yt,n.n&=~yt}t.length=s}},Mi=new WeakMap;let rs=0,yt=1;const Hi=30;let Fe;const Ot=Symbol(""),Ni=Symbol("");class hn{constructor(t,s=null,i){this.fn=t,this.scheduler=s,this.active=!0,this.deps=[],this.parent=void 0,Er(this,i)}run(){if(!this.active)return this.fn();let t=Fe,s=gt;for(;t;){if(t===this)return;t=t.parent}try{return this.parent=Fe,Fe=this,gt=!0,yt=1<<++rs,rs<=Hi?Nr(this):Fn(this),this.fn()}finally{rs<=Hi&&jr(this),yt=1<<--rs,Fe=this.parent,gt=s,this.parent=void 0,this.deferStop&&this.stop()}}stop(){Fe===this?this.deferStop=!0:this.active&&(Fn(this),this.onStop&&this.onStop(),this.active=!1)}}function Fn(e){const{deps:t}=e;if(t.length){for(let s=0;s<t.length;s++)t[s].delete(e);t.length=0}}let gt=!0;const Ko=[];function es(){Ko.push(gt),gt=!1}function ts(){const e=Ko.pop();gt=e===void 0?!0:e}function Ee(e,t,s){if(gt&&Fe){let i=Mi.get(e);i||Mi.set(e,i=new Map);let n=i.get(s);n||i.set(s,n=pn()),Vo(n)}}function Vo(e,t){let s=!1;rs<=Hi?Yo(e)||(e.n|=yt,s=!Uo(e)):s=!e.has(Fe),s&&(e.add(Fe),Fe.deps.push(e))}function it(e,t,s,i,n,o){const a=Mi.get(e);if(!a)return;let r=[];if(t==="clear")r=[...a.values()];else if(s==="length"&&B(e))a.forEach((l,d)=>{(d==="length"||d>=i)&&r.push(l)});else switch(s!==void 0&&r.push(a.get(s)),t){case"add":B(e)?dn(s)&&r.push(a.get("length")):(r.push(a.get(Ot)),Wt(e)&&r.push(a.get(Ni)));break;case"delete":B(e)||(r.push(a.get(Ot)),Wt(e)&&r.push(a.get(Ni)));break;case"set":Wt(e)&&r.push(a.get(Ot));break}if(r.length===1)r[0]&&ji(r[0]);else{const l=[];for(const d of r)d&&l.push(...d);ji(pn(l))}}function ji(e,t){const s=B(e)?e:[...e];for(const i of s)i.computed&&zn(i);for(const i of s)i.computed||zn(i)}function zn(e,t){(e!==Fe||e.allowRecurse)&&(e.scheduler?e.scheduler():e.run())}const Fr=an("__proto__,__v_isRef,__isVue"),Go=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(cn)),zr=un(),Br=un(!1,!0),Dr=un(!0),Bn=qr();function qr(){const e={};return["includes","indexOf","lastIndexOf"].forEach(t=>{e[t]=function(...s){const i=G(this);for(let o=0,a=this.length;o<a;o++)Ee(i,"get",o+"");const n=i[t](...s);return n===-1||n===!1?i[t](...s.map(G)):n}}),["push","pop","shift","unshift","splice"].forEach(t=>{e[t]=function(...s){es();const i=G(this)[t].apply(this,s);return ts(),i}}),e}function un(e=!1,t=!1){return function(i,n,o){if(n==="__v_isReactive")return!e;if(n==="__v_isReadonly")return e;if(n==="__v_isShallow")return t;if(n==="__v_raw"&&o===(e?t?ol:ea:t?Zo:Qo).get(i))return i;const a=B(i);if(!e&&a&&Y(Bn,n))return Reflect.get(Bn,n,o);const r=Reflect.get(i,n,o);return(cn(n)?Go.has(n):Fr(n))||(e||Ee(i,"get",n),t)?r:we(r)?a&&dn(n)?r:r.value:ne(r)?e?ta(r):oi(r):r}}const Wr=Xo(),Ur=Xo(!0);function Xo(e=!1){return function(s,i,n,o){let a=s[i];if(Vt(a)&&we(a)&&!we(n))return!1;if(!e&&(!qs(n)&&!Vt(n)&&(a=G(a),n=G(n)),!B(s)&&we(a)&&!we(n)))return a.value=n,!0;const r=B(s)&&dn(i)?Number(i)<s.length:Y(s,i),l=Reflect.set(s,i,n,o);return s===G(o)&&(r?ms(n,a)&&it(s,"set",i,n):it(s,"add",i,n)),l}}function Yr(e,t){const s=Y(e,t);e[t];const i=Reflect.deleteProperty(e,t);return i&&s&&it(e,"delete",t,void 0),i}function Kr(e,t){const s=Reflect.has(e,t);return(!cn(t)||!Go.has(t))&&Ee(e,"has",t),s}function Vr(e){return Ee(e,"iterate",B(e)?"length":Ot),Reflect.ownKeys(e)}const Jo={get:zr,set:Wr,deleteProperty:Yr,has:Kr,ownKeys:Vr},Gr={get:Dr,set(e,t){return!0},deleteProperty(e,t){return!0}},Xr=$e({},Jo,{get:Br,set:Ur}),fn=e=>e,ni=e=>Reflect.getPrototypeOf(e);function Rs(e,t,s=!1,i=!1){e=e.__v_raw;const n=G(e),o=G(t);s||(t!==o&&Ee(n,"get",t),Ee(n,"get",o));const{has:a}=ni(n),r=i?fn:s?bn:bs;if(a.call(n,t))return r(e.get(t));if(a.call(n,o))return r(e.get(o));e!==n&&e.get(t)}function Is(e,t=!1){const s=this.__v_raw,i=G(s),n=G(e);return t||(e!==n&&Ee(i,"has",e),Ee(i,"has",n)),e===n?s.has(e):s.has(e)||s.has(n)}function Os(e,t=!1){return e=e.__v_raw,!t&&Ee(G(e),"iterate",Ot),Reflect.get(e,"size",e)}function Dn(e){e=G(e);const t=G(this);return ni(t).has.call(t,e)||(t.add(e),it(t,"add",e,e)),this}function qn(e,t){t=G(t);const s=G(this),{has:i,get:n}=ni(s);let o=i.call(s,e);o||(e=G(e),o=i.call(s,e));const a=n.call(s,e);return s.set(e,t),o?ms(t,a)&&it(s,"set",e,t):it(s,"add",e,t),this}function Wn(e){const t=G(this),{has:s,get:i}=ni(t);let n=s.call(t,e);n||(e=G(e),n=s.call(t,e)),i&&i.call(t,e);const o=t.delete(e);return n&&it(t,"delete",e,void 0),o}function Un(){const e=G(this),t=e.size!==0,s=e.clear();return t&&it(e,"clear",void 0,void 0),s}function Es(e,t){return function(i,n){const o=this,a=o.__v_raw,r=G(a),l=t?fn:e?bn:bs;return!e&&Ee(r,"iterate",Ot),a.forEach((d,h)=>i.call(n,l(d),l(h),o))}}function Ms(e,t,s){return function(...i){const n=this.__v_raw,o=G(n),a=Wt(o),r=e==="entries"||e===Symbol.iterator&&a,l=e==="keys"&&a,d=n[e](...i),h=s?fn:t?bn:bs;return!t&&Ee(o,"iterate",l?Ni:Ot),{next(){const{value:u,done:f}=d.next();return f?{value:u,done:f}:{value:r?[h(u[0]),h(u[1])]:h(u),done:f}},[Symbol.iterator](){return this}}}}function pt(e){return function(...t){return e==="delete"?!1:this}}function Jr(){const e={get(o){return Rs(this,o)},get size(){return Os(this)},has:Is,add:Dn,set:qn,delete:Wn,clear:Un,forEach:Es(!1,!1)},t={get(o){return Rs(this,o,!1,!0)},get size(){return Os(this)},has:Is,add:Dn,set:qn,delete:Wn,clear:Un,forEach:Es(!1,!0)},s={get(o){return Rs(this,o,!0)},get size(){return Os(this,!0)},has(o){return Is.call(this,o,!0)},add:pt("add"),set:pt("set"),delete:pt("delete"),clear:pt("clear"),forEach:Es(!0,!1)},i={get(o){return Rs(this,o,!0,!0)},get size(){return Os(this,!0)},has(o){return Is.call(this,o,!0)},add:pt("add"),set:pt("set"),delete:pt("delete"),clear:pt("clear"),forEach:Es(!0,!0)};return["keys","values","entries",Symbol.iterator].forEach(o=>{e[o]=Ms(o,!1,!1),s[o]=Ms(o,!0,!1),t[o]=Ms(o,!1,!0),i[o]=Ms(o,!0,!0)}),[e,s,t,i]}const[Qr,Zr,el,tl]=Jr();function gn(e,t){const s=t?e?tl:el:e?Zr:Qr;return(i,n,o)=>n==="__v_isReactive"?!e:n==="__v_isReadonly"?e:n==="__v_raw"?i:Reflect.get(Y(s,n)&&n in i?s:i,n,o)}const sl={get:gn(!1,!1)},il={get:gn(!1,!0)},nl={get:gn(!0,!1)},Qo=new WeakMap,Zo=new WeakMap,ea=new WeakMap,ol=new WeakMap;function al(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function rl(e){return e.__v_skip||!Object.isExtensible(e)?0:al(Lr(e))}function oi(e){return Vt(e)?e:mn(e,!1,Jo,sl,Qo)}function ll(e){return mn(e,!1,Xr,il,Zo)}function ta(e){return mn(e,!0,Gr,nl,ea)}function mn(e,t,s,i,n){if(!ne(e)||e.__v_raw&&!(t&&e.__v_isReactive))return e;const o=n.get(e);if(o)return o;const a=rl(e);if(a===0)return e;const r=new Proxy(e,a===2?i:s);return n.set(e,r),r}function Ut(e){return Vt(e)?Ut(e.__v_raw):!!(e&&e.__v_isReactive)}function Vt(e){return!!(e&&e.__v_isReadonly)}function qs(e){return!!(e&&e.__v_isShallow)}function sa(e){return Ut(e)||Vt(e)}function G(e){const t=e&&e.__v_raw;return t?G(t):e}function ia(e){return Ds(e,"__v_skip",!0),e}const bs=e=>ne(e)?oi(e):e,bn=e=>ne(e)?ta(e):e;function na(e){gt&&Fe&&(e=G(e),Vo(e.dep||(e.dep=pn())))}function oa(e,t){e=G(e),e.dep&&ji(e.dep)}function we(e){return!!(e&&e.__v_isRef===!0)}function Oe(e){return cl(e,!1)}function cl(e,t){return we(e)?e:new dl(e,t)}class dl{constructor(t,s){this.__v_isShallow=s,this.dep=void 0,this.__v_isRef=!0,this._rawValue=s?t:G(t),this._value=s?t:bs(t)}get value(){return na(this),this._value}set value(t){const s=this.__v_isShallow||qs(t)||Vt(t);t=s?t:G(t),ms(t,this._rawValue)&&(this._rawValue=t,this._value=s?t:bs(t),oa(this))}}function _(e){return we(e)?e.value:e}const pl={get:(e,t,s)=>_(Reflect.get(e,t,s)),set:(e,t,s,i)=>{const n=e[t];return we(n)&&!we(s)?(n.value=s,!0):Reflect.set(e,t,s,i)}};function aa(e){return Ut(e)?e:new Proxy(e,pl)}var ra;class hl{constructor(t,s,i,n){this._setter=s,this.dep=void 0,this.__v_isRef=!0,this[ra]=!1,this._dirty=!0,this.effect=new hn(t,()=>{this._dirty||(this._dirty=!0,oa(this))}),this.effect.computed=this,this.effect.active=this._cacheable=!n,this.__v_isReadonly=i}get value(){const t=G(this);return na(t),(t._dirty||!t._cacheable)&&(t._dirty=!1,t._value=t.effect.run()),t._value}set value(t){this._setter(t)}}ra="__v_isReadonly";function ul(e,t,s=!1){let i,n;const o=q(e);return o?(i=e,n=Be):(i=e.get,n=e.set),new hl(i,n,o||!n,s)}function mt(e,t,s,i){let n;try{n=i?e(...i):e()}catch(o){ai(o,t,s)}return n}function De(e,t,s,i){if(q(e)){const o=mt(e,t,s,i);return o&&Do(o)&&o.catch(a=>{ai(a,t,s)}),o}const n=[];for(let o=0;o<e.length;o++)n.push(De(e[o],t,s,i));return n}function ai(e,t,s,i=!0){const n=t?t.vnode:null;if(t){let o=t.parent;const a=t.proxy,r=s;for(;o;){const d=o.ec;if(d){for(let h=0;h<d.length;h++)if(d[h](e,a,r)===!1)return}o=o.parent}const l=t.appContext.config.errorHandler;if(l){mt(l,null,10,[e,a,r]);return}}fl(e,s,n,i)}function fl(e,t,s,i=!0){console.error(e)}let ys=!1,Fi=!1;const ve=[];let Ke=0;const Yt=[];let Qe=null,At=0;const la=Promise.resolve();let yn=null;function at(e){const t=yn||la;return e?t.then(this?e.bind(this):e):t}function gl(e){let t=Ke+1,s=ve.length;for(;t<s;){const i=t+s>>>1;vs(ve[i])<e?t=i+1:s=i}return t}function vn(e){(!ve.length||!ve.includes(e,ys&&e.allowRecurse?Ke+1:Ke))&&(e.id==null?ve.push(e):ve.splice(gl(e.id),0,e),ca())}function ca(){!ys&&!Fi&&(Fi=!0,yn=la.then(pa))}function ml(e){const t=ve.indexOf(e);t>Ke&&ve.splice(t,1)}function bl(e){B(e)?Yt.push(...e):(!Qe||!Qe.includes(e,e.allowRecurse?At+1:At))&&Yt.push(e),ca()}function Yn(e,t=ys?Ke+1:0){for(;t<ve.length;t++){const s=ve[t];s&&s.pre&&(ve.splice(t,1),t--,s())}}function da(e){if(Yt.length){const t=[...new Set(Yt)];if(Yt.length=0,Qe){Qe.push(...t);return}for(Qe=t,Qe.sort((s,i)=>vs(s)-vs(i)),At=0;At<Qe.length;At++)Qe[At]();Qe=null,At=0}}const vs=e=>e.id==null?1/0:e.id,yl=(e,t)=>{const s=vs(e)-vs(t);if(s===0){if(e.pre&&!t.pre)return-1;if(t.pre&&!e.pre)return 1}return s};function pa(e){Fi=!1,ys=!0,ve.sort(yl);const t=Be;try{for(Ke=0;Ke<ve.length;Ke++){const s=ve[Ke];s&&s.active!==!1&&mt(s,null,14)}}finally{Ke=0,ve.length=0,da(),ys=!1,yn=null,(ve.length||Yt.length)&&pa()}}function vl(e,t,...s){if(e.isUnmounted)return;const i=e.vnode.props||Q;let n=s;const o=t.startsWith("update:"),a=o&&t.slice(7);if(a&&a in i){const h=`${a==="modelValue"?"model":a}Modifiers`,{number:u,trim:f}=i[h]||Q;f&&(n=s.map(k=>k.trim())),u&&(n=s.map(Ei))}let r,l=i[r=Ti(t)]||i[r=Ti(Ve(t))];!l&&o&&(l=i[r=Ti(Nt(t))]),l&&De(l,e,6,n);const d=i[r+"Once"];if(d){if(!e.emitted)e.emitted={};else if(e.emitted[r])return;e.emitted[r]=!0,De(d,e,6,n)}}function ha(e,t,s=!1){const i=t.emitsCache,n=i.get(e);if(n!==void 0)return n;const o=e.emits;let a={},r=!1;if(!q(e)){const l=d=>{const h=ha(d,t,!0);h&&(r=!0,$e(a,h))};!s&&t.mixins.length&&t.mixins.forEach(l),e.extends&&l(e.extends),e.mixins&&e.mixins.forEach(l)}return!o&&!r?(ne(e)&&i.set(e,null),null):(B(o)?o.forEach(l=>a[l]=null):$e(a,o),ne(e)&&i.set(e,a),a)}function ri(e,t){return!e||!ei(t)?!1:(t=t.slice(2).replace(/Once$/,""),Y(e,t[0].toLowerCase()+t.slice(1))||Y(e,Nt(t))||Y(e,t))}let ke=null,li=null;function Ws(e){const t=ke;return ke=e,li=e&&e.type.__scopeId||null,t}function He(e){li=e}function Ne(){li=null}const wl=e=>Le;function Le(e,t=ke,s){if(!t||e._n)return e;const i=(...n)=>{i._d&&so(-1);const o=Ws(t),a=e(...n);return Ws(o),i._d&&so(1),a};return i._n=!0,i._c=!0,i._d=!0,i}function $i(e){const{type:t,vnode:s,proxy:i,withProxy:n,props:o,propsOptions:[a],slots:r,attrs:l,emit:d,render:h,renderCache:u,data:f,setupState:k,ctx:P,inheritAttrs:A}=e;let R,I;const E=Ws(e);try{if(s.shapeFlag&4){const z=n||i;R=Ye(h.call(z,z,u,o,k,f,P)),I=l}else{const z=t;R=Ye(z.length>1?z(o,{attrs:l,slots:r,emit:d}):z(o,null)),I=t.props?l:xl(l)}}catch(z){ds.length=0,ai(z,e,1),R=W(wt)}let M=R;if(I&&A!==!1){const z=Object.keys(I),{shapeFlag:oe}=M;z.length&&oe&7&&(a&&z.some(rn)&&(I=_l(I,a)),M=Gt(M,I))}return s.dirs&&(M=Gt(M),M.dirs=M.dirs?M.dirs.concat(s.dirs):s.dirs),s.transition&&(M.transition=s.transition),R=M,Ws(E),R}const xl=e=>{let t;for(const s in e)(s==="class"||s==="style"||ei(s))&&((t||(t={}))[s]=e[s]);return t},_l=(e,t)=>{const s={};for(const i in e)(!rn(i)||!(i.slice(9)in t))&&(s[i]=e[i]);return s};function kl(e,t,s){const{props:i,children:n,component:o}=e,{props:a,children:r,patchFlag:l}=t,d=o.emitsOptions;if(t.dirs||t.transition)return!0;if(s&&l>=0){if(l&1024)return!0;if(l&16)return i?Kn(i,a,d):!!a;if(l&8){const h=t.dynamicProps;for(let u=0;u<h.length;u++){const f=h[u];if(a[f]!==i[f]&&!ri(d,f))return!0}}}else return(n||r)&&(!r||!r.$stable)?!0:i===a?!1:i?a?Kn(i,a,d):!0:!!a;return!1}function Kn(e,t,s){const i=Object.keys(t);if(i.length!==Object.keys(e).length)return!0;for(let n=0;n<i.length;n++){const o=i[n];if(t[o]!==e[o]&&!ri(s,o))return!0}return!1}function Tl({vnode:e,parent:t},s){for(;t&&t.subTree===e;)(e=t.vnode).el=s,t=t.parent}const $l=e=>e.__isSuspense;function Cl(e,t){t&&t.pendingBranch?B(e)?t.effects.push(...e):t.effects.push(e):bl(e)}function Sl(e,t){if(be){let s=be.provides;const i=be.parent&&be.parent.provides;i===s&&(s=be.provides=Object.create(i)),s[e]=t}}function Ci(e,t,s=!1){const i=be||ke;if(i){const n=i.parent==null?i.vnode.appContext&&i.vnode.appContext.provides:i.parent.provides;if(n&&e in n)return n[e];if(arguments.length>1)return s&&q(t)?t.call(i.proxy):t}}const Vn={};function bt(e,t,s){return ua(e,t,s)}function ua(e,t,{immediate:s,deep:i,flush:n,onTrack:o,onTrigger:a}=Q){const r=be;let l,d=!1,h=!1;if(we(e)?(l=()=>e.value,d=qs(e)):Ut(e)?(l=()=>e,i=!0):B(e)?(h=!0,d=e.some(I=>Ut(I)||qs(I)),l=()=>e.map(I=>{if(we(I))return I.value;if(Ut(I))return It(I);if(q(I))return mt(I,r,2)})):q(e)?t?l=()=>mt(e,r,2):l=()=>{if(!(r&&r.isUnmounted))return u&&u(),De(e,r,3,[f])}:l=Be,t&&i){const I=l;l=()=>It(I())}let u,f=I=>{u=R.onStop=()=>{mt(I,r,4)}};if(_s)return f=Be,t?s&&De(t,r,3,[l(),h?[]:void 0,f]):l(),Be;let k=h?[]:Vn;const P=()=>{if(!!R.active)if(t){const I=R.run();(i||d||(h?I.some((E,M)=>ms(E,k[M])):ms(I,k)))&&(u&&u(),De(t,r,3,[I,k===Vn?void 0:k,f]),k=I)}else R.run()};P.allowRecurse=!!t;let A;n==="sync"?A=P:n==="post"?A=()=>Se(P,r&&r.suspense):(P.pre=!0,r&&(P.id=r.uid),A=()=>vn(P));const R=new hn(l,A);return t?s?P():k=R.run():n==="post"?Se(R.run.bind(R),r&&r.suspense):R.run(),()=>{R.stop(),r&&r.scope&&ln(r.scope.effects,R)}}function Pl(e,t,s){const i=this.proxy,n=pe(e)?e.includes(".")?fa(i,e):()=>i[e]:e.bind(i,i);let o;q(t)?o=t:(o=t.handler,s=t);const a=be;Xt(this);const r=ua(n,o.bind(i),s);return a?Xt(a):Et(),r}function fa(e,t){const s=t.split(".");return()=>{let i=e;for(let n=0;n<s.length&&i;n++)i=i[s[n]];return i}}function It(e,t){if(!ne(e)||e.__v_skip||(t=t||new Set,t.has(e)))return e;if(t.add(e),we(e))It(e.value,t);else if(B(e))for(let s=0;s<e.length;s++)It(e[s],t);else if(Bo(e)||Wt(e))e.forEach(s=>{It(s,t)});else if(Wo(e))for(const s in e)It(e[s],t);return e}function ee(e){return q(e)?{setup:e,name:e.name}:e}const cs=e=>!!e.type.__asyncLoader,ga=e=>e.type.__isKeepAlive;function Ll(e,t){ma(e,"a",t)}function Al(e,t){ma(e,"da",t)}function ma(e,t,s=be){const i=e.__wdc||(e.__wdc=()=>{let n=s;for(;n;){if(n.isDeactivated)return;n=n.parent}return e()});if(ci(t,i,s),s){let n=s.parent;for(;n&&n.parent;)ga(n.parent.vnode)&&Rl(i,t,s,n),n=n.parent}}function Rl(e,t,s,i){const n=ci(t,e,i,!0);ya(()=>{ln(i[t],n)},s)}function ci(e,t,s=be,i=!1){if(s){const n=s[e]||(s[e]=[]),o=t.__weh||(t.__weh=(...a)=>{if(s.isUnmounted)return;es(),Xt(s);const r=De(t,s,e,a);return Et(),ts(),r});return i?n.unshift(o):n.push(o),o}}const rt=e=>(t,s=be)=>(!_s||e==="sp")&&ci(e,t,s),Il=rt("bm"),ba=rt("m"),Ol=rt("bu"),El=rt("u"),Ml=rt("bum"),ya=rt("um"),Hl=rt("sp"),Nl=rt("rtg"),jl=rt("rtc");function Fl(e,t=be){ci("ec",e,t)}function zl(e,t){const s=ke;if(s===null)return e;const i=pi(s)||s.proxy,n=e.dirs||(e.dirs=[]);for(let o=0;o<t.length;o++){let[a,r,l,d=Q]=t[o];q(a)&&(a={mounted:a,updated:a}),a.deep&&It(r),n.push({dir:a,instance:i,value:r,oldValue:void 0,arg:l,modifiers:d})}return e}function Tt(e,t,s,i){const n=e.dirs,o=t&&t.dirs;for(let a=0;a<n.length;a++){const r=n[a];o&&(r.oldValue=o[a].value);let l=r.dir[i];l&&(es(),De(l,s,8,[e.el,r,e,t]),ts())}}const wn="components";function ws(e,t){return xa(wn,e,!0,t)||e}const va=Symbol();function wa(e){return pe(e)?xa(wn,e,!1)||e:e||va}function xa(e,t,s=!0,i=!1){const n=ke||be;if(n){const o=n.type;if(e===wn){const r=uc(o,!1);if(r&&(r===t||r===Ve(t)||r===ii(Ve(t))))return o}const a=Gn(n[e]||o[e],t)||Gn(n.appContext[e],t);return!a&&i?o:a}}function Gn(e,t){return e&&(e[t]||e[Ve(t)]||e[ii(Ve(t))])}function Pe(e,t,s,i){let n;const o=s&&s[i];if(B(e)||pe(e)){n=new Array(e.length);for(let a=0,r=e.length;a<r;a++)n[a]=t(e[a],a,void 0,o&&o[a])}else if(typeof e=="number"){n=new Array(e);for(let a=0;a<e;a++)n[a]=t(a+1,a,void 0,o&&o[a])}else if(ne(e))if(e[Symbol.iterator])n=Array.from(e,(a,r)=>t(a,r,void 0,o&&o[r]));else{const a=Object.keys(e);n=new Array(a.length);for(let r=0,l=a.length;r<l;r++){const d=a[r];n[r]=t(e[d],d,r,o&&o[r])}}else n=[];return s&&(s[i]=n),n}function vt(e,t,s={},i,n){if(ke.isCE||ke.parent&&cs(ke.parent)&&ke.parent.isCE)return W("slot",t==="default"?null:{name:t},i&&i());let o=e[t];o&&o._c&&(o._d=!1),T();const a=o&&_a(o(s)),r=Ge(F,{key:s.key||a&&a.key||`_${t}`},a||(i?i():[]),a&&e._===1?64:-2);return!n&&r.scopeId&&(r.slotScopeIds=[r.scopeId+"-s"]),o&&o._c&&(o._d=!0),r}function _a(e){return e.some(t=>Ks(t)?!(t.type===wt||t.type===F&&!_a(t.children)):!0)?e:null}const zi=e=>e?Ea(e)?pi(e)||e.proxy:zi(e.parent):null,Us=$e(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>zi(e.parent),$root:e=>zi(e.root),$emit:e=>e.emit,$options:e=>xn(e),$forceUpdate:e=>e.f||(e.f=()=>vn(e.update)),$nextTick:e=>e.n||(e.n=at.bind(e.proxy)),$watch:e=>Pl.bind(e)}),Bl={get({_:e},t){const{ctx:s,setupState:i,data:n,props:o,accessCache:a,type:r,appContext:l}=e;let d;if(t[0]!=="$"){const k=a[t];if(k!==void 0)switch(k){case 1:return i[t];case 2:return n[t];case 4:return s[t];case 3:return o[t]}else{if(i!==Q&&Y(i,t))return a[t]=1,i[t];if(n!==Q&&Y(n,t))return a[t]=2,n[t];if((d=e.propsOptions[0])&&Y(d,t))return a[t]=3,o[t];if(s!==Q&&Y(s,t))return a[t]=4,s[t];Bi&&(a[t]=0)}}const h=Us[t];let u,f;if(h)return t==="$attrs"&&Ee(e,"get",t),h(e);if((u=r.__cssModules)&&(u=u[t]))return u;if(s!==Q&&Y(s,t))return a[t]=4,s[t];if(f=l.config.globalProperties,Y(f,t))return f[t]},set({_:e},t,s){const{data:i,setupState:n,ctx:o}=e;return n!==Q&&Y(n,t)?(n[t]=s,!0):i!==Q&&Y(i,t)?(i[t]=s,!0):Y(e.props,t)||t[0]==="$"&&t.slice(1)in e?!1:(o[t]=s,!0)},has({_:{data:e,setupState:t,accessCache:s,ctx:i,appContext:n,propsOptions:o}},a){let r;return!!s[a]||e!==Q&&Y(e,a)||t!==Q&&Y(t,a)||(r=o[0])&&Y(r,a)||Y(i,a)||Y(Us,a)||Y(n.config.globalProperties,a)},defineProperty(e,t,s){return s.get!=null?e._.accessCache[t]=0:Y(s,"value")&&this.set(e,t,s.value,null),Reflect.defineProperty(e,t,s)}};let Bi=!0;function Dl(e){const t=xn(e),s=e.proxy,i=e.ctx;Bi=!1,t.beforeCreate&&Xn(t.beforeCreate,e,"bc");const{data:n,computed:o,methods:a,watch:r,provide:l,inject:d,created:h,beforeMount:u,mounted:f,beforeUpdate:k,updated:P,activated:A,deactivated:R,beforeDestroy:I,beforeUnmount:E,destroyed:M,unmounted:z,render:oe,renderTracked:ue,renderTriggered:fe,errorCaptured:ie,serverPrefetch:D,expose:re,inheritAttrs:ae,components:de,directives:xe,filters:ge}=t;if(d&&ql(d,i,null,e.appContext.config.unwrapInjectedRef),a)for(const le in a){const te=a[le];q(te)&&(i[le]=te.bind(s))}if(n){const le=n.call(s,s);ne(le)&&(e.data=oi(le))}if(Bi=!0,o)for(const le in o){const te=o[le],Xe=q(te)?te.bind(s,s):q(te.get)?te.get.bind(s,s):Be,xi=!q(te)&&q(te.set)?te.set.bind(s):Be,ss=ce({get:Xe,set:xi});Object.defineProperty(i,le,{enumerable:!0,configurable:!0,get:()=>ss.value,set:Ft=>ss.value=Ft})}if(r)for(const le in r)ka(r[le],i,s,le);if(l){const le=q(l)?l.call(s):l;Reflect.ownKeys(le).forEach(te=>{Sl(te,le[te])})}h&&Xn(h,e,"c");function Ce(le,te){B(te)?te.forEach(Xe=>le(Xe.bind(s))):te&&le(te.bind(s))}if(Ce(Il,u),Ce(ba,f),Ce(Ol,k),Ce(El,P),Ce(Ll,A),Ce(Al,R),Ce(Fl,ie),Ce(jl,ue),Ce(Nl,fe),Ce(Ml,E),Ce(ya,z),Ce(Hl,D),B(re))if(re.length){const le=e.exposed||(e.exposed={});re.forEach(te=>{Object.defineProperty(le,te,{get:()=>s[te],set:Xe=>s[te]=Xe})})}else e.exposed||(e.exposed={});oe&&e.render===Be&&(e.render=oe),ae!=null&&(e.inheritAttrs=ae),de&&(e.components=de),xe&&(e.directives=xe)}function ql(e,t,s=Be,i=!1){B(e)&&(e=Di(e));for(const n in e){const o=e[n];let a;ne(o)?"default"in o?a=Ci(o.from||n,o.default,!0):a=Ci(o.from||n):a=Ci(o),we(a)&&i?Object.defineProperty(t,n,{enumerable:!0,configurable:!0,get:()=>a.value,set:r=>a.value=r}):t[n]=a}}function Xn(e,t,s){De(B(e)?e.map(i=>i.bind(t.proxy)):e.bind(t.proxy),t,s)}function ka(e,t,s,i){const n=i.includes(".")?fa(s,i):()=>s[i];if(pe(e)){const o=t[e];q(o)&&bt(n,o)}else if(q(e))bt(n,e.bind(s));else if(ne(e))if(B(e))e.forEach(o=>ka(o,t,s,i));else{const o=q(e.handler)?e.handler.bind(s):t[e.handler];q(o)&&bt(n,o,e)}}function xn(e){const t=e.type,{mixins:s,extends:i}=t,{mixins:n,optionsCache:o,config:{optionMergeStrategies:a}}=e.appContext,r=o.get(t);let l;return r?l=r:!n.length&&!s&&!i?l=t:(l={},n.length&&n.forEach(d=>Ys(l,d,a,!0)),Ys(l,t,a)),ne(t)&&o.set(t,l),l}function Ys(e,t,s,i=!1){const{mixins:n,extends:o}=t;o&&Ys(e,o,s,!0),n&&n.forEach(a=>Ys(e,a,s,!0));for(const a in t)if(!(i&&a==="expose")){const r=Wl[a]||s&&s[a];e[a]=r?r(e[a],t[a]):t[a]}return e}const Wl={data:Jn,props:Pt,emits:Pt,methods:Pt,computed:Pt,beforeCreate:_e,created:_e,beforeMount:_e,mounted:_e,beforeUpdate:_e,updated:_e,beforeDestroy:_e,beforeUnmount:_e,destroyed:_e,unmounted:_e,activated:_e,deactivated:_e,errorCaptured:_e,serverPrefetch:_e,components:Pt,directives:Pt,watch:Yl,provide:Jn,inject:Ul};function Jn(e,t){return t?e?function(){return $e(q(e)?e.call(this,this):e,q(t)?t.call(this,this):t)}:t:e}function Ul(e,t){return Pt(Di(e),Di(t))}function Di(e){if(B(e)){const t={};for(let s=0;s<e.length;s++)t[e[s]]=e[s];return t}return e}function _e(e,t){return e?[...new Set([].concat(e,t))]:t}function Pt(e,t){return e?$e($e(Object.create(null),e),t):t}function Yl(e,t){if(!e)return t;if(!t)return e;const s=$e(Object.create(null),e);for(const i in t)s[i]=_e(e[i],t[i]);return s}function Kl(e,t,s,i=!1){const n={},o={};Ds(o,di,1),e.propsDefaults=Object.create(null),Ta(e,t,n,o);for(const a in e.propsOptions[0])a in n||(n[a]=void 0);s?e.props=i?n:ll(n):e.type.props?e.props=n:e.props=o,e.attrs=o}function Vl(e,t,s,i){const{props:n,attrs:o,vnode:{patchFlag:a}}=e,r=G(n),[l]=e.propsOptions;let d=!1;if((i||a>0)&&!(a&16)){if(a&8){const h=e.vnode.dynamicProps;for(let u=0;u<h.length;u++){let f=h[u];if(ri(e.emitsOptions,f))continue;const k=t[f];if(l)if(Y(o,f))k!==o[f]&&(o[f]=k,d=!0);else{const P=Ve(f);n[P]=qi(l,r,P,k,e,!1)}else k!==o[f]&&(o[f]=k,d=!0)}}}else{Ta(e,t,n,o)&&(d=!0);let h;for(const u in r)(!t||!Y(t,u)&&((h=Nt(u))===u||!Y(t,h)))&&(l?s&&(s[u]!==void 0||s[h]!==void 0)&&(n[u]=qi(l,r,u,void 0,e,!0)):delete n[u]);if(o!==r)for(const u in o)(!t||!Y(t,u)&&!0)&&(delete o[u],d=!0)}d&&it(e,"set","$attrs")}function Ta(e,t,s,i){const[n,o]=e.propsOptions;let a=!1,r;if(t)for(let l in t){if(js(l))continue;const d=t[l];let h;n&&Y(n,h=Ve(l))?!o||!o.includes(h)?s[h]=d:(r||(r={}))[h]=d:ri(e.emitsOptions,l)||(!(l in i)||d!==i[l])&&(i[l]=d,a=!0)}if(o){const l=G(s),d=r||Q;for(let h=0;h<o.length;h++){const u=o[h];s[u]=qi(n,l,u,d[u],e,!Y(d,u))}}return a}function qi(e,t,s,i,n,o){const a=e[s];if(a!=null){const r=Y(a,"default");if(r&&i===void 0){const l=a.default;if(a.type!==Function&&q(l)){const{propsDefaults:d}=n;s in d?i=d[s]:(Xt(n),i=d[s]=l.call(null,t),Et())}else i=l}a[0]&&(o&&!r?i=!1:a[1]&&(i===""||i===Nt(s))&&(i=!0))}return i}function $a(e,t,s=!1){const i=t.propsCache,n=i.get(e);if(n)return n;const o=e.props,a={},r=[];let l=!1;if(!q(e)){const h=u=>{l=!0;const[f,k]=$a(u,t,!0);$e(a,f),k&&r.push(...k)};!s&&t.mixins.length&&t.mixins.forEach(h),e.extends&&h(e.extends),e.mixins&&e.mixins.forEach(h)}if(!o&&!l)return ne(e)&&i.set(e,qt),qt;if(B(o))for(let h=0;h<o.length;h++){const u=Ve(o[h]);Qn(u)&&(a[u]=Q)}else if(o)for(const h in o){const u=Ve(h);if(Qn(u)){const f=o[h],k=a[u]=B(f)||q(f)?{type:f}:f;if(k){const P=to(Boolean,k.type),A=to(String,k.type);k[0]=P>-1,k[1]=A<0||P<A,(P>-1||Y(k,"default"))&&r.push(u)}}}const d=[a,r];return ne(e)&&i.set(e,d),d}function Qn(e){return e[0]!=="$"}function Zn(e){const t=e&&e.toString().match(/^\s*function (\w+)/);return t?t[1]:e===null?"null":""}function eo(e,t){return Zn(e)===Zn(t)}function to(e,t){return B(t)?t.findIndex(s=>eo(s,e)):q(t)&&eo(t,e)?0:-1}const Ca=e=>e[0]==="_"||e==="$stable",_n=e=>B(e)?e.map(Ye):[Ye(e)],Gl=(e,t,s)=>{if(t._n)return t;const i=Le((...n)=>_n(t(...n)),s);return i._c=!1,i},Sa=(e,t,s)=>{const i=e._ctx;for(const n in e){if(Ca(n))continue;const o=e[n];if(q(o))t[n]=Gl(n,o,i);else if(o!=null){const a=_n(o);t[n]=()=>a}}},Pa=(e,t)=>{const s=_n(t);e.slots.default=()=>s},Xl=(e,t)=>{if(e.vnode.shapeFlag&32){const s=t._;s?(e.slots=G(t),Ds(t,"_",s)):Sa(t,e.slots={})}else e.slots={},t&&Pa(e,t);Ds(e.slots,di,1)},Jl=(e,t,s)=>{const{vnode:i,slots:n}=e;let o=!0,a=Q;if(i.shapeFlag&32){const r=t._;r?s&&r===1?o=!1:($e(n,t),!s&&r===1&&delete n._):(o=!t.$stable,Sa(t,n)),a=t}else t&&(Pa(e,t),a={default:1});if(o)for(const r in n)!Ca(r)&&!(r in a)&&delete n[r]};function La(){return{app:null,config:{isNativeTag:Cr,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let Ql=0;function Zl(e,t){return function(i,n=null){q(i)||(i=Object.assign({},i)),n!=null&&!ne(n)&&(n=null);const o=La(),a=new Set;let r=!1;const l=o.app={_uid:Ql++,_component:i,_props:n,_container:null,_context:o,_instance:null,version:mc,get config(){return o.config},set config(d){},use(d,...h){return a.has(d)||(d&&q(d.install)?(a.add(d),d.install(l,...h)):q(d)&&(a.add(d),d(l,...h))),l},mixin(d){return o.mixins.includes(d)||o.mixins.push(d),l},component(d,h){return h?(o.components[d]=h,l):o.components[d]},directive(d,h){return h?(o.directives[d]=h,l):o.directives[d]},mount(d,h,u){if(!r){const f=W(i,n);return f.appContext=o,h&&t?t(f,d):e(f,d,u),r=!0,l._container=d,d.__vue_app__=l,pi(f.component)||f.component.proxy}},unmount(){r&&(e(null,l._container),delete l._container.__vue_app__)},provide(d,h){return o.provides[d]=h,l}};return l}}function Wi(e,t,s,i,n=!1){if(B(e)){e.forEach((f,k)=>Wi(f,t&&(B(t)?t[k]:t),s,i,n));return}if(cs(i)&&!n)return;const o=i.shapeFlag&4?pi(i.component)||i.component.proxy:i.el,a=n?null:o,{i:r,r:l}=e,d=t&&t.r,h=r.refs===Q?r.refs={}:r.refs,u=r.setupState;if(d!=null&&d!==l&&(pe(d)?(h[d]=null,Y(u,d)&&(u[d]=null)):we(d)&&(d.value=null)),q(l))mt(l,r,12,[a,h]);else{const f=pe(l),k=we(l);if(f||k){const P=()=>{if(e.f){const A=f?h[l]:l.value;n?B(A)&&ln(A,o):B(A)?A.includes(o)||A.push(o):f?(h[l]=[o],Y(u,l)&&(u[l]=h[l])):(l.value=[o],e.k&&(h[e.k]=l.value))}else f?(h[l]=a,Y(u,l)&&(u[l]=a)):k&&(l.value=a,e.k&&(h[e.k]=a))};a?(P.id=-1,Se(P,s)):P()}}}const Se=Cl;function ec(e){return tc(e)}function tc(e,t){const s=Ir();s.__VUE__=!0;const{insert:i,remove:n,patchProp:o,createElement:a,createText:r,createComment:l,setText:d,setElementText:h,parentNode:u,nextSibling:f,setScopeId:k=Be,cloneNode:P,insertStaticContent:A}=e,R=(c,p,g,y=null,b=null,x=null,S=!1,w=null,$=!!p.dynamicChildren)=>{if(c===p)return;c&&!ns(c,p)&&(y=As(c),dt(c,b,x,!0),c=null),p.patchFlag===-2&&($=!1,p.dynamicChildren=null);const{type:v,ref:H,shapeFlag:O}=p;switch(v){case kn:I(c,p,g,y);break;case wt:E(c,p,g,y);break;case Si:c==null&&M(p,g,y,S);break;case F:xe(c,p,g,y,b,x,S,w,$);break;default:O&1?ue(c,p,g,y,b,x,S,w,$):O&6?ge(c,p,g,y,b,x,S,w,$):(O&64||O&128)&&v.process(c,p,g,y,b,x,S,w,$,zt)}H!=null&&b&&Wi(H,c&&c.ref,x,p||c,!p)},I=(c,p,g,y)=>{if(c==null)i(p.el=r(p.children),g,y);else{const b=p.el=c.el;p.children!==c.children&&d(b,p.children)}},E=(c,p,g,y)=>{c==null?i(p.el=l(p.children||""),g,y):p.el=c.el},M=(c,p,g,y)=>{[c.el,c.anchor]=A(c.children,p,g,y,c.el,c.anchor)},z=({el:c,anchor:p},g,y)=>{let b;for(;c&&c!==p;)b=f(c),i(c,g,y),c=b;i(p,g,y)},oe=({el:c,anchor:p})=>{let g;for(;c&&c!==p;)g=f(c),n(c),c=g;n(p)},ue=(c,p,g,y,b,x,S,w,$)=>{S=S||p.type==="svg",c==null?fe(p,g,y,b,x,S,w,$):re(c,p,b,x,S,w,$)},fe=(c,p,g,y,b,x,S,w)=>{let $,v;const{type:H,props:O,shapeFlag:N,transition:j,patchFlag:K,dirs:X}=c;if(c.el&&P!==void 0&&K===-1)$=c.el=P(c.el);else{if($=c.el=a(c.type,x,O&&O.is,O),N&8?h($,c.children):N&16&&D(c.children,$,null,y,b,x&&H!=="foreignObject",S,w),X&&Tt(c,null,y,"created"),O){for(const se in O)se!=="value"&&!js(se)&&o($,se,null,O[se],x,c.children,y,b,Je);"value"in O&&o($,"value",null,O.value),(v=O.onVnodeBeforeMount)&&We(v,y,c)}ie($,c,c.scopeId,S,y)}X&&Tt(c,null,y,"beforeMount");const J=(!b||b&&!b.pendingBranch)&&j&&!j.persisted;J&&j.beforeEnter($),i($,p,g),((v=O&&O.onVnodeMounted)||J||X)&&Se(()=>{v&&We(v,y,c),J&&j.enter($),X&&Tt(c,null,y,"mounted")},b)},ie=(c,p,g,y,b)=>{if(g&&k(c,g),y)for(let x=0;x<y.length;x++)k(c,y[x]);if(b){let x=b.subTree;if(p===x){const S=b.vnode;ie(c,S,S.scopeId,S.slotScopeIds,b.parent)}}},D=(c,p,g,y,b,x,S,w,$=0)=>{for(let v=$;v<c.length;v++){const H=c[v]=w?ft(c[v]):Ye(c[v]);R(null,H,p,g,y,b,x,S,w)}},re=(c,p,g,y,b,x,S)=>{const w=p.el=c.el;let{patchFlag:$,dynamicChildren:v,dirs:H}=p;$|=c.patchFlag&16;const O=c.props||Q,N=p.props||Q;let j;g&&$t(g,!1),(j=N.onVnodeBeforeUpdate)&&We(j,g,p,c),H&&Tt(p,c,g,"beforeUpdate"),g&&$t(g,!0);const K=b&&p.type!=="foreignObject";if(v?ae(c.dynamicChildren,v,w,g,y,K,x):S||Xe(c,p,w,null,g,y,K,x,!1),$>0){if($&16)de(w,p,O,N,g,y,b);else if($&2&&O.class!==N.class&&o(w,"class",null,N.class,b),$&4&&o(w,"style",O.style,N.style,b),$&8){const X=p.dynamicProps;for(let J=0;J<X.length;J++){const se=X[J],je=O[se],Bt=N[se];(Bt!==je||se==="value")&&o(w,se,je,Bt,b,c.children,g,y,Je)}}$&1&&c.children!==p.children&&h(w,p.children)}else!S&&v==null&&de(w,p,O,N,g,y,b);((j=N.onVnodeUpdated)||H)&&Se(()=>{j&&We(j,g,p,c),H&&Tt(p,c,g,"updated")},y)},ae=(c,p,g,y,b,x,S)=>{for(let w=0;w<p.length;w++){const $=c[w],v=p[w],H=$.el&&($.type===F||!ns($,v)||$.shapeFlag&70)?u($.el):g;R($,v,H,null,y,b,x,S,!0)}},de=(c,p,g,y,b,x,S)=>{if(g!==y){for(const w in y){if(js(w))continue;const $=y[w],v=g[w];$!==v&&w!=="value"&&o(c,w,v,$,S,p.children,b,x,Je)}if(g!==Q)for(const w in g)!js(w)&&!(w in y)&&o(c,w,g[w],null,S,p.children,b,x,Je);"value"in y&&o(c,"value",g.value,y.value)}},xe=(c,p,g,y,b,x,S,w,$)=>{const v=p.el=c?c.el:r(""),H=p.anchor=c?c.anchor:r("");let{patchFlag:O,dynamicChildren:N,slotScopeIds:j}=p;j&&(w=w?w.concat(j):j),c==null?(i(v,g,y),i(H,g,y),D(p.children,g,H,b,x,S,w,$)):O>0&&O&64&&N&&c.dynamicChildren?(ae(c.dynamicChildren,N,g,b,x,S,w),(p.key!=null||b&&p===b.subTree)&&Aa(c,p,!0)):Xe(c,p,g,H,b,x,S,w,$)},ge=(c,p,g,y,b,x,S,w,$)=>{p.slotScopeIds=w,c==null?p.shapeFlag&512?b.ctx.activate(p,g,y,S,$):kt(p,g,y,b,x,S,$):Ce(c,p,$)},kt=(c,p,g,y,b,x,S)=>{const w=c.component=lc(c,y,b);if(ga(c)&&(w.ctx.renderer=zt),cc(w),w.asyncDep){if(b&&b.registerDep(w,le),!c.el){const $=w.subTree=W(wt);E(null,$,p,g)}return}le(w,c,p,g,b,x,S)},Ce=(c,p,g)=>{const y=p.component=c.component;if(kl(c,p,g))if(y.asyncDep&&!y.asyncResolved){te(y,p,g);return}else y.next=p,ml(y.update),y.update();else p.el=c.el,y.vnode=p},le=(c,p,g,y,b,x,S)=>{const w=()=>{if(c.isMounted){let{next:H,bu:O,u:N,parent:j,vnode:K}=c,X=H,J;$t(c,!1),H?(H.el=K.el,te(c,H,S)):H=K,O&&Fs(O),(J=H.props&&H.props.onVnodeBeforeUpdate)&&We(J,j,H,K),$t(c,!0);const se=$i(c),je=c.subTree;c.subTree=se,R(je,se,u(je.el),As(je),c,b,x),H.el=se.el,X===null&&Tl(c,se.el),N&&Se(N,b),(J=H.props&&H.props.onVnodeUpdated)&&Se(()=>We(J,j,H,K),b)}else{let H;const{el:O,props:N}=p,{bm:j,m:K,parent:X}=c,J=cs(p);if($t(c,!1),j&&Fs(j),!J&&(H=N&&N.onVnodeBeforeMount)&&We(H,X,p),$t(c,!0),O&&ki){const se=()=>{c.subTree=$i(c),ki(O,c.subTree,c,b,null)};J?p.type.__asyncLoader().then(()=>!c.isUnmounted&&se()):se()}else{const se=c.subTree=$i(c);R(null,se,g,y,c,b,x),p.el=se.el}if(K&&Se(K,b),!J&&(H=N&&N.onVnodeMounted)){const se=p;Se(()=>We(H,X,se),b)}(p.shapeFlag&256||X&&cs(X.vnode)&&X.vnode.shapeFlag&256)&&c.a&&Se(c.a,b),c.isMounted=!0,p=g=y=null}},$=c.effect=new hn(w,()=>vn(v),c.scope),v=c.update=()=>$.run();v.id=c.uid,$t(c,!0),v()},te=(c,p,g)=>{p.component=c;const y=c.vnode.props;c.vnode=p,c.next=null,Vl(c,p.props,y,g),Jl(c,p.children,g),es(),Yn(),ts()},Xe=(c,p,g,y,b,x,S,w,$=!1)=>{const v=c&&c.children,H=c?c.shapeFlag:0,O=p.children,{patchFlag:N,shapeFlag:j}=p;if(N>0){if(N&128){ss(v,O,g,y,b,x,S,w,$);return}else if(N&256){xi(v,O,g,y,b,x,S,w,$);return}}j&8?(H&16&&Je(v,b,x),O!==v&&h(g,O)):H&16?j&16?ss(v,O,g,y,b,x,S,w,$):Je(v,b,x,!0):(H&8&&h(g,""),j&16&&D(O,g,y,b,x,S,w,$))},xi=(c,p,g,y,b,x,S,w,$)=>{c=c||qt,p=p||qt;const v=c.length,H=p.length,O=Math.min(v,H);let N;for(N=0;N<O;N++){const j=p[N]=$?ft(p[N]):Ye(p[N]);R(c[N],j,g,null,b,x,S,w,$)}v>H?Je(c,b,x,!0,!1,O):D(p,g,y,b,x,S,w,$,O)},ss=(c,p,g,y,b,x,S,w,$)=>{let v=0;const H=p.length;let O=c.length-1,N=H-1;for(;v<=O&&v<=N;){const j=c[v],K=p[v]=$?ft(p[v]):Ye(p[v]);if(ns(j,K))R(j,K,g,null,b,x,S,w,$);else break;v++}for(;v<=O&&v<=N;){const j=c[O],K=p[N]=$?ft(p[N]):Ye(p[N]);if(ns(j,K))R(j,K,g,null,b,x,S,w,$);else break;O--,N--}if(v>O){if(v<=N){const j=N+1,K=j<H?p[j].el:y;for(;v<=N;)R(null,p[v]=$?ft(p[v]):Ye(p[v]),g,K,b,x,S,w,$),v++}}else if(v>N)for(;v<=O;)dt(c[v],b,x,!0),v++;else{const j=v,K=v,X=new Map;for(v=K;v<=N;v++){const Ae=p[v]=$?ft(p[v]):Ye(p[v]);Ae.key!=null&&X.set(Ae.key,v)}let J,se=0;const je=N-K+1;let Bt=!1,Mn=0;const is=new Array(je);for(v=0;v<je;v++)is[v]=0;for(v=j;v<=O;v++){const Ae=c[v];if(se>=je){dt(Ae,b,x,!0);continue}let qe;if(Ae.key!=null)qe=X.get(Ae.key);else for(J=K;J<=N;J++)if(is[J-K]===0&&ns(Ae,p[J])){qe=J;break}qe===void 0?dt(Ae,b,x,!0):(is[qe-K]=v+1,qe>=Mn?Mn=qe:Bt=!0,R(Ae,p[qe],g,null,b,x,S,w,$),se++)}const Hn=Bt?sc(is):qt;for(J=Hn.length-1,v=je-1;v>=0;v--){const Ae=K+v,qe=p[Ae],Nn=Ae+1<H?p[Ae+1].el:y;is[v]===0?R(null,qe,g,Nn,b,x,S,w,$):Bt&&(J<0||v!==Hn[J]?Ft(qe,g,Nn,2):J--)}}},Ft=(c,p,g,y,b=null)=>{const{el:x,type:S,transition:w,children:$,shapeFlag:v}=c;if(v&6){Ft(c.component.subTree,p,g,y);return}if(v&128){c.suspense.move(p,g,y);return}if(v&64){S.move(c,p,g,zt);return}if(S===F){i(x,p,g);for(let O=0;O<$.length;O++)Ft($[O],p,g,y);i(c.anchor,p,g);return}if(S===Si){z(c,p,g);return}if(y!==2&&v&1&&w)if(y===0)w.beforeEnter(x),i(x,p,g),Se(()=>w.enter(x),b);else{const{leave:O,delayLeave:N,afterLeave:j}=w,K=()=>i(x,p,g),X=()=>{O(x,()=>{K(),j&&j()})};N?N(x,K,X):X()}else i(x,p,g)},dt=(c,p,g,y=!1,b=!1)=>{const{type:x,props:S,ref:w,children:$,dynamicChildren:v,shapeFlag:H,patchFlag:O,dirs:N}=c;if(w!=null&&Wi(w,null,g,c,!0),H&256){p.ctx.deactivate(c);return}const j=H&1&&N,K=!cs(c);let X;if(K&&(X=S&&S.onVnodeBeforeUnmount)&&We(X,p,c),H&6)wr(c.component,g,y);else{if(H&128){c.suspense.unmount(g,y);return}j&&Tt(c,null,p,"beforeUnmount"),H&64?c.type.remove(c,p,g,b,zt,y):v&&(x!==F||O>0&&O&64)?Je(v,p,g,!1,!0):(x===F&&O&384||!b&&H&16)&&Je($,p,g),y&&On(c)}(K&&(X=S&&S.onVnodeUnmounted)||j)&&Se(()=>{X&&We(X,p,c),j&&Tt(c,null,p,"unmounted")},g)},On=c=>{const{type:p,el:g,anchor:y,transition:b}=c;if(p===F){vr(g,y);return}if(p===Si){oe(c);return}const x=()=>{n(g),b&&!b.persisted&&b.afterLeave&&b.afterLeave()};if(c.shapeFlag&1&&b&&!b.persisted){const{leave:S,delayLeave:w}=b,$=()=>S(g,x);w?w(c.el,x,$):$()}else x()},vr=(c,p)=>{let g;for(;c!==p;)g=f(c),n(c),c=g;n(p)},wr=(c,p,g)=>{const{bum:y,scope:b,update:x,subTree:S,um:w}=c;y&&Fs(y),b.stop(),x&&(x.active=!1,dt(S,c,p,g)),w&&Se(w,p),Se(()=>{c.isUnmounted=!0},p),p&&p.pendingBranch&&!p.isUnmounted&&c.asyncDep&&!c.asyncResolved&&c.suspenseId===p.pendingId&&(p.deps--,p.deps===0&&p.resolve())},Je=(c,p,g,y=!1,b=!1,x=0)=>{for(let S=x;S<c.length;S++)dt(c[S],p,g,y,b)},As=c=>c.shapeFlag&6?As(c.component.subTree):c.shapeFlag&128?c.suspense.next():f(c.anchor||c.el),En=(c,p,g)=>{c==null?p._vnode&&dt(p._vnode,null,null,!0):R(p._vnode||null,c,p,null,null,null,g),Yn(),da(),p._vnode=c},zt={p:R,um:dt,m:Ft,r:On,mt:kt,mc:D,pc:Xe,pbc:ae,n:As,o:e};let _i,ki;return t&&([_i,ki]=t(zt)),{render:En,hydrate:_i,createApp:Zl(En,_i)}}function $t({effect:e,update:t},s){e.allowRecurse=t.allowRecurse=s}function Aa(e,t,s=!1){const i=e.children,n=t.children;if(B(i)&&B(n))for(let o=0;o<i.length;o++){const a=i[o];let r=n[o];r.shapeFlag&1&&!r.dynamicChildren&&((r.patchFlag<=0||r.patchFlag===32)&&(r=n[o]=ft(n[o]),r.el=a.el),s||Aa(a,r))}}function sc(e){const t=e.slice(),s=[0];let i,n,o,a,r;const l=e.length;for(i=0;i<l;i++){const d=e[i];if(d!==0){if(n=s[s.length-1],e[n]<d){t[i]=n,s.push(i);continue}for(o=0,a=s.length-1;o<a;)r=o+a>>1,e[s[r]]<d?o=r+1:a=r;d<e[s[o]]&&(o>0&&(t[i]=s[o-1]),s[o]=i)}}for(o=s.length,a=s[o-1];o-- >0;)s[o]=a,a=t[a];return s}const ic=e=>e.__isTeleport,F=Symbol(void 0),kn=Symbol(void 0),wt=Symbol(void 0),Si=Symbol(void 0),ds=[];let ze=null;function T(e=!1){ds.push(ze=e?null:[])}function nc(){ds.pop(),ze=ds[ds.length-1]||null}let xs=1;function so(e){xs+=e}function Ra(e){return e.dynamicChildren=xs>0?ze||qt:null,nc(),xs>0&&ze&&ze.push(e),e}function L(e,t,s,i,n,o){return Ra(m(e,t,s,i,n,o,!0))}function Ge(e,t,s,i,n){return Ra(W(e,t,s,i,n,!0))}function Ks(e){return e?e.__v_isVNode===!0:!1}function ns(e,t){return e.type===t.type&&e.key===t.key}const di="__vInternal",Ia=({key:e})=>e!=null?e:null,zs=({ref:e,ref_key:t,ref_for:s})=>e!=null?pe(e)||we(e)||q(e)?{i:ke,r:e,k:t,f:!!s}:e:null;function m(e,t=null,s=null,i=0,n=null,o=e===F?0:1,a=!1,r=!1){const l={__v_isVNode:!0,__v_skip:!0,type:e,props:t,key:t&&Ia(t),ref:t&&zs(t),scopeId:li,slotScopeIds:null,children:s,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetAnchor:null,staticCount:0,shapeFlag:o,patchFlag:i,dynamicProps:n,dynamicChildren:null,appContext:null};return r?($n(l,s),o&128&&e.normalize(l)):s&&(l.shapeFlag|=pe(s)?8:16),xs>0&&!a&&ze&&(l.patchFlag>0||o&6)&&l.patchFlag!==32&&ze.push(l),l}const W=oc;function oc(e,t=null,s=null,i=0,n=null,o=!1){if((!e||e===va)&&(e=wt),Ks(e)){const r=Gt(e,t,!0);return s&&$n(r,s),xs>0&&!o&&ze&&(r.shapeFlag&6?ze[ze.indexOf(e)]=r:ze.push(r)),r.patchFlag|=-2,r}if(fc(e)&&(e=e.__vccOpts),t){t=Tn(t);let{class:r,style:l}=t;r&&!pe(r)&&(t.class=ye(r)),ne(l)&&(sa(l)&&!B(l)&&(l=$e({},l)),t.style=tt(l))}const a=pe(e)?1:$l(e)?128:ic(e)?64:ne(e)?4:q(e)?2:0;return m(e,t,s,i,n,a,o,!0)}function Tn(e){return e?sa(e)||di in e?$e({},e):e:null}function Gt(e,t,s=!1){const{props:i,ref:n,patchFlag:o,children:a}=e,r=t?Oa(i||{},t):i;return{__v_isVNode:!0,__v_skip:!0,type:e.type,props:r,key:r&&Ia(r),ref:t&&t.ref?s&&n?B(n)?n.concat(zs(t)):[n,zs(t)]:zs(t):n,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:a,target:e.target,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:t&&e.type!==F?o===-1?16:o|16:o,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:e.transition,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&Gt(e.ssContent),ssFallback:e.ssFallback&&Gt(e.ssFallback),el:e.el,anchor:e.anchor}}function Z(e=" ",t=0){return W(kn,null,e,t)}function Te(e="",t=!1){return t?(T(),Ge(wt,null,e)):W(wt,null,e)}function Ye(e){return e==null||typeof e=="boolean"?W(wt):B(e)?W(F,null,e.slice()):typeof e=="object"?ft(e):W(kn,null,String(e))}function ft(e){return e.el===null||e.memo?e:Gt(e)}function $n(e,t){let s=0;const{shapeFlag:i}=e;if(t==null)t=null;else if(B(t))s=16;else if(typeof t=="object")if(i&65){const n=t.default;n&&(n._c&&(n._d=!1),$n(e,n()),n._c&&(n._d=!0));return}else{s=32;const n=t._;!n&&!(di in t)?t._ctx=ke:n===3&&ke&&(ke.slots._===1?t._=1:(t._=2,e.patchFlag|=1024))}else q(t)?(t={default:t,_ctx:ke},s=32):(t=String(t),i&64?(s=16,t=[Z(t)]):s=8);e.children=t,e.shapeFlag|=s}function Oa(...e){const t={};for(let s=0;s<e.length;s++){const i=e[s];for(const n in i)if(n==="class")t.class!==i.class&&(t.class=ye([t.class,i.class]));else if(n==="style")t.style=tt([t.style,i.style]);else if(ei(n)){const o=t[n],a=i[n];a&&o!==a&&!(B(o)&&o.includes(a))&&(t[n]=o?[].concat(o,a):a)}else n!==""&&(t[n]=i[n])}return t}function We(e,t,s,i=null){De(e,t,7,[s,i])}const ac=La();let rc=0;function lc(e,t,s){const i=e.type,n=(t?t.appContext:e.appContext)||ac,o={uid:rc++,vnode:e,type:i,parent:t,appContext:n,root:null,next:null,subTree:null,effect:null,update:null,scope:new Or(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:t?t.provides:Object.create(n.provides),accessCache:null,renderCache:[],components:null,directives:null,propsOptions:$a(i,n),emitsOptions:ha(i,n),emit:null,emitted:null,propsDefaults:Q,inheritAttrs:i.inheritAttrs,ctx:Q,data:Q,props:Q,attrs:Q,slots:Q,refs:Q,setupState:Q,setupContext:null,suspense:s,suspenseId:s?s.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return o.ctx={_:o},o.root=t?t.root:o,o.emit=vl.bind(null,o),e.ce&&e.ce(o),o}let be=null;const Xt=e=>{be=e,e.scope.on()},Et=()=>{be&&be.scope.off(),be=null};function Ea(e){return e.vnode.shapeFlag&4}let _s=!1;function cc(e,t=!1){_s=t;const{props:s,children:i}=e.vnode,n=Ea(e);Kl(e,s,n,t),Xl(e,i);const o=n?dc(e,t):void 0;return _s=!1,o}function dc(e,t){const s=e.type;e.accessCache=Object.create(null),e.proxy=ia(new Proxy(e.ctx,Bl));const{setup:i}=s;if(i){const n=e.setupContext=i.length>1?hc(e):null;Xt(e),es();const o=mt(i,e,0,[e.props,n]);if(ts(),Et(),Do(o)){if(o.then(Et,Et),t)return o.then(a=>{io(e,a,t)}).catch(a=>{ai(a,e,0)});e.asyncDep=o}else io(e,o,t)}else Ma(e,t)}function io(e,t,s){q(t)?e.type.__ssrInlineRender?e.ssrRender=t:e.render=t:ne(t)&&(e.setupState=aa(t)),Ma(e,s)}let no;function Ma(e,t,s){const i=e.type;if(!e.render){if(!t&&no&&!i.render){const n=i.template||xn(e).template;if(n){const{isCustomElement:o,compilerOptions:a}=e.appContext.config,{delimiters:r,compilerOptions:l}=i,d=$e($e({isCustomElement:o,delimiters:r},a),l);i.render=no(n,d)}}e.render=i.render||Be}Xt(e),es(),Dl(e),ts(),Et()}function pc(e){return new Proxy(e.attrs,{get(t,s){return Ee(e,"get","$attrs"),t[s]}})}function hc(e){const t=i=>{e.exposed=i||{}};let s;return{get attrs(){return s||(s=pc(e))},slots:e.slots,emit:e.emit,expose:t}}function pi(e){if(e.exposed)return e.exposeProxy||(e.exposeProxy=new Proxy(aa(ia(e.exposed)),{get(t,s){if(s in t)return t[s];if(s in Us)return Us[s](e)}}))}function uc(e,t=!0){return q(e)?e.displayName||e.name:e.name||t&&e.__name}function fc(e){return q(e)&&"__vccOpts"in e}const ce=(e,t)=>ul(e,t,_s);function gc(e,t,s){const i=arguments.length;return i===2?ne(t)&&!B(t)?Ks(t)?W(e,null,[t]):W(e,t):W(e,null,t):(i>3?s=Array.prototype.slice.call(arguments,2):i===3&&Ks(s)&&(s=[s]),W(e,t,s))}const mc="3.2.39",bc="http://www.w3.org/2000/svg",Rt=typeof document<"u"?document:null,oo=Rt&&Rt.createElement("template"),yc={insert:(e,t,s)=>{t.insertBefore(e,s||null)},remove:e=>{const t=e.parentNode;t&&t.removeChild(e)},createElement:(e,t,s,i)=>{const n=t?Rt.createElementNS(bc,e):Rt.createElement(e,s?{is:s}:void 0);return e==="select"&&i&&i.multiple!=null&&n.setAttribute("multiple",i.multiple),n},createText:e=>Rt.createTextNode(e),createComment:e=>Rt.createComment(e),setText:(e,t)=>{e.nodeValue=t},setElementText:(e,t)=>{e.textContent=t},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>Rt.querySelector(e),setScopeId(e,t){e.setAttribute(t,"")},cloneNode(e){const t=e.cloneNode(!0);return"_value"in e&&(t._value=e._value),t},insertStaticContent(e,t,s,i,n,o){const a=s?s.previousSibling:t.lastChild;if(n&&(n===o||n.nextSibling))for(;t.insertBefore(n.cloneNode(!0),s),!(n===o||!(n=n.nextSibling)););else{oo.innerHTML=i?`<svg>${e}</svg>`:e;const r=oo.content;if(i){const l=r.firstChild;for(;l.firstChild;)r.appendChild(l.firstChild);r.removeChild(l)}t.insertBefore(r,s)}return[a?a.nextSibling:t.firstChild,s?s.previousSibling:t.lastChild]}};function vc(e,t,s){const i=e._vtc;i&&(t=(t?[t,...i]:[...i]).join(" ")),t==null?e.removeAttribute("class"):s?e.setAttribute("class",t):e.className=t}function wc(e,t,s){const i=e.style,n=pe(s);if(s&&!n){for(const o in s)Ui(i,o,s[o]);if(t&&!pe(t))for(const o in t)s[o]==null&&Ui(i,o,"")}else{const o=i.display;n?t!==s&&(i.cssText=s):t&&e.removeAttribute("style"),"_vod"in e&&(i.display=o)}}const ao=/\s*!important$/;function Ui(e,t,s){if(B(s))s.forEach(i=>Ui(e,t,i));else if(s==null&&(s=""),t.startsWith("--"))e.setProperty(t,s);else{const i=xc(e,t);ao.test(s)?e.setProperty(Nt(i),s.replace(ao,""),"important"):e[i]=s}}const ro=["Webkit","Moz","ms"],Pi={};function xc(e,t){const s=Pi[t];if(s)return s;let i=Ve(t);if(i!=="filter"&&i in e)return Pi[t]=i;i=ii(i);for(let n=0;n<ro.length;n++){const o=ro[n]+i;if(o in e)return Pi[t]=o}return t}const lo="http://www.w3.org/1999/xlink";function _c(e,t,s,i,n){if(i&&t.startsWith("xlink:"))s==null?e.removeAttributeNS(lo,t.slice(6,t.length)):e.setAttributeNS(lo,t,s);else{const o=_r(t);s==null||o&&!jo(s)?e.removeAttribute(t):e.setAttribute(t,o?"":s)}}function kc(e,t,s,i,n,o,a){if(t==="innerHTML"||t==="textContent"){i&&a(i,n,o),e[t]=s==null?"":s;return}if(t==="value"&&e.tagName!=="PROGRESS"&&!e.tagName.includes("-")){e._value=s;const l=s==null?"":s;(e.value!==l||e.tagName==="OPTION")&&(e.value=l),s==null&&e.removeAttribute(t);return}let r=!1;if(s===""||s==null){const l=typeof e[t];l==="boolean"?s=jo(s):s==null&&l==="string"?(s="",r=!0):l==="number"&&(s=0,r=!0)}try{e[t]=s}catch{}r&&e.removeAttribute(t)}const[Ha,Tc]=(()=>{let e=Date.now,t=!1;if(typeof window<"u"){Date.now()>document.createEvent("Event").timeStamp&&(e=performance.now.bind(performance));const s=navigator.userAgent.match(/firefox\/(\d+)/i);t=!!(s&&Number(s[1])<=53)}return[e,t]})();let Yi=0;const $c=Promise.resolve(),Cc=()=>{Yi=0},Sc=()=>Yi||($c.then(Cc),Yi=Ha());function Dt(e,t,s,i){e.addEventListener(t,s,i)}function Pc(e,t,s,i){e.removeEventListener(t,s,i)}function Lc(e,t,s,i,n=null){const o=e._vei||(e._vei={}),a=o[t];if(i&&a)a.value=i;else{const[r,l]=Ac(t);if(i){const d=o[t]=Rc(i,n);Dt(e,r,d,l)}else a&&(Pc(e,r,a,l),o[t]=void 0)}}const co=/(?:Once|Passive|Capture)$/;function Ac(e){let t;if(co.test(e)){t={};let i;for(;i=e.match(co);)e=e.slice(0,e.length-i[0].length),t[i[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):Nt(e.slice(2)),t]}function Rc(e,t){const s=i=>{const n=i.timeStamp||Ha();(Tc||n>=s.attached-1)&&De(Ic(i,s.value),t,5,[i])};return s.value=e,s.attached=Sc(),s}function Ic(e,t){if(B(t)){const s=e.stopImmediatePropagation;return e.stopImmediatePropagation=()=>{s.call(e),e._stopped=!0},t.map(i=>n=>!n._stopped&&i&&i(n))}else return t}const po=/^on[a-z]/,Oc=(e,t,s,i,n=!1,o,a,r,l)=>{t==="class"?vc(e,i,n):t==="style"?wc(e,s,i):ei(t)?rn(t)||Lc(e,t,s,i,a):(t[0]==="."?(t=t.slice(1),!0):t[0]==="^"?(t=t.slice(1),!1):Ec(e,t,i,n))?kc(e,t,i,o,a,r,l):(t==="true-value"?e._trueValue=i:t==="false-value"&&(e._falseValue=i),_c(e,t,i,n))};function Ec(e,t,s,i){return i?!!(t==="innerHTML"||t==="textContent"||t in e&&po.test(t)&&q(s)):t==="spellcheck"||t==="draggable"||t==="translate"||t==="form"||t==="list"&&e.tagName==="INPUT"||t==="type"&&e.tagName==="TEXTAREA"||po.test(t)&&pe(s)?!1:t in e}const ho=e=>{const t=e.props["onUpdate:modelValue"]||!1;return B(t)?s=>Fs(t,s):t};function Mc(e){e.target.composing=!0}function uo(e){const t=e.target;t.composing&&(t.composing=!1,t.dispatchEvent(new Event("input")))}const Hc={created(e,{modifiers:{lazy:t,trim:s,number:i}},n){e._assign=ho(n);const o=i||n.props&&n.props.type==="number";Dt(e,t?"change":"input",a=>{if(a.target.composing)return;let r=e.value;s&&(r=r.trim()),o&&(r=Ei(r)),e._assign(r)}),s&&Dt(e,"change",()=>{e.value=e.value.trim()}),t||(Dt(e,"compositionstart",Mc),Dt(e,"compositionend",uo),Dt(e,"change",uo))},mounted(e,{value:t}){e.value=t==null?"":t},beforeUpdate(e,{value:t,modifiers:{lazy:s,trim:i,number:n}},o){if(e._assign=ho(o),e.composing||document.activeElement===e&&e.type!=="range"&&(s||i&&e.value.trim()===t||(n||e.type==="number")&&Ei(e.value)===t))return;const a=t==null?"":t;e.value!==a&&(e.value=a)}},Nc=["ctrl","shift","alt","meta"],jc={stop:e=>e.stopPropagation(),prevent:e=>e.preventDefault(),self:e=>e.target!==e.currentTarget,ctrl:e=>!e.ctrlKey,shift:e=>!e.shiftKey,alt:e=>!e.altKey,meta:e=>!e.metaKey,left:e=>"button"in e&&e.button!==0,middle:e=>"button"in e&&e.button!==1,right:e=>"button"in e&&e.button!==2,exact:(e,t)=>Nc.some(s=>e[`${s}Key`]&&!t.includes(s))},Vs=(e,t)=>(s,...i)=>{for(let n=0;n<t.length;n++){const o=jc[t[n]];if(o&&o(s,t))return}return e(s,...i)},Fc={esc:"escape",space:" ",up:"arrow-up",left:"arrow-left",right:"arrow-right",down:"arrow-down",delete:"backspace"},Na=(e,t)=>s=>{if(!("key"in s))return;const i=Nt(s.key);if(t.some(n=>n===i||Fc[n]===i))return e(s)},zc=$e({patchProp:Oc},yc);let fo;function Bc(){return fo||(fo=ec(zc))}const ja=(...e)=>{const t=Bc().createApp(...e),{mount:s}=t;return t.mount=i=>{const n=Dc(i);if(!n)return;const o=t._component;!q(o)&&!o.render&&!o.template&&(o.template=n.innerHTML),n.innerHTML="";const a=s(n,!1,n instanceof SVGElement);return n instanceof Element&&(n.removeAttribute("v-cloak"),n.setAttribute("data-v-app","")),a},t};function Dc(e){return pe(e)?document.querySelector(e):e}function qc(e,t){return(!t.tag||e.tag===t.tag)&&(!t.type||e.type===t.type)}const Fa=[{name:"HTML and the DOM",skippable:!0,instructions:`<img src="img/chef.png" style="width: 88px; margin: 0 auto"/>
        ...
        `}],Wc={name:"HTML - Semantics",description:"Why semantics matter",intro:`
    <p>HTML is the markup language that describes the <strong>content</strong> of web pages.</p>
    <p>In this chapter, we will look at the different elements available in HTML and why understanding the purpose of each of them is important for you and your visitors.</p>`,levels:Fa};function lt(e){return e.split("-")[0]}function Kt(e){return e.split("-")[1]}function $s(e){return["top","bottom"].includes(lt(e))?"x":"y"}function Cn(e){return e==="y"?"height":"width"}function go(e){let{reference:t,floating:s,placement:i}=e;const n=t.x+t.width/2-s.width/2,o=t.y+t.height/2-s.height/2;let a;switch(lt(i)){case"top":a={x:n,y:t.y-s.height};break;case"bottom":a={x:n,y:t.y+t.height};break;case"right":a={x:t.x+t.width,y:o};break;case"left":a={x:t.x-s.width,y:o};break;default:a={x:t.x,y:t.y}}const r=$s(i),l=Cn(r);switch(Kt(i)){case"start":a[r]=a[r]-(t[l]/2-s[l]/2);break;case"end":a[r]=a[r]+(t[l]/2-s[l]/2);break}return a}const Uc=async(e,t,s)=>{const{placement:i="bottom",strategy:n="absolute",middleware:o=[],platform:a}=s;let r=await a.getElementRects({reference:e,floating:t,strategy:n}),{x:l,y:d}=go({...r,placement:i}),h=i,u={};for(let f=0;f<o.length;f++){const{name:k,fn:P}=o[f],{x:A,y:R,data:I,reset:E}=await P({x:l,y:d,initialPlacement:i,placement:h,strategy:n,middlewareData:u,rects:r,platform:a,elements:{reference:e,floating:t}});if(l=A!=null?A:l,d=R!=null?R:d,u={...u,[k]:I!=null?I:{}},E){typeof E=="object"&&(E.placement&&(h=E.placement),E.rects&&(r=E.rects===!0?await a.getElementRects({reference:e,floating:t,strategy:n}):E.rects),{x:l,y:d}=go({...r,placement:h})),f=-1;continue}}return{x:l,y:d,placement:h,strategy:n,middlewareData:u}};function Yc(e){return{top:0,right:0,bottom:0,left:0,...e}}function za(e){return typeof e!="number"?Yc(e):{top:e,right:e,bottom:e,left:e}}function Ki(e){return{...e,top:e.y,left:e.x,right:e.x+e.width,bottom:e.y+e.height}}async function hi(e,t){t===void 0&&(t={});const{x:s,y:i,platform:n,rects:o,elements:a,strategy:r}=e,{boundary:l="clippingParents",rootBoundary:d="viewport",elementContext:h="floating",altBoundary:u=!1,padding:f=0}=t,k=za(f),A=a[u?h==="floating"?"reference":"floating":h],R=await n.getClippingClientRect({element:await n.isElement(A)?A:A.contextElement||await n.getDocumentElement({element:a.floating}),boundary:l,rootBoundary:d}),I=Ki(await n.convertOffsetParentRelativeRectToViewportRelativeRect({rect:h==="floating"?{...o.floating,x:s,y:i}:o.reference,offsetParent:await n.getOffsetParent({element:a.floating}),strategy:r}));return{top:R.top-I.top+k.top,bottom:I.bottom-R.bottom+k.bottom,left:R.left-I.left+k.left,right:I.right-R.right+k.right}}const Kc=Math.min,Lt=Math.max;function Vi(e,t,s){return Lt(e,Kc(t,s))}const Vc=e=>({name:"arrow",options:e,async fn(t){const{element:s,padding:i=0}=e!=null?e:{},{x:n,y:o,placement:a,rects:r,platform:l}=t;if(s==null)return{};const d=za(i),h={x:n,y:o},u=lt(a),f=$s(u),k=Cn(f),P=await l.getDimensions({element:s}),A=f==="y"?"top":"left",R=f==="y"?"bottom":"right",I=r.reference[k]+r.reference[f]-h[f]-r.floating[k],E=h[f]-r.reference[f],M=await l.getOffsetParent({element:s}),z=M?f==="y"?M.clientHeight||0:M.clientWidth||0:0,oe=I/2-E/2,ue=d[A],fe=z-P[k]-d[R],ie=z/2-P[k]/2+oe,D=Vi(ue,ie,fe);return{data:{[f]:D,centerOffset:ie-D}}}}),Gc={left:"right",right:"left",bottom:"top",top:"bottom"};function Gs(e){return e.replace(/left|right|bottom|top/g,t=>Gc[t])}function Ba(e,t){const s=Kt(e)==="start",i=$s(e),n=Cn(i);let o=i==="x"?s?"right":"left":s?"bottom":"top";return t.reference[n]>t.floating[n]&&(o=Gs(o)),{main:o,cross:Gs(o)}}const Xc={start:"end",end:"start"};function Gi(e){return e.replace(/start|end/g,t=>Xc[t])}const Jc=["top","right","bottom","left"],Qc=Jc.reduce((e,t)=>e.concat(t,t+"-start",t+"-end"),[]);function Zc(e,t,s){return(e?[...s.filter(n=>Kt(n)===e),...s.filter(n=>Kt(n)!==e)]:s.filter(n=>lt(n)===n)).filter(n=>e?Kt(n)===e||(t?Gi(n)!==n:!1):!0)}const ed=function(e){return e===void 0&&(e={}),{name:"autoPlacement",options:e,async fn(t){var s,i,n,o,a,r;const{x:l,y:d,rects:h,middlewareData:u,placement:f}=t,{alignment:k=null,allowedPlacements:P=Qc,autoAlignment:A=!0,...R}=e;if((s=u.autoPlacement)!=null&&s.skip)return{};const I=Zc(k,A,P),E=await hi(t,R),M=(i=(n=u.autoPlacement)==null?void 0:n.index)!=null?i:0,z=I[M],{main:oe,cross:ue}=Ba(z,h);if(f!==z)return{x:l,y:d,reset:{placement:I[0]}};const fe=[E[lt(z)],E[oe],E[ue]],ie=[...(o=(a=u.autoPlacement)==null?void 0:a.overflows)!=null?o:[],{placement:z,overflows:fe}],D=I[M+1];if(D)return{data:{index:M+1,overflows:ie},reset:{placement:D}};const re=ie.slice().sort((de,xe)=>de.overflows[0]-xe.overflows[0]),ae=(r=re.find(de=>{let{overflows:xe}=de;return xe.every(ge=>ge<=0)}))==null?void 0:r.placement;return{data:{skip:!0},reset:{placement:ae!=null?ae:re[0].placement}}}}};function td(e){const t=Gs(e);return[Gi(e),t,Gi(t)]}const sd=function(e){return e===void 0&&(e={}),{name:"flip",options:e,async fn(t){var s,i;const{placement:n,middlewareData:o,rects:a,initialPlacement:r}=t;if((s=o.flip)!=null&&s.skip)return{};const{mainAxis:l=!0,crossAxis:d=!0,fallbackPlacements:h,fallbackStrategy:u="bestFit",flipAlignment:f=!0,...k}=e,P=lt(n),R=h||(P===r||!f?[Gs(r)]:td(r)),I=[r,...R],E=await hi(t,k),M=[];let z=((i=o.flip)==null?void 0:i.overflows)||[];if(l&&M.push(E[P]),d){const{main:ie,cross:D}=Ba(n,a);M.push(E[ie],E[D])}if(z=[...z,{placement:n,overflows:M}],!M.every(ie=>ie<=0)){var oe,ue;const ie=((oe=(ue=o.flip)==null?void 0:ue.index)!=null?oe:0)+1,D=I[ie];if(D)return{data:{index:ie,overflows:z},reset:{placement:D}};let re="bottom";switch(u){case"bestFit":{var fe;const ae=(fe=z.slice().sort((de,xe)=>de.overflows.filter(ge=>ge>0).reduce((ge,kt)=>ge+kt,0)-xe.overflows.filter(ge=>ge>0).reduce((ge,kt)=>ge+kt,0))[0])==null?void 0:fe.placement;ae&&(re=ae);break}case"initialPlacement":re=r;break}return{data:{skip:!0},reset:{placement:re}}}return{}}}};function id(e){let{placement:t,rects:s,value:i}=e;const n=lt(t),o=["left","top"].includes(n)?-1:1,a=typeof i=="function"?i({...s,placement:t}):i,{mainAxis:r,crossAxis:l}=typeof a=="number"?{mainAxis:a,crossAxis:0}:{mainAxis:0,crossAxis:0,...a};return $s(n)==="x"?{x:l,y:r*o}:{x:r*o,y:l}}const nd=function(e){return e===void 0&&(e=0),{name:"offset",options:e,fn(t){const{x:s,y:i,placement:n,rects:o}=t,a=id({placement:n,rects:o,value:e});return{x:s+a.x,y:i+a.y,data:a}}}};function od(e){return e==="x"?"y":"x"}const ad=function(e){return e===void 0&&(e={}),{name:"shift",options:e,async fn(t){const{x:s,y:i,placement:n}=t,{mainAxis:o=!0,crossAxis:a=!1,limiter:r={fn:R=>{let{x:I,y:E}=R;return{x:I,y:E}}},...l}=e,d={x:s,y:i},h=await hi(t,l),u=$s(lt(n)),f=od(u);let k=d[u],P=d[f];if(o){const R=u==="y"?"top":"left",I=u==="y"?"bottom":"right",E=k+h[R],M=k-h[I];k=Vi(E,k,M)}if(a){const R=f==="y"?"top":"left",I=f==="y"?"bottom":"right",E=P+h[R],M=P-h[I];P=Vi(E,P,M)}const A=r.fn({...t,[u]:k,[f]:P});return{...A,data:{x:A.x-s,y:A.y-i}}}}},rd=function(e){return e===void 0&&(e={}),{name:"size",options:e,async fn(t){var s;const{placement:i,rects:n,middlewareData:o}=t,{apply:a,...r}=e;if((s=o.size)!=null&&s.skip)return{};const l=await hi(t,r),d=lt(i),h=Kt(i)==="end";let u,f;d==="top"||d==="bottom"?(u=d,f=h?"left":"right"):(f=d,u=h?"top":"bottom");const k=Lt(l.left,0),P=Lt(l.right,0),A=Lt(l.top,0),R=Lt(l.bottom,0),I={height:n.floating.height-(["left","right"].includes(i)?2*(A!==0||R!==0?A+R:Lt(l.top,l.bottom)):l[u]),width:n.floating.width-(["top","bottom"].includes(i)?2*(k!==0||P!==0?k+P:Lt(l.left,l.right)):l[f])};return a==null||a({...I,...n}),{data:{skip:!0},reset:{rects:!0}}}}};function Sn(e){return(e==null?void 0:e.toString())==="[object Window]"}function xt(e){if(e==null)return window;if(!Sn(e)){const t=e.ownerDocument;return t&&t.defaultView||window}return e}function ui(e){return xt(e).getComputedStyle(e)}function nt(e){return Sn(e)?"":e?(e.nodeName||"").toLowerCase():""}function ot(e){return e instanceof xt(e).HTMLElement}function Xs(e){return e instanceof xt(e).Element}function ld(e){return e instanceof xt(e).Node}function Da(e){const t=xt(e).ShadowRoot;return e instanceof t||e instanceof ShadowRoot}function fi(e){const{overflow:t,overflowX:s,overflowY:i}=ui(e);return/auto|scroll|overlay|hidden/.test(t+i+s)}function cd(e){return["table","td","th"].includes(nt(e))}function qa(e){const t=navigator.userAgent.toLowerCase().includes("firefox"),s=ui(e);return s.transform!=="none"||s.perspective!=="none"||s.contain==="paint"||["transform","perspective"].includes(s.willChange)||t&&s.willChange==="filter"||t&&(s.filter?s.filter!=="none":!1)}const mo=Math.min,ps=Math.max,Js=Math.round;function Jt(e,t){t===void 0&&(t=!1);const s=e.getBoundingClientRect();let i=1,n=1;return t&&ot(e)&&(i=e.offsetWidth>0&&Js(s.width)/e.offsetWidth||1,n=e.offsetHeight>0&&Js(s.height)/e.offsetHeight||1),{width:s.width/i,height:s.height/n,top:s.top/n,right:s.right/i,bottom:s.bottom/n,left:s.left/i,x:s.left/i,y:s.top/n}}function _t(e){return((ld(e)?e.ownerDocument:e.document)||window.document).documentElement}function gi(e){return Sn(e)?{scrollLeft:e.pageXOffset,scrollTop:e.pageYOffset}:{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}}function Wa(e){return Jt(_t(e)).left+gi(e).scrollLeft}function dd(e){const t=Jt(e);return Js(t.width)!==e.offsetWidth||Js(t.height)!==e.offsetHeight}function pd(e,t,s){const i=ot(t),n=_t(t),o=Jt(e,i&&dd(t));let a={scrollLeft:0,scrollTop:0};const r={x:0,y:0};if(i||!i&&s!=="fixed")if((nt(t)!=="body"||fi(n))&&(a=gi(t)),ot(t)){const l=Jt(t,!0);r.x=l.x+t.clientLeft,r.y=l.y+t.clientTop}else n&&(r.x=Wa(n));return{x:o.left+a.scrollLeft-r.x,y:o.top+a.scrollTop-r.y,width:o.width,height:o.height}}function mi(e){return nt(e)==="html"?e:e.assignedSlot||e.parentNode||(Da(e)?e.host:null)||_t(e)}function bo(e){return!ot(e)||getComputedStyle(e).position==="fixed"?null:e.offsetParent}function hd(e){let t=mi(e);for(;ot(t)&&!["html","body"].includes(nt(t));){if(qa(t))return t;t=t.parentNode}return null}function Xi(e){const t=xt(e);let s=bo(e);for(;s&&cd(s)&&getComputedStyle(s).position==="static";)s=bo(s);return s&&(nt(s)==="html"||nt(s)==="body"&&getComputedStyle(s).position==="static"&&!qa(s))?t:s||hd(e)||t}function yo(e){return{width:e.offsetWidth,height:e.offsetHeight}}function ud(e){let{rect:t,offsetParent:s,strategy:i}=e;const n=ot(s),o=_t(s);if(s===o)return t;let a={scrollLeft:0,scrollTop:0};const r={x:0,y:0};if((n||!n&&i!=="fixed")&&((nt(s)!=="body"||fi(o))&&(a=gi(s)),ot(s))){const l=Jt(s,!0);r.x=l.x+s.clientLeft,r.y=l.y+s.clientTop}return{...t,x:t.x-a.scrollLeft+r.x,y:t.y-a.scrollTop+r.y}}function fd(e){const t=xt(e),s=_t(e),i=t.visualViewport;let n=s.clientWidth,o=s.clientHeight,a=0,r=0;return i&&(n=i.width,o=i.height,Math.abs(t.innerWidth/i.scale-i.width)<.01&&(a=i.offsetLeft,r=i.offsetTop)),{width:n,height:o,x:a,y:r}}function gd(e){var t;const s=_t(e),i=gi(e),n=(t=e.ownerDocument)==null?void 0:t.body,o=ps(s.scrollWidth,s.clientWidth,n?n.scrollWidth:0,n?n.clientWidth:0),a=ps(s.scrollHeight,s.clientHeight,n?n.scrollHeight:0,n?n.clientHeight:0);let r=-i.scrollLeft+Wa(e);const l=-i.scrollTop;return ui(n||s).direction==="rtl"&&(r+=ps(s.clientWidth,n?n.clientWidth:0)-o),{width:o,height:a,x:r,y:l}}function Ua(e){return["html","body","#document"].includes(nt(e))?e.ownerDocument.body:ot(e)&&fi(e)?e:Ua(mi(e))}function Qs(e,t){var s;t===void 0&&(t=[]);const i=Ua(e),n=i===((s=e.ownerDocument)==null?void 0:s.body),o=xt(i),a=n?[o].concat(o.visualViewport||[],fi(i)?i:[]):i,r=t.concat(a);return n?r:r.concat(Qs(mi(a)))}function md(e,t){const s=t.getRootNode==null?void 0:t.getRootNode();if(e.contains(t))return!0;if(s&&Da(s)){let i=t;do{if(i&&e===i)return!0;i=i.parentNode||i.host}while(i)}return!1}function bd(e){const t=Jt(e),s=t.top+e.clientTop,i=t.left+e.clientLeft;return{top:s,left:i,x:i,y:s,right:i+e.clientWidth,bottom:s+e.clientHeight,width:e.clientWidth,height:e.clientHeight}}function vo(e,t){return t==="viewport"?Ki(fd(e)):Xs(t)?bd(t):Ki(gd(_t(e)))}function yd(e){const t=Qs(mi(e)),i=["absolute","fixed"].includes(ui(e).position)&&ot(e)?Xi(e):e;return Xs(i)?t.filter(n=>Xs(n)&&md(n,i)&&nt(n)!=="body"):[]}function vd(e){let{element:t,boundary:s,rootBoundary:i}=e;const o=[...s==="clippingParents"?yd(t):[].concat(s),i],a=o[0],r=o.reduce((l,d)=>{const h=vo(t,d);return l.top=ps(h.top,l.top),l.right=mo(h.right,l.right),l.bottom=mo(h.bottom,l.bottom),l.left=ps(h.left,l.left),l},vo(t,a));return r.width=r.right-r.left,r.height=r.bottom-r.top,r.x=r.left,r.y=r.top,r}const wd={getElementRects:e=>{let{reference:t,floating:s,strategy:i}=e;return{reference:pd(t,Xi(s),i),floating:{...yo(s),x:0,y:0}}},convertOffsetParentRelativeRectToViewportRelativeRect:e=>ud(e),getOffsetParent:e=>{let{element:t}=e;return Xi(t)},isElement:e=>Xs(e),getDocumentElement:e=>{let{element:t}=e;return _t(t)},getClippingClientRect:e=>vd(e),getDimensions:e=>{let{element:t}=e;return yo(t)},getClientRects:e=>{let{element:t}=e;return t.getClientRects()}},xd=(e,t,s)=>Uc(e,t,{platform:wd,...s});var _d=Object.defineProperty,kd=Object.defineProperties,Td=Object.getOwnPropertyDescriptors,wo=Object.getOwnPropertySymbols,$d=Object.prototype.hasOwnProperty,Cd=Object.prototype.propertyIsEnumerable,xo=(e,t,s)=>t in e?_d(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s,Ze=(e,t)=>{for(var s in t||(t={}))$d.call(t,s)&&xo(e,s,t[s]);if(wo)for(var s of wo(t))Cd.call(t,s)&&xo(e,s,t[s]);return e},Cs=(e,t)=>kd(e,Td(t));function Ya(e,t){for(const s in t)Object.prototype.hasOwnProperty.call(t,s)&&(typeof t[s]=="object"&&e[s]?Ya(e[s],t[s]):e[s]=t[s])}const st={disabled:!1,distance:5,skidding:0,container:"body",boundary:void 0,instantMove:!1,disposeTimeout:5e3,popperTriggers:[],strategy:"absolute",preventOverflow:!0,flip:!0,shift:!0,overflowPadding:0,arrowPadding:0,arrowOverflow:!0,themes:{tooltip:{placement:"top",triggers:["hover","focus","touch"],hideTriggers:e=>[...e,"click"],delay:{show:200,hide:0},handleResize:!1,html:!1,loadingContent:"..."},dropdown:{placement:"bottom",triggers:["click"],delay:0,handleResize:!0,autoHide:!0},menu:{$extend:"dropdown",triggers:["hover","focus"],popperTriggers:["hover","focus"],delay:{show:0,hide:400}}}};function Qt(e,t){let s=st.themes[e]||{},i;do i=s[t],typeof i>"u"?s.$extend?s=st.themes[s.$extend]||{}:(s=null,i=st[t]):s=null;while(s);return i}function Sd(e){const t=[e];let s=st.themes[e]||{};do s.$extend&&!s.$resetCss?(t.push(s.$extend),s=st.themes[s.$extend]||{}):s=null;while(s);return t.map(i=>`v-popper--theme-${i}`)}function _o(e){const t=[e];let s=st.themes[e]||{};do s.$extend?(t.push(s.$extend),s=st.themes[s.$extend]||{}):s=null;while(s);return t}let Mt=!1;if(typeof window<"u"){Mt=!1;try{const e=Object.defineProperty({},"passive",{get(){Mt=!0}});window.addEventListener("test",null,e)}catch{}}let Ka=!1;typeof window<"u"&&typeof navigator<"u"&&(Ka=/iPad|iPhone|iPod/.test(navigator.userAgent)&&!window.MSStream);const Va=["auto","top","bottom","left","right"].reduce((e,t)=>e.concat([t,`${t}-start`,`${t}-end`]),[]),ko={hover:"mouseenter",focus:"focus",click:"click",touch:"touchstart"},To={hover:"mouseleave",focus:"blur",click:"click",touch:"touchend"};function $o(e,t){const s=e.indexOf(t);s!==-1&&e.splice(s,1)}function Li(){return new Promise(e=>requestAnimationFrame(()=>{requestAnimationFrame(e)}))}const Ie=[];let Ct=null;const Co={};function So(e){let t=Co[e];return t||(t=Co[e]=[]),t}let Ji=function(){};typeof window<"u"&&(Ji=window.Element);function V(e){return function(t){return Qt(t.theme,e)}}const Ai="__floating-vue__popper";var Ga=()=>ee({name:"VPopper",provide(){return{[Ai]:{parentPopper:this}}},inject:{[Ai]:{default:null}},props:{theme:{type:String,required:!0},targetNodes:{type:Function,required:!0},referenceNode:{type:Function,default:null},popperNode:{type:Function,required:!0},shown:{type:Boolean,default:!1},showGroup:{type:String,default:null},ariaId:{default:null},disabled:{type:Boolean,default:V("disabled")},positioningDisabled:{type:Boolean,default:V("positioningDisabled")},placement:{type:String,default:V("placement"),validator:e=>Va.includes(e)},delay:{type:[String,Number,Object],default:V("delay")},distance:{type:[Number,String],default:V("distance")},skidding:{type:[Number,String],default:V("skidding")},triggers:{type:Array,default:V("triggers")},showTriggers:{type:[Array,Function],default:V("showTriggers")},hideTriggers:{type:[Array,Function],default:V("hideTriggers")},popperTriggers:{type:Array,default:V("popperTriggers")},popperShowTriggers:{type:[Array,Function],default:V("popperShowTriggers")},popperHideTriggers:{type:[Array,Function],default:V("popperHideTriggers")},container:{type:[String,Object,Ji,Boolean],default:V("container")},boundary:{type:[String,Ji],default:V("boundary")},strategy:{type:String,validator:e=>["absolute","fixed"].includes(e),default:V("strategy")},autoHide:{type:[Boolean,Function],default:V("autoHide")},handleResize:{type:Boolean,default:V("handleResize")},instantMove:{type:Boolean,default:V("instantMove")},eagerMount:{type:Boolean,default:V("eagerMount")},popperClass:{type:[String,Array,Object],default:V("popperClass")},computeTransformOrigin:{type:Boolean,default:V("computeTransformOrigin")},autoMinSize:{type:Boolean,default:V("autoMinSize")},autoSize:{type:[Boolean,String],default:V("autoSize")},autoMaxSize:{type:Boolean,default:V("autoMaxSize")},autoBoundaryMaxSize:{type:Boolean,default:V("autoBoundaryMaxSize")},preventOverflow:{type:Boolean,default:V("preventOverflow")},overflowPadding:{type:[Number,String],default:V("overflowPadding")},arrowPadding:{type:[Number,String],default:V("arrowPadding")},arrowOverflow:{type:Boolean,default:V("arrowOverflow")},flip:{type:Boolean,default:V("flip")},shift:{type:Boolean,default:V("shift")},shiftCrossAxis:{type:Boolean,default:V("shiftCrossAxis")},noAutoFocus:{type:Boolean,default:V("noAutoFocus")}},emits:["show","hide","update:shown","apply-show","apply-hide","close-group","close-directive","auto-hide","resize","dispose"],data(){return{isShown:!1,isMounted:!1,skipTransition:!1,classes:{showFrom:!1,showTo:!1,hideFrom:!1,hideTo:!0},result:{x:0,y:0,placement:"",strategy:this.strategy,arrow:{x:0,y:0,centerOffset:0},transformOrigin:null},shownChildren:new Set,lastAutoHide:!0}},computed:{popperId(){return this.ariaId!=null?this.ariaId:this.randomId},shouldMountContent(){return this.eagerMount||this.isMounted},slotData(){return{popperId:this.popperId,isShown:this.isShown,shouldMountContent:this.shouldMountContent,skipTransition:this.skipTransition,autoHide:typeof this.autoHide=="function"?this.lastAutoHide:this.autoHide,show:this.show,hide:this.hide,handleResize:this.handleResize,onResize:this.onResize,classes:Cs(Ze({},this.classes),{popperClass:this.popperClass}),result:this.positioningDisabled?null:this.result,attrs:this.$attrs}},parentPopper(){var e;return(e=this[Ai])==null?void 0:e.parentPopper},hasPopperShowTriggerHover(){var e,t;return((e=this.popperTriggers)==null?void 0:e.includes("hover"))||((t=this.popperShowTriggers)==null?void 0:t.includes("hover"))}},watch:Ze(Ze({shown:"$_autoShowHide",disabled(e){e?this.dispose():this.init()},async container(){this.isShown&&(this.$_ensureTeleport(),await this.$_computePosition())}},["triggers","positioningDisabled"].reduce((e,t)=>(e[t]="$_refreshListeners",e),{})),["placement","distance","skidding","boundary","strategy","overflowPadding","arrowPadding","preventOverflow","shift","shiftCrossAxis","flip"].reduce((e,t)=>(e[t]="$_computePosition",e),{})),created(){this.$_isDisposed=!0,this.randomId=`popper_${[Math.random(),Date.now()].map(e=>e.toString(36).substring(2,10)).join("_")}`,this.autoMinSize&&console.warn('[floating-vue] `autoMinSize` option is deprecated. Use `autoSize="min"` instead.'),this.autoMaxSize&&console.warn("[floating-vue] `autoMaxSize` option is deprecated. Use `autoBoundaryMaxSize` instead.")},mounted(){this.init(),this.$_detachPopperNode()},activated(){this.$_autoShowHide()},deactivated(){this.hide()},beforeUnmount(){this.dispose()},methods:{show({event:e=null,skipDelay:t=!1,force:s=!1}={}){var i,n;((i=this.parentPopper)==null?void 0:i.lockedChild)&&this.parentPopper.lockedChild!==this||(this.$_pendingHide=!1,(s||!this.disabled)&&(((n=this.parentPopper)==null?void 0:n.lockedChild)===this&&(this.parentPopper.lockedChild=null),this.$_scheduleShow(e,t),this.$emit("show"),this.$_showFrameLocked=!0,requestAnimationFrame(()=>{this.$_showFrameLocked=!1})),this.$emit("update:shown",!0))},hide({event:e=null,skipDelay:t=!1}={}){var s;if(!this.$_hideInProgress){if(this.shownChildren.size>0){this.$_pendingHide=!0;return}if(this.hasPopperShowTriggerHover&&this.$_isAimingPopper()){this.parentPopper&&(this.parentPopper.lockedChild=this,clearTimeout(this.parentPopper.lockedChildTimer),this.parentPopper.lockedChildTimer=setTimeout(()=>{this.parentPopper.lockedChild===this&&(this.parentPopper.lockedChild.hide({skipDelay:t}),this.parentPopper.lockedChild=null)},1e3));return}((s=this.parentPopper)==null?void 0:s.lockedChild)===this&&(this.parentPopper.lockedChild=null),this.$_pendingHide=!1,this.$_scheduleHide(e,t),this.$emit("hide"),this.$emit("update:shown",!1)}},init(){var e,t;!this.$_isDisposed||(this.$_isDisposed=!1,this.isMounted=!1,this.$_events=[],this.$_preventShow=!1,this.$_referenceNode=(t=(e=this.referenceNode)==null?void 0:e.call(this))!=null?t:this.$el,this.$_targetNodes=this.targetNodes().filter(s=>s.nodeType===s.ELEMENT_NODE),this.$_popperNode=this.popperNode(),this.$_innerNode=this.$_popperNode.querySelector(".v-popper__inner"),this.$_arrowNode=this.$_popperNode.querySelector(".v-popper__arrow-container"),this.$_swapTargetAttrs("title","data-original-title"),this.$_detachPopperNode(),this.triggers.length&&this.$_addEventListeners(),this.shown&&this.show())},dispose(){this.$_isDisposed||(this.$_isDisposed=!0,this.$_removeEventListeners(),this.hide({skipDelay:!0}),this.$_detachPopperNode(),this.isMounted=!1,this.isShown=!1,this.$_updateParentShownChildren(!1),this.$_swapTargetAttrs("data-original-title","title"),this.$emit("dispose"))},async onResize(){this.isShown&&(await this.$_computePosition(),this.$emit("resize"))},async $_computePosition(){var e;if(this.$_isDisposed||this.positioningDisabled)return;const t={strategy:this.strategy,middleware:[]};(this.distance||this.skidding)&&t.middleware.push(nd({mainAxis:this.distance,crossAxis:this.skidding}));const s=this.placement.startsWith("auto");if(s?t.middleware.push(ed({alignment:(e=this.placement.split("-")[1])!=null?e:""})):t.placement=this.placement,this.preventOverflow&&(this.shift&&t.middleware.push(ad({padding:this.overflowPadding,boundary:this.boundary,crossAxis:this.shiftCrossAxis})),!s&&this.flip&&t.middleware.push(sd({padding:this.overflowPadding,boundary:this.boundary}))),t.middleware.push(Vc({element:this.$_arrowNode,padding:this.arrowPadding})),this.arrowOverflow&&t.middleware.push({name:"arrowOverflow",fn:({placement:n,rects:o,middlewareData:a})=>{let r;const{centerOffset:l}=a.arrow;return n.startsWith("top")||n.startsWith("bottom")?r=Math.abs(l)>o.reference.width/2:r=Math.abs(l)>o.reference.height/2,{data:{overflow:r}}}}),this.autoMinSize||this.autoSize){const n=this.autoSize?this.autoSize:this.autoMinSize?"min":null;t.middleware.push({name:"autoSize",fn:({rects:o,placement:a,middlewareData:r})=>{var l;if((l=r.autoSize)!=null&&l.skip)return{};let d,h;return a.startsWith("top")||a.startsWith("bottom")?d=o.reference.width:h=o.reference.height,this.$_innerNode.style[n==="min"?"minWidth":n==="max"?"maxWidth":"width"]=d!=null?`${d}px`:null,this.$_innerNode.style[n==="min"?"minHeight":n==="max"?"maxHeight":"height"]=h!=null?`${h}px`:null,{data:{skip:!0},reset:{rects:!0}}}})}(this.autoMaxSize||this.autoBoundaryMaxSize)&&(this.$_innerNode.style.maxWidth=null,this.$_innerNode.style.maxHeight=null,t.middleware.push(rd({boundary:this.boundary,padding:this.overflowPadding,apply:({width:n,height:o})=>{this.$_innerNode.style.maxWidth=n!=null?`${n}px`:null,this.$_innerNode.style.maxHeight=o!=null?`${o}px`:null}})));const i=await xd(this.$_referenceNode,this.$_popperNode,t);Object.assign(this.result,{x:i.x,y:i.y,placement:i.placement,strategy:i.strategy,arrow:Ze(Ze({},i.middlewareData.arrow),i.middlewareData.arrowOverflow)})},$_scheduleShow(e=null,t=!1){if(this.$_updateParentShownChildren(!0),this.$_hideInProgress=!1,clearTimeout(this.$_scheduleTimer),Ct&&this.instantMove&&Ct.instantMove&&Ct!==this.parentPopper){Ct.$_applyHide(!0),this.$_applyShow(!0);return}t?this.$_applyShow():this.$_scheduleTimer=setTimeout(this.$_applyShow.bind(this),this.$_computeDelay("show"))},$_scheduleHide(e=null,t=!1){if(this.shownChildren.size>0){this.$_pendingHide=!0;return}this.$_updateParentShownChildren(!1),this.$_hideInProgress=!0,clearTimeout(this.$_scheduleTimer),this.isShown&&(Ct=this),t?this.$_applyHide():this.$_scheduleTimer=setTimeout(this.$_applyHide.bind(this),this.$_computeDelay("hide"))},$_computeDelay(e){const t=this.delay;return parseInt(t&&t[e]||t||0)},async $_applyShow(e=!1){clearTimeout(this.$_disposeTimer),clearTimeout(this.$_scheduleTimer),this.skipTransition=e,!this.isShown&&(this.$_ensureTeleport(),await Li(),await this.$_computePosition(),await this.$_applyShowEffect(),this.positioningDisabled||this.$_registerEventListeners([...Qs(this.$_referenceNode),...Qs(this.$_popperNode)],"scroll",()=>{this.$_computePosition()}))},async $_applyShowEffect(){if(this.$_hideInProgress)return;if(this.computeTransformOrigin){const t=this.$_referenceNode.getBoundingClientRect(),s=this.$_popperNode.querySelector(".v-popper__wrapper"),i=s.parentNode.getBoundingClientRect(),n=t.x+t.width/2-(i.left+s.offsetLeft),o=t.y+t.height/2-(i.top+s.offsetTop);this.result.transformOrigin=`${n}px ${o}px`}this.isShown=!0,this.$_applyAttrsToTarget({"aria-describedby":this.popperId,"data-popper-shown":""});const e=this.showGroup;if(e){let t;for(let s=0;s<Ie.length;s++)t=Ie[s],t.showGroup!==e&&(t.hide(),t.$emit("close-group"))}Ie.push(this),document.body.classList.add("v-popper--some-open");for(const t of _o(this.theme))So(t).push(this),document.body.classList.add(`v-popper--some-open--${t}`);this.$emit("apply-show"),this.classes.showFrom=!0,this.classes.showTo=!1,this.classes.hideFrom=!1,this.classes.hideTo=!1,await Li(),this.classes.showFrom=!1,this.classes.showTo=!0,this.noAutoFocus||this.$_popperNode.focus()},async $_applyHide(e=!1){if(this.shownChildren.size>0){this.$_pendingHide=!0,this.$_hideInProgress=!1;return}if(clearTimeout(this.$_scheduleTimer),!this.isShown)return;this.skipTransition=e,$o(Ie,this),Ie.length===0&&document.body.classList.remove("v-popper--some-open");for(const s of _o(this.theme)){const i=So(s);$o(i,this),i.length===0&&document.body.classList.remove(`v-popper--some-open--${s}`)}Ct===this&&(Ct=null),this.isShown=!1,this.$_applyAttrsToTarget({"aria-describedby":void 0,"data-popper-shown":void 0}),clearTimeout(this.$_disposeTimer);const t=Qt(this.theme,"disposeTimeout");t!==null&&(this.$_disposeTimer=setTimeout(()=>{this.$_popperNode&&(this.$_detachPopperNode(),this.isMounted=!1)},t)),this.$_removeEventListeners("scroll"),this.$emit("apply-hide"),this.classes.showFrom=!1,this.classes.showTo=!1,this.classes.hideFrom=!0,this.classes.hideTo=!1,await Li(),this.classes.hideFrom=!1,this.classes.hideTo=!0},$_autoShowHide(){this.shown?this.show():this.hide()},$_ensureTeleport(){if(this.$_isDisposed)return;let e=this.container;if(typeof e=="string"?e=window.document.querySelector(e):e===!1&&(e=this.$_targetNodes[0].parentNode),!e)throw new Error("No container for popover: "+this.container);e.appendChild(this.$_popperNode),this.isMounted=!0},$_addEventListeners(){const e=s=>{this.isShown&&!this.$_hideInProgress||(s.usedByTooltip=!0,!this.$_preventShow&&this.show({event:s}))};this.$_registerTriggerListeners(this.$_targetNodes,ko,this.triggers,this.showTriggers,e),this.$_registerTriggerListeners([this.$_popperNode],ko,this.popperTriggers,this.popperShowTriggers,e);const t=s=>{s.usedByTooltip||this.hide({event:s})};this.$_registerTriggerListeners(this.$_targetNodes,To,this.triggers,this.hideTriggers,t),this.$_registerTriggerListeners([this.$_popperNode],To,this.popperTriggers,this.popperHideTriggers,t)},$_registerEventListeners(e,t,s){this.$_events.push({targetNodes:e,eventType:t,handler:s}),e.forEach(i=>i.addEventListener(t,s,Mt?{passive:!0}:void 0))},$_registerTriggerListeners(e,t,s,i,n){let o=s;i!=null&&(o=typeof i=="function"?i(o):i),o.forEach(a=>{const r=t[a];r&&this.$_registerEventListeners(e,r,n)})},$_removeEventListeners(e){const t=[];this.$_events.forEach(s=>{const{targetNodes:i,eventType:n,handler:o}=s;!e||e===n?i.forEach(a=>a.removeEventListener(n,o)):t.push(s)}),this.$_events=t},$_refreshListeners(){this.$_isDisposed||(this.$_removeEventListeners(),this.$_addEventListeners())},$_handleGlobalClose(e,t=!1){this.$_showFrameLocked||(this.hide({event:e}),e.closePopover?this.$emit("close-directive"):this.$emit("auto-hide"),t&&(this.$_preventShow=!0,setTimeout(()=>{this.$_preventShow=!1},300)))},$_detachPopperNode(){this.$_popperNode.parentNode&&this.$_popperNode.parentNode.removeChild(this.$_popperNode)},$_swapTargetAttrs(e,t){for(const s of this.$_targetNodes){const i=s.getAttribute(e);i&&(s.removeAttribute(e),s.setAttribute(t,i))}},$_applyAttrsToTarget(e){for(const t of this.$_targetNodes)for(const s in e){const i=e[s];i==null?t.removeAttribute(s):t.setAttribute(s,i)}},$_updateParentShownChildren(e){let t=this.parentPopper;for(;t;)e?t.shownChildren.add(this.randomId):(t.shownChildren.delete(this.randomId),t.$_pendingHide&&t.hide()),t=t.parentPopper},$_isAimingPopper(){const e=this.$_referenceNode.getBoundingClientRect();if(hs>=e.left&&hs<=e.right&&us>=e.top&&us<=e.bottom){const t=this.$_popperNode.getBoundingClientRect(),s=hs-ht,i=us-ut,o=t.left+t.width/2-ht+(t.top+t.height/2)-ut+t.width+t.height,a=ht+s*o,r=ut+i*o;return Hs(ht,ut,a,r,t.left,t.top,t.left,t.bottom)||Hs(ht,ut,a,r,t.left,t.top,t.right,t.top)||Hs(ht,ut,a,r,t.right,t.top,t.right,t.bottom)||Hs(ht,ut,a,r,t.left,t.bottom,t.right,t.bottom)}return!1}},render(){return this.$slots.default(this.slotData)}});typeof document<"u"&&typeof window<"u"&&(Ka?(document.addEventListener("touchstart",Po,Mt?{passive:!0,capture:!0}:!0),document.addEventListener("touchend",Ld,Mt?{passive:!0,capture:!0}:!0)):(window.addEventListener("mousedown",Po,!0),window.addEventListener("click",Pd,!0)),window.addEventListener("resize",Id));function Po(e){for(let t=0;t<Ie.length;t++){const s=Ie[t];try{const i=s.popperNode();s.$_mouseDownContains=i.contains(e.target)}catch{}}}function Pd(e){Xa(e)}function Ld(e){Xa(e,!0)}function Xa(e,t=!1){const s={};for(let i=Ie.length-1;i>=0;i--){const n=Ie[i];try{const o=n.$_containsGlobalTarget=Ad(n,e);n.$_pendingHide=!1,requestAnimationFrame(()=>{if(n.$_pendingHide=!1,!s[n.randomId]&&Lo(n,o,e)){if(n.$_handleGlobalClose(e,t),!e.closeAllPopover&&e.closePopover&&o){let r=n.parentPopper;for(;r;)s[r.randomId]=!0,r=r.parentPopper;return}let a=n.parentPopper;for(;a&&Lo(a,a.$_containsGlobalTarget,e);){a.$_handleGlobalClose(e,t);a=a.parentPopper}}})}catch{}}}function Ad(e,t){const s=e.popperNode();return e.$_mouseDownContains||s.contains(t.target)}function Lo(e,t,s){return s.closeAllPopover||s.closePopover&&t||Rd(e,s)&&!t}function Rd(e,t){if(typeof e.autoHide=="function"){const s=e.autoHide(t);return e.lastAutoHide=s,s}return e.autoHide}function Id(e){for(let t=0;t<Ie.length;t++)Ie[t].$_computePosition(e)}function Qi(){for(let e=0;e<Ie.length;e++)Ie[e].hide()}let ht=0,ut=0,hs=0,us=0;typeof window<"u"&&window.addEventListener("mousemove",e=>{ht=hs,ut=us,hs=e.clientX,us=e.clientY},Mt?{passive:!0}:void 0);function Hs(e,t,s,i,n,o,a,r){const l=((a-n)*(t-o)-(r-o)*(e-n))/((r-o)*(s-e)-(a-n)*(i-t)),d=((s-e)*(t-o)-(i-t)*(e-n))/((r-o)*(s-e)-(a-n)*(i-t));return l>=0&&l<=1&&d>=0&&d<=1}var bi=(e,t)=>{const s=e.__vccOpts||e;for(const[i,n]of t)s[i]=n;return s};const Od={extends:Ga()};function Ed(e,t,s,i,n,o){return T(),L("div",{ref:"reference",class:ye(["v-popper",{"v-popper--shown":e.slotData.isShown}])},[vt(e.$slots,"default",Fo(Tn(e.slotData)))],2)}var Md=bi(Od,[["render",Ed]]);function Hd(){var e=window.navigator.userAgent,t=e.indexOf("MSIE ");if(t>0)return parseInt(e.substring(t+5,e.indexOf(".",t)),10);var s=e.indexOf("Trident/");if(s>0){var i=e.indexOf("rv:");return parseInt(e.substring(i+3,e.indexOf(".",i)),10)}var n=e.indexOf("Edge/");return n>0?parseInt(e.substring(n+5,e.indexOf(".",n)),10):-1}let Bs;function Zi(){Zi.init||(Zi.init=!0,Bs=Hd()!==-1)}var yi={name:"ResizeObserver",props:{emitOnMount:{type:Boolean,default:!1},ignoreWidth:{type:Boolean,default:!1},ignoreHeight:{type:Boolean,default:!1}},emits:["notify"],mounted(){Zi(),at(()=>{this._w=this.$el.offsetWidth,this._h=this.$el.offsetHeight,this.emitOnMount&&this.emitSize()});const e=document.createElement("object");this._resizeObject=e,e.setAttribute("aria-hidden","true"),e.setAttribute("tabindex",-1),e.onload=this.addResizeHandlers,e.type="text/html",Bs&&this.$el.appendChild(e),e.data="about:blank",Bs||this.$el.appendChild(e)},beforeUnmount(){this.removeResizeHandlers()},methods:{compareAndNotify(){(!this.ignoreWidth&&this._w!==this.$el.offsetWidth||!this.ignoreHeight&&this._h!==this.$el.offsetHeight)&&(this._w=this.$el.offsetWidth,this._h=this.$el.offsetHeight,this.emitSize())},emitSize(){this.$emit("notify",{width:this._w,height:this._h})},addResizeHandlers(){this._resizeObject.contentDocument.defaultView.addEventListener("resize",this.compareAndNotify),this.compareAndNotify()},removeResizeHandlers(){this._resizeObject&&this._resizeObject.onload&&(!Bs&&this._resizeObject.contentDocument&&this._resizeObject.contentDocument.defaultView.removeEventListener("resize",this.compareAndNotify),this.$el.removeChild(this._resizeObject),this._resizeObject.onload=null,this._resizeObject=null)}}};const Nd=wl();He("data-v-b329ee4c");const jd={class:"resize-observer",tabindex:"-1"};Ne();const Fd=Nd((e,t,s,i,n,o)=>(T(),Ge("div",jd)));yi.render=Fd;yi.__scopeId="data-v-b329ee4c";yi.__file="src/components/ResizeObserver.vue";var Ja=(e="theme")=>({computed:{themeClass(){return Sd(this[e])}}});const zd=ee({name:"VPopperContent",components:{ResizeObserver:yi},mixins:[Ja()],props:{popperId:String,theme:String,shown:Boolean,mounted:Boolean,skipTransition:Boolean,autoHide:Boolean,handleResize:Boolean,classes:Object,result:Object},emits:["hide","resize"],methods:{toPx(e){return e!=null&&!isNaN(e)?`${e}px`:null}}}),Bd=["id","aria-hidden","tabindex","data-popper-placement"],Dd={ref:"inner",class:"v-popper__inner"},qd=m("div",{class:"v-popper__arrow-outer"},null,-1),Wd=m("div",{class:"v-popper__arrow-inner"},null,-1),Ud=[qd,Wd];function Yd(e,t,s,i,n,o){const a=ws("ResizeObserver");return T(),L("div",{id:e.popperId,ref:"popover",class:ye(["v-popper__popper",[e.themeClass,e.classes.popperClass,{"v-popper__popper--shown":e.shown,"v-popper__popper--hidden":!e.shown,"v-popper__popper--show-from":e.classes.showFrom,"v-popper__popper--show-to":e.classes.showTo,"v-popper__popper--hide-from":e.classes.hideFrom,"v-popper__popper--hide-to":e.classes.hideTo,"v-popper__popper--skip-transition":e.skipTransition,"v-popper__popper--arrow-overflow":e.result&&e.result.arrow.overflow,"v-popper__popper--no-positioning":!e.result}]]),style:tt(e.result?{position:e.result.strategy,transform:`translate3d(${Math.round(e.result.x)}px,${Math.round(e.result.y)}px,0)`}:void 0),"aria-hidden":e.shown?"false":"true",tabindex:e.autoHide?0:void 0,"data-popper-placement":e.result?e.result.placement:void 0,onKeyup:t[2]||(t[2]=Na(r=>e.autoHide&&e.$emit("hide"),["esc"]))},[m("div",{class:"v-popper__backdrop",onClick:t[0]||(t[0]=r=>e.autoHide&&e.$emit("hide"))}),m("div",{class:"v-popper__wrapper",style:tt(e.result?{transformOrigin:e.result.transformOrigin}:void 0)},[m("div",Dd,[e.mounted?(T(),L(F,{key:0},[m("div",null,[vt(e.$slots,"default")]),e.handleResize?(T(),Ge(a,{key:0,onNotify:t[1]||(t[1]=r=>e.$emit("resize",r))})):Te("",!0)],64)):Te("",!0)],512),m("div",{ref:"arrow",class:"v-popper__arrow-container",style:tt(e.result?{left:e.toPx(e.result.arrow.x),top:e.toPx(e.result.arrow.y)}:void 0)},Ud,4)],4)],46,Bd)}var Qa=bi(zd,[["render",Yd]]),Za={methods:{show(...e){return this.$refs.popper.show(...e)},hide(...e){return this.$refs.popper.hide(...e)},dispose(...e){return this.$refs.popper.dispose(...e)},onResize(...e){return this.$refs.popper.onResize(...e)}}};const Kd=ee({name:"VPopperWrapper",components:{Popper:Md,PopperContent:Qa},mixins:[Za,Ja("finalTheme")],props:{theme:{type:String,default:null}},computed:{finalTheme(){var e;return(e=this.theme)!=null?e:this.$options.vPopperTheme}},methods:{getTargetNodes(){return Array.from(this.$el.children).filter(e=>e!==this.$refs.popperContent.$el)}}});function Vd(e,t,s,i,n,o){const a=ws("PopperContent"),r=ws("Popper");return T(),Ge(r,{ref:"popper",theme:e.finalTheme,"target-nodes":e.getTargetNodes,"popper-node":()=>e.$refs.popperContent.$el,class:ye([e.themeClass])},{default:Le(({popperId:l,isShown:d,shouldMountContent:h,skipTransition:u,autoHide:f,show:k,hide:P,handleResize:A,onResize:R,classes:I,result:E})=>[vt(e.$slots,"default",{shown:d,show:k,hide:P}),W(a,{ref:"popperContent","popper-id":l,theme:e.finalTheme,shown:d,mounted:h,"skip-transition":u,"auto-hide":f,"handle-resize":A,classes:I,result:E,onHide:P,onResize:R},{default:Le(()=>[vt(e.$slots,"popper",{shown:d,hide:P})]),_:2},1032,["popper-id","theme","shown","mounted","skip-transition","auto-hide","handle-resize","classes","result","onHide","onResize"])]),_:3},8,["theme","target-nodes","popper-node","class"])}var Pn=bi(Kd,[["render",Vd]]);const Gd=ee(Cs(Ze({},Pn),{name:"VDropdown",vPopperTheme:"dropdown"})),Xd=ee(Cs(Ze({},Pn),{name:"VMenu",vPopperTheme:"menu"})),Jd=ee(Cs(Ze({},Pn),{name:"VTooltip",vPopperTheme:"tooltip"})),Qd=ee({name:"VTooltipDirective",components:{Popper:Ga(),PopperContent:Qa},mixins:[Za],inheritAttrs:!1,props:{theme:{type:String,default:"tooltip"},html:{type:Boolean,default:e=>Qt(e.theme,"html")},content:{type:[String,Number,Function],default:null},loadingContent:{type:String,default:e=>Qt(e.theme,"loadingContent")}},data(){return{asyncContent:null}},computed:{isContentAsync(){return typeof this.content=="function"},loading(){return this.isContentAsync&&this.asyncContent==null},finalContent(){return this.isContentAsync?this.loading?this.loadingContent:this.asyncContent:this.content}},watch:{content:{handler(){this.fetchContent(!0)},immediate:!0},async finalContent(){await this.$nextTick(),this.$refs.popper.onResize()}},created(){this.$_fetchId=0},methods:{fetchContent(e){if(typeof this.content=="function"&&this.$_isShown&&(e||!this.$_loading&&this.asyncContent==null)){this.asyncContent=null,this.$_loading=!0;const t=++this.$_fetchId,s=this.content(this);s.then?s.then(i=>this.onResult(t,i)):this.onResult(t,s)}},onResult(e,t){e===this.$_fetchId&&(this.$_loading=!1,this.asyncContent=t)},onShow(){this.$_isShown=!0,this.fetchContent()},onHide(){this.$_isShown=!1}}}),Zd=["innerHTML"],ep=["textContent"];function tp(e,t,s,i,n,o){const a=ws("PopperContent"),r=ws("Popper");return T(),Ge(r,Oa({ref:"popper"},e.$attrs,{theme:e.theme,"popper-node":()=>e.$refs.popperContent.$el,onApplyShow:e.onShow,onApplyHide:e.onHide}),{default:Le(({popperId:l,isShown:d,shouldMountContent:h,skipTransition:u,autoHide:f,hide:k,handleResize:P,onResize:A,classes:R,result:I})=>[W(a,{ref:"popperContent",class:ye({"v-popper--tooltip-loading":e.loading}),"popper-id":l,theme:e.theme,shown:d,mounted:h,"skip-transition":u,"auto-hide":f,"handle-resize":P,classes:R,result:I,onHide:k,onResize:A},{default:Le(()=>[e.html?(T(),L("div",{key:0,innerHTML:e.finalContent},null,8,Zd)):(T(),L("div",{key:1,textContent:U(e.finalContent)},null,8,ep))]),_:2},1032,["class","popper-id","theme","shown","mounted","skip-transition","auto-hide","handle-resize","classes","result","onHide","onResize"])]),_:1},16,["theme","popper-node","onApplyShow","onApplyHide"])}var sp=bi(Qd,[["render",tp]]);const er="v-popper--has-tooltip";function ip(e,t){let s=e.placement;if(!s&&t)for(const i of Va)t[i]&&(s=i);return s||(s=Qt(e.theme||"tooltip","placement")),s}function tr(e,t,s){let i;const n=typeof t;return n==="string"?i={content:t}:t&&n==="object"?i=t:i={content:!1},i.placement=ip(i,s),i.targetNodes=()=>[e],i.referenceNode=()=>e,i}let Ri,ks,np=0;function op(){if(Ri)return;ks=Oe([]),Ri=ja({name:"VTooltipDirectiveApp",setup(){return{directives:ks}},render(){return this.directives.map(t=>gc(sp,Cs(Ze({},t.options),{shown:t.shown||t.options.shown,key:t.id})))},devtools:{hide:!0}});const e=document.createElement("div");document.body.appendChild(e),Ri.mount(e)}function sr(e,t,s){op();const i=Oe(tr(e,t,s)),n=Oe(!1),o={id:np++,options:i,shown:n};return ks.value.push(o),e.classList&&e.classList.add(er),e.$_popper={options:i,item:o,show(){n.value=!0},hide(){n.value=!1}}}function ir(e){if(e.$_popper){const t=ks.value.indexOf(e.$_popper.item);t!==-1&&ks.value.splice(t,1),delete e.$_popper,delete e.$_popperOldShown,delete e.$_popperMountTarget}e.classList&&e.classList.remove(er)}function Ao(e,{value:t,modifiers:s}){const i=tr(e,t,s);if(!i.content||Qt(i.theme||"tooltip","disabled"))ir(e);else{let n;e.$_popper?(n=e.$_popper,n.options.value=i):n=sr(e,t,s),typeof t.shown<"u"&&t.shown!==e.$_popperOldShown&&(e.$_popperOldShown=t.shown,t.shown?n.show():n.hide())}}var ap={beforeMount:Ao,updated:Ao,beforeUnmount(e){ir(e)}};function Ro(e){e.addEventListener("click",nr),e.addEventListener("touchstart",or,Mt?{passive:!0}:!1)}function Io(e){e.removeEventListener("click",nr),e.removeEventListener("touchstart",or),e.removeEventListener("touchend",ar),e.removeEventListener("touchcancel",rr)}function nr(e){const t=e.currentTarget;e.closePopover=!t.$_vclosepopover_touch,e.closeAllPopover=t.$_closePopoverModifiers&&!!t.$_closePopoverModifiers.all}function or(e){if(e.changedTouches.length===1){const t=e.currentTarget;t.$_vclosepopover_touch=!0;const s=e.changedTouches[0];t.$_vclosepopover_touchPoint=s,t.addEventListener("touchend",ar),t.addEventListener("touchcancel",rr)}}function ar(e){const t=e.currentTarget;if(t.$_vclosepopover_touch=!1,e.changedTouches.length===1){const s=e.changedTouches[0],i=t.$_vclosepopover_touchPoint;e.closePopover=Math.abs(s.screenY-i.screenY)<20&&Math.abs(s.screenX-i.screenX)<20,e.closeAllPopover=t.$_closePopoverModifiers&&!!t.$_closePopoverModifiers.all}}function rr(e){const t=e.currentTarget;t.$_vclosepopover_touch=!1}var rp={beforeMount(e,{value:t,modifiers:s}){e.$_closePopoverModifiers=s,(typeof t>"u"||t)&&Ro(e)},updated(e,{value:t,oldValue:s,modifiers:i}){e.$_closePopoverModifiers=i,t!==s&&(typeof t>"u"||t?Ro(e):Io(e))},beforeUnmount(e){Io(e)}};function lp(e,t={}){e.$_vTooltipInstalled||(e.$_vTooltipInstalled=!0,Ya(st,t),e.directive("tooltip",ap),e.directive("close-popper",rp),e.component("VTooltip",Jd),e.component("VDropdown",Gd),e.component("VMenu",Xd))}const cp={version:"2.0.0-beta.20",install:lp,options:st};function Ss(){Array.from(document.querySelectorAll(".table *")).forEach(t=>{sr(t,{triggers:["hover"],content:dp(t),delay:0},null),t.addEventListener("mouseover",s=>{s.stopPropagation(),Qi()}),t.addEventListener("mouseenter",s=>{s.stopPropagation(),Qi()})})}function dp(e){const t=e.tagName.toLowerCase(),s=e.getAttribute("class"),i=e.getAttribute("id");return`<${t}${i?` id="${i}"`:""}${s?` class="${s}"`:""}>`}const pp=[{name:"Type Selector",doThis:"Select the plates",selector:"plate",syntax:"tagname",helpTitle:"Select elements by their type",help:"Selects all elements of a type. Type refers to the type of tag, so <tag>div</tag>, <tag>p</tag> and <tag>ul</tag> are all different element types.",examples:["<strong>div</strong> selects all <tag>div</tag> elements.","<strong>p</strong> selects all <tag>p</tag> elements."],markup:`
    <plate></plate>
    ...
    <plate></plate>
    <plate></plate>
    `}],lr={name:"CSS Selectors",levels:pp,wrapperClass:"selectors-chapter",credits:'Credits: <a href="http://www.twitter.com/flukeout">@flukeout</a> for his work on <a href="https://flukeout.github.io/" target="_blank">CSS diner</a> that served as the foundation for this website',intro:`
    <p>To apply CSS to an element you need to select this element with a <b>selector</b>.</p>
    <p>CSS provides you with a number of different ways to do this, and you can explore them in this chapter.</p>`,onLevelStart(){at(()=>Ss())}},Zs=(e,t,s)=>Math.min(Math.max(e,t),s);function fs(){Array.from(document.querySelectorAll(".shake, .strobe, .clean")).forEach(e=>e.classList.remove("shake","strobe","clean"))}const Ts=e=>{!e||(e.classList.add("shake"),setTimeout(()=>{e.classList.remove("shake")},500))},en="html_css_training_progress";function Ln(e,t){return Array.isArray(C.progress.completed[e])&&C.progress.completed[e].includes(t)}function hp(){const e=C.progress.currentChapter,t=C.progress.currentLevel;Ln(e,t)||(C.progress.completed.hasOwnProperty(e)||(C.progress.completed[e]=[]),C.progress.completed[e].push(t),vi())}function up(e){return Array.isArray(C.progress.completed[e])?Zs(C.progress.completed[e].length/et[e-1].levels.length*100,0,100):0}function fp(){var e;try{Object.assign(C.progress,JSON.parse((e=localStorage.getItem(en))!=null?e:"{}"))}catch{localStorage.removeItem(en),tn()}}function vi(){localStorage.setItem(en,JSON.stringify(C.progress))}function gp(e){C.progress.currentChapter in C.progress.inputs||(C.progress.inputs[C.progress.currentChapter]={}),C.progress.inputs[C.progress.currentChapter][C.progress.currentLevel]=e,vi()}function tn(){C.progress={currentChapter:1,currentLevel:0,completed:{},inputs:{}},vi()}function cr(){C.menuOpened=!1}function Zt(){hp(),Ht(C.progress.currentChapter,C.progress.currentLevel+1)}function Ht(e,t){const s=et[e-1];t>s.levels.length&&e<et.length?(e++,t=0):t<0&&e>1&&(e=Math.max(1,e-1),t=et[e-1].levels.length);const i=Zs(e,1,et.length),n=Zs(t,0,et[e-1].levels.length);(n!==C.progress.currentLevel||i!==C.progress.currentChapter)&&(C.progress.currentChapter=i,C.progress.currentLevel=n,Qi(),dr(),cr())}function dr(){const e=Me.value,t=e.levels;C.progress.currentLevel=Zs(C.progress.currentLevel,0,t.length),C.level=t[C.progress.currentLevel-1],vi(),e.onLevelStart&&e.onLevelStart(C.level)}function mp(e){const t=C.level,s=document.querySelector(".game-wrapper");fs();const i=document.querySelectorAll(".table-content plate");e.length===t.solution.length&&t.solution.every((o,a)=>e[a]===o)?(s.classList.add("win"),i.forEach(o=>{o.classList.add("clean")}),setTimeout(function(){s.classList.remove("win"),Zt()},1e3)):e.forEach((o,a)=>{if(t.solution[a]!==o){const r=i[a];Ts(r)}})}const bp=[{name:"ID vs tag",markup:`
            <bento><plate></plate></bento>
    ...
    <p>To help you, here is a <a target="_blank" href="img/specifishity.png">cheat sheet on specificity explained with fish</a>.</p>`,levels:bp,onLevelStart(){at(()=>Ss())}},vp=[{name:"Inline display",doThis:"Set the display mode of apples to inline",selector:"apple",cssRulesHidden:{".table-content":["width: 800px","min-height: 360px"]},cssRules:{apple:["display: block"]},wrapperClass:"inline-layout",syntax:"display: inline",help:`<p>The <code>display</code> property does two things. The first thing it does is determine if the box it is applied to acts as <b>inline</b> or <b>block</b>. The second is to determine how the element's children should behave.</p>
...
`,markup:`
    ...
    <bento style="height: 200px;"><plate></plate></bento>
    `,check:[["vertical-align","middle"]]}],wp={name:"Inline & Block Layout",description:"Basic display modes of HTML content",levels:vp,wrapperClass:"inline-block-chapter",intro:"<p>Let's learn the different ways to position elements in CSS !</p>",onLevelStart(){at(()=>{Ss()})}},xp=[{name:"Flex display",doThis:"Put the sushis on the plates",selector:"bento",wrapperClass:"flex-game",cssRules:{},syntax:"display: flex;",help:`<p>Flex layout lets you control the sizing and positioning of its direct child elements, that we will refer to as <b>items</b>. By default, flex layout has this behavior:
    <ul>
...
align-content: <value>`,help:"<p>Combine all what you learned to place the items correctly !</p>",markup:`
    ...
    <plate class="egg"></plate>
    <plate class="egg"></plate>
    </div>`,inputLinesNumber:4,check:[["flex-wrap","wrap"],["flex-direction","column"],["justify-content","center"],["align-content","space-evenly"]]}],_p={name:"Flex Layout",description:"One-directional content flow",levels:xp,credits:'Credits: <a href="https://github.com/thomaspark">Thomas Park</a> for its inspiring <a target="_blank" href="https://flexboxfroggy.com/">Flexbox Froggy</a> game.',intro:`<p>Let's learn the different ways to position elements in CSS !</p>
...
grid-auto-columns: <dims>...`,examples:["<code>grid-auto-rows: minmax(100px, auto);</code> will automatically create rows at a minimum size of 100px.","<code>grid-auto-columns: 100px 200px</code> will automatically create columns alternating between 100px and 200px."],help:`<p>When you are not explicitely declaring a grid with <code>grid-template</code> properties, or when the explicit grid is full, the items are placed in new tracks, automatically created. These tracks are referred to as the <strong>implicit grid</strong>.</p>
  ...
  minmax(100px, 1fr)
    ...
    `,hintMarkup:`<div class="hint-wrapper" style='grid-template-columns: repeat(auto-fill, minmax(200px, 1fr))'>      
      ...
      <div title="veggies (>=200px)"></div>
      <div title="fruits (>=200px)"></div>
    </div>`,check:[["grid-template-columns","repeat(auto-fit, minmax(200px, 1fr))"]]}],Tp={name:"Grid Layout",description:"Powerful 2D layouts",levels:kp,credits:'Credits: inspired from <a href="https://cssgridgarden.com/" target="_blank">CSS Grid Garden</a> by <a href="https://codepip.com" target="_blank">Codepip</a>',intro:`<p>Let's learn the different ways to position elements in CSS !</p>
  <p>While flexbox is a great layout tool for <b>one-directional</b> flow, we still need a solution for complex 2D placement.</p>
  <p>CSS Grid is this solution. It consists of around 24 new CSS properties that provides a powerful way to create two-dimensional layouts. Let's dig in !</p>`,onLevelStart(){at(()=>{Ss()})}},me=`
...
`,$p=[{name:"Font Families",selector:"h1",cssImports:["https://fonts.googleapis.com/css?family=Reggae+One"],cssRules:{},syntax:'font-family: "MyFontName"',help:`<p>Use the <code>font-family</code> property to change the typeface of the text in an element.</p>
...
filter: sepia(<val>)`,help:`
  ...
  <img src="img/sushis/4.png" width="300" />`},et=[Wc,lr,yp,wp,_p,Tp,Cp,Pp],C=oi({progress:{completed:{},inputs:{},currentChapter:1,currentLevel:0},level:Fa[0],menuOpened:!1});window.state=C;const Me=ce(()=>et[C.progress.currentChapter-1]);var Oo;const Ps=typeof window<"u",Lp=e=>typeof e=="string",Ii=()=>{};Ps&&((Oo=window==null?void 0:window.navigator)==null?void 0:Oo.userAgent)&&/iP(ad|hone|od)/.test(window.navigator.userAgent);function Ap(e){return typeof e=="function"?e():_(e)}function Rp(e){return e}function Ip(e){return Mr()?(Hr(e),!0):!1}function Op(e){var t;const s=Ap(e);return(t=s==null?void 0:s.$el)!=null?t:s}const pr=Ps?window:void 0;Ps&&window.document;Ps&&window.navigator;Ps&&window.location;function hr(...e){let t,s,i,n;if(Lp(e[0])?([s,i,n]=e,t=pr):[t,s,i,n]=e,!t)return Ii;let o=Ii;const a=bt(()=>Op(t),l=>{o(),l&&(l.addEventListener(s,i,n),o=()=>{l.removeEventListener(s,i,n),o=Ii})},{immediate:!0,flush:"post"}),r=()=>{a(),o()};return Ip(r),r}const Ep=e=>typeof e=="function"?e:typeof e=="string"?t=>t.key===e:Array.isArray(e)?t=>e.includes(t.key):e?()=>!0:()=>!1;function Oi(e,t,s={}){const{target:i=pr,eventName:n="keydown",passive:o=!1}=s,a=Ep(e);return hr(i,n,l=>{a(l)&&t(l)},o)}const sn=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},nn="__vueuse_ssr_handlers__";sn[nn]=sn[nn]||{};sn[nn];var Eo;(function(e){e.UP="UP",e.RIGHT="RIGHT",e.DOWN="DOWN",e.LEFT="LEFT",e.NONE="NONE"})(Eo||(Eo={}));var Mp=Object.defineProperty,Mo=Object.getOwnPropertySymbols,Hp=Object.prototype.hasOwnProperty,Np=Object.prototype.propertyIsEnumerable,Ho=(e,t,s)=>t in e?Mp(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s,jp=(e,t)=>{for(var s in t||(t={}))Hp.call(t,s)&&Ho(e,s,t[s]);if(Mo)for(var s of Mo(t))Np.call(t,s)&&Ho(e,s,t[s]);return e};const Fp={easeInSine:[.12,0,.39,0],easeOutSine:[.61,1,.88,1],easeInOutSine:[.37,0,.63,1],easeInQuad:[.11,0,.5,0],easeOutQuad:[.5,1,.89,1],easeInOutQuad:[.45,0,.55,1],easeInCubic:[.32,0,.67,0],easeOutCubic:[.33,1,.68,1],easeInOutCubic:[.65,0,.35,1],easeInQuart:[.5,0,.75,0],easeOutQuart:[.25,1,.5,1],easeInOutQuart:[.76,0,.24,1],easeInQuint:[.64,0,.78,0],easeOutQuint:[.22,1,.36,1],easeInOutQuint:[.83,0,.17,1],easeInExpo:[.7,0,.84,0],easeOutExpo:[.16,1,.3,1],easeInOutExpo:[.87,0,.13,1],easeInCirc:[.55,0,1,.45],easeOutCirc:[0,.55,.45,1],easeInOutCirc:[.85,0,.15,1],easeInBack:[.36,0,.66,-.56],easeOutBack:[.34,1.56,.64,1],easeInOutBack:[.68,-.6,.32,1.6]};jp({linear:Rp},Fp);const zp={key:0,class:"credits"},Bp=["innerHTML"],Dp=ee({__name:"About",setup(e){const t=ce(()=>Me.value.credits);return(s,i)=>_(t)?(T(),L("div",zp,[m("p",{innerHTML:_(t)},null,8,Bp)])):Te("",!0)}});const he=(e,t)=>{const s=e.__vccOpts||e;for(const[i,n]of t)s[i]=n;return s},qp=he(Dp,[["__scopeId","data-v-9c9636d8"]]);const Wp={},Up=e=>(He("data-v-7ec5a0cc"),e=e(),Ne(),e),Yp=Z(" HTML/CSS Training "),Kp=Up(()=>m("span",{class:"share-menu"},[Z(" Repository "),m("a",{class:"share-github",target:"_blank",href:"https://github.com/worldline/html-css-training"})],-1)),Vp=[Yp,Kp];function Gp(e,t){return T(),L("header",null,Vp)}const Xp=he(Wp,[["render",Gp],["__scopeId","data-v-7ec5a0cc"]]),Jp=e=>(He("data-v-5e4fbae2"),e=e(),Ne(),e),Qp={class:"chapter-intro"},Zp={class:"chapter-name"},eh=Jp(()=>m("hr",null,null,-1)),th=ee({__name:"ChapterIntro",setup(e){return(t,s)=>(T(),L("div",Qp,[m("h1",null,[Z("Chapter "+U(_(C).progress.currentChapter)+": ",1),m("p",Zp,U(_(Me).name),1)]),eh,m("p",null,U(_(Me).description),1)]))}});const sh=he(th,[["__scopeId","data-v-5e4fbae2"]]);let ih=(e=21)=>crypto.getRandomValues(new Uint8Array(e)).reduce((t,s)=>(s&=63,s<36?t+=s.toString(36):s<62?t+=(s-26).toString(36).toUpperCase():s>62?t+="-":t+="_",t),"");function nh(e){const t=e.contentDocument,s=e.contentWindow;((i,n)=>{const o="div",a=["#c33","#ea4c88","#639","#06c","#690","#fc3","#f90","#963"];function r(E){return a[E%(a.length-1)]}function l(E,M,z,oe,ue,fe,ie,D){const re=t.createElement(o);return re.dataset.faceFor=D,new Map().set("position","absolute").set("transform-origin",["left","top"]).set("background",ie).set("width",`${oe}px`).set("height",`${ue}px`).set("opacity","0.8").set("transform",`translate3d(${E}px, ${M}px, ${z}px) rotateX(270deg) rotateY(${fe}deg)`).forEach((ae,de)=>re.style[de]=Array.isArray(ae)?ae.join(" "):ae),re.outerHTML}const d=.001;let h="";function u(E,M,z,oe){const ue=E.childNodes,fe=ue.length;for(let ie=0;ie<fe;ie++){const D=ue[ie];if(D.nodeType===Node.ELEMENT_NODE){const re=ih();D.dataset.uid=re,D.style.overflow="visible",D.style.transformStyle="preserve-3d",D.style.transform=`translateZ(${(i+(fe-ie)*d).toFixed(3)}px)`;let ae=z,de=oe;D.offsetParent===E&&(ae+=E.offsetLeft,de+=E.offsetTop),u(D,M+1,ae,de);const xe=(M+1)*i,ge=r(M);h+=l(ae+D.offsetLeft,de+D.offsetTop,xe,D.offsetWidth,i,0,ge,re),h+=l(ae+D.offsetLeft+D.offsetWidth,de+D.offsetTop,xe,D.offsetHeight,i,270,ge,re),h+=l(ae+D.offsetLeft,de+D.offsetTop+D.offsetHeight,xe,D.offsetWidth,i,0,ge,re),h+=l(ae+D.offsetLeft,de+D.offsetTop,xe,D.offsetHeight,i,270,ge,re)}}}const f=t.body;f.style.overflow="visible",f.style.transformStyle="preserve-3d",f.style.perspective=n.toString();const k=E=>(E/2).toFixed(2),P=`${k(s.innerWidth)}px ${k(s.innerHeight)}px`;f.style.perspectiveOrigin=P,f.style.transformOrigin=P,u(f,0,0,0),t.addEventListener("mousemove",E=>{if(!E.ctrlKey){const M=E.clientX/s.innerWidth,z=1-E.clientY/s.innerHeight,oe=120,ue=fe=>((fe-.5)*oe).toFixed(2);f.style.transform=`rotateX(${ue(z)}deg) rotateY(${ue(M)}deg)`}},!0),t.addEventListener("mouseover",E=>{if(E.ctrlKey){const M=E.target,z=M.dataset.uid||M.dataset.faceFor;M.dataset.faceFor&&Array.from(t.querySelectorAll(`[data-uid="${z}"], [data-face-for="${z}"]`)).forEach(oe=>oe.classList.add("hovered"))}}),t.addEventListener("mouseleave",E=>{t.querySelectorAll(".hovered").forEach(M=>M.classList.remove("hovered"))}),t.addEventListener("mouseout",E=>{const M=E.target,z=M.dataset.uid||M.dataset.faceFor;Array.from(t.querySelectorAll(`[data-uid="${z}"], [data-face-for="${z}"]`)).forEach(oe=>oe.classList.remove("hovered"))}),t.addEventListener("click",E=>{var z;let M=E.target;M.nodeName==="A"&&E.preventDefault(),M.dataset.faceFor&&(M=t.querySelector(`[data-uid="${M.dataset.faceFor}"]`)),M&&((z=s.top)==null||z.postMessage({event:"elementClick",tag:M.tagName.toLowerCase(),type:M.getAttribute("type")}))});const A=t.createElement(o);A.style.position="absolute",A.style.transformStyle="preserve-3d";const{marginTop:R,marginLeft:I}=getComputedStyle(f);A.style.top=`-${R}`,A.style.left=`-${I}`,A.innerHTML=h,f.appendChild(A),f.style.transition="transform 400ms ease-in-out",f.style.transform="rotateX(-22.5deg) rotateY(12.5deg)",setTimeout(()=>{f.style.transition=""},400)})(50,5e3)}const oh={},ah={id:"correct-animation"};function rh(e,t){return T(),L("div",ah," \u2714\uFE0F Correct ")}const Ls=he(oh,[["render",rh]]),ur=e=>(He("data-v-7c679098"),e=e(),Ne(),e),lh={key:0},ch=Z("Use the "),dh=ur(()=>m("b",null,"3D",-1)),ph=Z(" view and the "),hh=ur(()=>m("b",null,"Ctrl",-1)),uh=Z(" key to select elements in the DOM."),fh=[ch,dh,ph,hh,uh],gh=ee({__name:"InteractiveDOM",setup(e){const t=ce(()=>C.level),s=Oe(!1),i=Oe(null),n=Oe(!1);function o(){if(!i.value)return;const a=i.value;s.value===!0&&a.contentWindow?(a.contentWindow.location.reload(),s.value=!1):(nh(a),s.value=!0)}return hr("message",a=>{if(a.data.event==="elementClick"){const r=a.data,l=r.tag,d=C.level;if(l==null||!d.tag)return;qc(r,d)?(n.value=!0,setTimeout(()=>{n.value=!1,Zt()},600)):Ts(document.querySelector("iframe"))}}),(a,r)=>(T(),L(F,null,[m("p",{class:"order",style:tt({opacity:_(t).order&&!n.value?1:0})},U(_(t).order||"\xA0"),5),m("div",{class:ye(["game-wrapper",{win:n.value}])},[W(Ls),m("iframe",{src:"demo/chapter1.html",ref_key:"iframe",ref:i,scrolling:"no"},null,512)],2),_(t).order&&_(t).tag?(T(),L("p",lh,fh)):Te("",!0),m("button",{onClick:o,id:"button-3d"},U(s.value?"2D":"3D"),1)],64))}});const mh=he(gh,[["__scopeId","data-v-7c679098"]]);var St,Ns,gs=typeof Map=="function"?new Map:(St=[],Ns=[],{has:function(e){return St.indexOf(e)>-1},get:function(e){return Ns[St.indexOf(e)]},set:function(e,t){St.indexOf(e)===-1&&(St.push(e),Ns.push(t))},delete:function(e){var t=St.indexOf(e);t>-1&&(St.splice(t,1),Ns.splice(t,1))}}),fr=function(e){return new Event(e,{bubbles:!0})};try{new Event("test")}catch{fr=function(t){var s=document.createEvent("Event");return s.initEvent(t,!0,!1),s}}function bh(e){var t=gs.get(e);t&&t.destroy()}function yh(e){var t=gs.get(e);t&&t.update()}var ls=null;typeof window>"u"||typeof window.getComputedStyle!="function"?((ls=function(e){return e}).destroy=function(e){return e},ls.update=function(e){return e}):((ls=function(e,t){return e&&Array.prototype.forEach.call(e.length?e:[e],function(s){return function(i){if(i&&i.nodeName&&i.nodeName==="TEXTAREA"&&!gs.has(i)){var n,o=null,a=null,r=null,l=function(){i.clientWidth!==a&&f()},d=function(k){window.removeEventListener("resize",l,!1),i.removeEventListener("input",f,!1),i.removeEventListener("keyup",f,!1),i.removeEventListener("autosize:destroy",d,!1),i.removeEventListener("autosize:update",f,!1),Object.keys(k).forEach(function(P){i.style[P]=k[P]}),gs.delete(i)}.bind(i,{height:i.style.height,resize:i.style.resize,overflowY:i.style.overflowY,overflowX:i.style.overflowX,wordWrap:i.style.wordWrap});i.addEventListener("autosize:destroy",d,!1),"onpropertychange"in i&&"oninput"in i&&i.addEventListener("keyup",f,!1),window.addEventListener("resize",l,!1),i.addEventListener("input",f,!1),i.addEventListener("autosize:update",f,!1),i.style.overflowX="hidden",i.style.wordWrap="break-word",gs.set(i,{destroy:d,update:f}),(n=window.getComputedStyle(i,null)).resize==="vertical"?i.style.resize="none":n.resize==="both"&&(i.style.resize="horizontal"),o=n.boxSizing==="content-box"?-(parseFloat(n.paddingTop)+parseFloat(n.paddingBottom)):parseFloat(n.borderTopWidth)+parseFloat(n.borderBottomWidth),isNaN(o)&&(o=0),f()}function h(k){var P=i.style.width;i.style.width="0px",i.style.width=P,i.style.overflowY=k}function u(){if(i.scrollHeight!==0){var k=function(A){for(var R=[];A&&A.parentNode&&A.parentNode instanceof Element;)A.parentNode.scrollTop&&R.push({node:A.parentNode,scrollTop:A.parentNode.scrollTop}),A=A.parentNode;return R}(i),P=document.documentElement&&document.documentElement.scrollTop;i.style.height="",i.style.height=i.scrollHeight+o+"px",a=i.clientWidth,k.forEach(function(A){A.node.scrollTop=A.scrollTop}),P&&(document.documentElement.scrollTop=P)}}function f(){u();var k=Math.round(parseFloat(i.style.height)),P=window.getComputedStyle(i,null),A=P.boxSizing==="content-box"?Math.round(parseFloat(P.height)):i.offsetHeight;if(A<k?P.overflowY==="hidden"&&(h("scroll"),u(),A=P.boxSizing==="content-box"?Math.round(parseFloat(window.getComputedStyle(i,null).height)):i.offsetHeight):P.overflowY!=="hidden"&&(h("hidden"),u(),A=P.boxSizing==="content-box"?Math.round(parseFloat(window.getComputedStyle(i,null).height)):i.offsetHeight),r!==A){r=A;var R=fr("autosize:resized");try{i.dispatchEvent(R)}catch{}}}}(s)}),e}).destroy=function(e){return e&&Array.prototype.forEach.call(e.length?e:[e],bh),e},ls.update=function(e){return e&&Array.prototype.forEach.call(e.length?e:[e],yh),e});var vh=ls;const wh={class:"input-header"},xh={key:0,class:"file-name"},_h={class:"file-window"},kh={class:"line-numbers"},Th=m("br",null,null,-1),on=ee({__name:"EditorPane",props:{title:String,fileName:{type:String,required:!1},lang:String,nbLines:{type:Number,default:20}},setup(e){return(t,s)=>(T(),L("div",{class:ye(["editor-pane",e.lang+"-view"])},[m("div",wh,[e.fileName?(T(),L("div",xh,U(e.fileName),1)):Te("",!0),Z(" "+U(e.title),1)]),m("div",_h,[m("div",kh,[(T(!0),L(F,null,Pe(e.nbLines,i=>(T(),L(F,null,[Z(U(i),1),Th],64))),256))]),vt(t.$slots,"default")])],2))}});const $h={class:"markup"},gr=ee({__name:"HTMLMarkup",props:{markup:String},setup(e){const t=e,s=Oe(null);ba(i),bt(()=>t.markup,i);function i(){var a;const o=document.createElement("div");o.innerHTML=(a=t.markup)!=null?a:"",s.value&&(s.value.innerHTML=n(o,!0).innerHTML)}function n(o,a){if(o instanceof HTMLElement){const r=document.createElement("div"),l=o.tagName.toLowerCase(),d=o.getAttributeNames().map(u=>`${u}="${o.getAttribute(u)}"`).join(" "),h=Array.from(o.childNodes);return h.length>0?(a||(r.textContent=`<${l}${d?" "+d:""}>`),h.forEach(u=>r.appendChild(n(u,!1))),a||r.appendChild(document.createTextNode(`</${l}>`))):r.textContent=`<${l}${d?" "+d:""} />`,r}else{const r=document.createElement("span");return r.textContent=o.textContent,r}}return(o,a)=>(T(),L("div",$h,[m("div",{ref_key:"container",ref:s},null,512)]))}});function mr(e){var r,l,d,h;const t=C.level;if(!t)return;const s=t.wrapperClass||Me.value.wrapperClass,i=s?`.${s}`:"",n=new Set([t.selector,...Object.keys((r=t.cssRules)!=null?r:{}),...Object.keys((l=t.cssRulesHidden)!=null?l:{})]);let o="";for(let u of n)o+=`
${i} ${u} {
...
${i} ${t.selector} {
  ${e.join(`
`)}
}`);const a=document.getElementById("css-editor-stylesheet");a.innerHTML=o}function br(e){const t=C.level;fs();const s=document.querySelector(".game-wrapper"),i=Array.from(s.querySelectorAll(t.selector));mr(e),Ch(e,t)?(s.classList.add("win"),i.forEach(o=>{o.classList.remove("strobe")}),setTimeout(function(){s.classList.remove("win"),Zt()},1500)):i.forEach(o=>{o.classList.remove("strobe"),Ts(document.querySelector(".table-content"))})}function No(e){return typeof e!="string"?e:e.replaceAll(/,\s+/g,",").replaceAll(/\s*\/\s*/g,"/").replaceAll(/'/g,'"').replace(/;$/,"").toLowerCase().trim()}function Ch(e,t){if(!t.check)return!0;const s=Object.fromEntries(e.map(i=>[i.split(":")[0],i.split(":")[1]]).map(([i,n])=>[i.trim(),No(n)]));return t.check.every(([i,...n])=>{const o=s[i];return n.some(a=>(a=No(a),typeof o=="string"&&o===a||typeof a=="function"&&a(o)?!0:(console.log(`Expected ${i} to be ${a}, got ${o}`),!1)))})}const Sh=e=>(He("data-v-9fa49e2e"),e=e(),Ne(),e),Ph=["onKeydown","onKeyup","placeholder"],Lh=Sh(()=>m("span",{class:"plus"},"+",-1)),Ah=ee({__name:"Editor",props:{placeholder:String},emits:["input"],setup(e,{emit:t}){const s=Oe(null),i=Oe(null),n=Oe(""),o=ce(()=>C.level);bt(o,()=>{var d,h;n.value=(h=(d=C.progress.inputs[C.progress.currentChapter])==null?void 0:d[C.progress.currentLevel])!=null?h:"",at(()=>{var u;return(u=i.value)==null?void 0:u.focus()}),mr(n.value.split(`
`))},{immediate:!0});const a=ce(()=>o.value.inputLinesNumber&&o.value.inputLinesNumber>1?`CSS Editor (${o.value.inputLinesNumber} properties to set)`:"CSS Editor");bt(i,()=>vh(i.value));function r(d){var u;const h=n.value.split(`
`).map(f=>f.trim()).map(f=>Me.value===lr||f.endsWith(";")?f:f+";");if(h.length>=((u=o.value.inputLinesNumber)!=null?u:1)){d.preventDefault();const f=s.value;f.classList.remove("enterhit"),setTimeout(()=>f.classList.add("enterhit"),0)}n.value&&(n.value=h.join(`
`)),t("input",h),gp(n.value)}function l(){i.value.classList.toggle("input-strobe",n.value.length>0)}return(d,h)=>(T(),L("div",{class:"editor",onClick:h[1]||(h[1]=u=>{var f;return(f=i.value)==null?void 0:f.focus()})},[W(on,{title:_(a),fileName:"style.css",lang:"css"},{default:Le(()=>[vt(d.$slots,"code-before",{},void 0,!0),zl(m("textarea",{id:"editor-input",class:"input-strobe",ref_key:"inputElement",ref:i,onKeydown:Na(r,["enter"]),onKeyup:Vs(l,["prevent"]),placeholder:e.placeholder,"onUpdate:modelValue":h[0]||(h[0]=u=>n.value=u)},null,40,Ph),[[Hc,n.value]]),Lh,m("div",{class:"enter-button",onClick:r,ref_key:"enterButton",ref:s},"enter",512),vt(d.$slots,"code-after",{},void 0,!0)]),_:3},8,["title"]),W(on,{title:"HTML Viewer",fileName:"table.html",lang:"html"},{default:Le(()=>[W(gr,{markup:_(o).markup},null,8,["markup"])]),_:1})]))}});const An=he(Ah,[["__scopeId","data-v-9fa49e2e"]]),Rh={name:"Table",props:["content","hintContent"]};const yr=e=>(He("data-v-1e2c3b82"),e=e(),Ne(),e),Ih={class:"table-wrapper"},Oh={class:"table-surface",ref:"surface"},Eh={class:"table-content"},Mh=["innerHTML"],Hh=["innerHTML"],Nh={key:2,ref:"board",class:"table"},jh={class:"table-edge",ref:"edge"},Fh=yr(()=>m("div",{class:"table-leg"},null,-1)),zh=yr(()=>m("div",{class:"table-leg"},null,-1)),Bh=[Fh,zh];function Dh(e,t,s,i,n,o){return T(),L("div",Ih,[m("div",Oh,null,512),m("div",Eh,[s.hintContent?(T(),L("div",{key:0,class:"hint-content",innerHTML:s.hintContent},null,8,Mh)):Te("",!0),s.content?(T(),L("div",{key:1,innerHTML:s.content,ref:"board",class:"table"},null,8,Hh)):(T(),L("div",Nh,[vt(e.$slots,"default",{},void 0,!0)],512))]),m("div",jh,Bh,512)])}const Rn=he(Rh,[["render",Dh],["__scopeId","data-v-1e2c3b82"]]),In=e=>(He("data-v-43ba39a3"),e=e(),Ne(),e),qh={class:"order"},Wh={class:"game-container"},Uh={class:"game-wrapper"},Yh=In(()=>m("br",null,null,-1)),Kh=Z("{"),Vh=In(()=>m("br",null,null,-1)),Gh=Z(" /* Styles would go here. */"),Xh=In(()=>m("br",null,null,-1)),Jh=Z(" } "),Qh=ee({__name:"SelectorGame",setup(e){const t=ce(()=>C.level);function s(n){const o=C.level;fs();const a=document.querySelector(".table-content"),r=document.querySelector(".game-wrapper");try{a.querySelectorAll(n)}catch{n=""}const l=n?Array.from(a.querySelectorAll(n)):[],d=Array.from(a.querySelectorAll(o.selector));let h=!1;l.length==0&&Ts(document.querySelector(".editor")),l.length===d.length&&l.length>0&&(h=i(l,d)),h?(r.classList.add("win"),l.forEach(u=>{u.classList.remove("strobe"),u.classList.add("clean")}),setTimeout(function(){r.classList.remove("win"),fs(),Zt()},1e3)):(l.forEach(u=>{u.classList.remove("strobe"),Ts(u)}),setTimeout(function(){fs(),d.forEach(u=>{u.classList.add("strobe")})},500))}function i(n,o){return n.length===o.length&&n.every(a=>o.includes(a))}return(n,o)=>(T(),L(F,null,[m("p",qh,U(_(t).doThis),1),m("div",Wh,[m("div",Uh,[W(Ls),W(Rn,{content:_(t).markup,class:ye(_(t).wrapperClass||_(Me).wrapperClass)},null,8,["content","class"])])]),W(An,{placeholder:"Type in a CSS selector",onInput:o[0]||(o[0]=a=>s(a[0]))},{"code-after":Le(()=>[Yh,Kh,Vh,Gh,Xh,Jh]),_:1})],64))}});const Zh=he(Qh,[["__scopeId","data-v-43ba39a3"]]),eu={class:"customer-wrapper"},tu={class:"customer-speech-bubble"},su={class:"customer-body"},iu={class:"code"},nu=ee({__name:"Customer",props:{request:String,selector:String,meal:String},setup(e){return(t,s)=>(T(),L("div",eu,[m("div",tu,U(e.request),1),m("div",su,[m("div",iu,[m("pre",null,U(e.selector)+` {\r
  meal: `+U(e.meal)+`;\r
}`,1)])])]))}});const ou=he(nu,[["__scopeId","data-v-c1c4318a"]]),au={class:"game-container"},ru={class:"game-wrapper"},lu={class:"customers"},cu={class:"editor"},du=ee({__name:"SpecificityGame",setup(e){const t=ce(()=>C.level);function s(r){const l=r.target.closest("plate");l&&n(l)}const i=["sushi","toast","apple","pickle"];function n(r){var h,u;const l=r.firstChild,d=i[i.indexOf((u=(h=l==null?void 0:l.tagName)==null?void 0:h.toLowerCase())!=null?u:"soup")+1]||"sushi";l==null?r.appendChild(document.createElement(d)):r.replaceChild(document.createElement(d),l)}const o=Oe(null);function a(){const l=[...o.value.$el.querySelectorAll("plate")].map(d=>d.firstElementChild?d.firstElementChild.tagName.toLowerCase():"");mp(l)}return(r,l)=>(T(),L("div",au,[m("div",ru,[W(Ls),W(Rn,{content:_(t).markup,onClick:s,ref_key:"table",ref:o},null,8,["content"]),m("div",{class:"actions"},[m("button",{onClick:a,id:"submit-button"},"Validate")]),m("div",lu,[(T(!0),L(F,null,Pe(_(t).customers,d=>(T(),Ge(ou,Fo(Tn(d)),null,16))),256))]),m("div",cu,[W(on,{title:"HTML Viewer",fileName:"table.html",lang:"html"},{default:Le(()=>[W(gr,{markup:_(t).markup},null,8,["markup"])]),_:1})])])]))}});const pu=he(du,[["__scopeId","data-v-00d68f52"]]),jt=e=>(He("data-v-4ea136c9"),e=e(),Ne(),e),hu={class:"order"},uu={class:"game-container"},fu={class:"game-wrapper"},gu=jt(()=>m("br",null,null,-1)),mu=jt(()=>m("br",null,null,-1)),bu=Z(" }"),yu=jt(()=>m("br",null,null,-1)),vu=jt(()=>m("br",null,null,-1)),wu=jt(()=>m("br",null,null,-1)),xu=jt(()=>m("br",null,null,-1)),_u=jt(()=>m("br",null,null,-1)),ku=Z("} "),Tu=ee({__name:"LayoutGame",setup(e){const t=ce(()=>C.level),s=ce(()=>{var n;return Object.fromEntries(Object.entries((n=t.value.cssRules)!=null?n:{}).filter(([o])=>o!==t.value.selector))}),i=n=>t.value.cssRules?t.value.cssRules[n]||[]:[];return(n,o)=>(T(),L(F,null,[m("p",hu,U(_(t).doThis),1),m("div",uu,[m("div",fu,[W(Ls),(T(),Ge(Rn,{content:_(t).markup,hintContent:_(t).hintMarkup,key:_(t).name,class:ye(_(t).wrapperClass||_(Me).wrapperClass)},null,8,["content","hintContent","class"]))])]),W(An,{placeholder:"Type styles here",onInput:o[0]||(o[0]=a=>_(br)(a))},{"code-before":Le(()=>[(T(!0),L(F,null,Pe(_(s),(a,r)=>(T(),L(F,{key:"selector_"+r},[Z(U(r)+" {",1),gu,(T(!0),L(F,null,Pe(a,l=>(T(),L(F,{key:r+"_"+l},[Z("\xA0\xA0"+U(l)+";",1),mu],64))),128)),bu,yu,vu],64))),128)),Z(" "+U(_(t).selector)+" {",1),wu,(T(!0),L(F,null,Pe(i(_(t).selector),a=>(T(),L(F,{key:_(t).selector+"_"+a},[Z("\xA0\xA0"+U(a)+";",1),xu],64))),128))]),"code-after":Le(()=>[_u,ku]),_:1})],64))}});const $u=he(Tu,[["__scopeId","data-v-4ea136c9"]]),ct=e=>(He("data-v-4691c48a"),e=e(),Ne(),e),Cu={class:"order"},Su={class:"game-container"},Pu={class:"game-wrapper"},Lu=["innerHTML"],Au={class:"expected-result"},Ru=ct(()=>m("p",null,"Expected result:",-1)),Iu=["src"],Ou=["href"],Eu=["href"],Mu=ct(()=>m("br",null,null,-1)),Hu={key:0},Nu=ct(()=>m("br",null,null,-1)),ju=ct(()=>m("br",null,null,-1)),Fu=Z(" }"),zu=ct(()=>m("br",null,null,-1)),Bu=ct(()=>m("br",null,null,-1)),Du=ct(()=>m("br",null,null,-1)),qu=ct(()=>m("br",null,null,-1)),Wu=ct(()=>m("br",null,null,-1)),Uu=Z("} "),Yu=ee({__name:"ReproduceGame",setup(e){const t=ce(()=>C.level),s=ce(()=>{var a;return Object.fromEntries(Object.entries((a=t.value.cssRules)!=null?a:{}).filter(([r])=>r!==t.value.selector))}),i=ce(()=>t.value.cssImports),n=ce(()=>t.value.cssImportsHidden),o=Oe("");return bt(()=>t,()=>{o.value="",at(()=>{var a;o.value=(a=t.value.markup)!=null?a:""})}),(a,r)=>(T(),L(F,null,[m("p",Cu,U(_(t).doThis),1),m("div",Su,[m("div",Pu,[W(Ls),m("div",{class:ye(["game-content",_(t).wrapperClass||_(Me).wrapperClass]),innerHTML:_(t).markup},null,10,Lu),m("div",Au,[Ru,m("img",{src:_(t).expectedScreenshot},null,8,Iu)])])]),W(An,{placeholder:"Type styles here",onInput:r[0]||(r[0]=l=>_(br)(l))},{"code-before":Le(()=>{var l,d;return[(T(!0),L(F,null,Pe(_(n),h=>(T(),L("link",{rel:"stylesheet",href:h},null,8,Ou))),256)),(T(!0),L(F,null,Pe(_(i),h=>(T(),L("link",{rel:"stylesheet",href:h},null,8,Eu))),256)),(T(!0),L(F,null,Pe(_(i),h=>(T(),L(F,null,[Z('@import "'+U(h)+'";',1),Mu],64))),256)),_(i)?(T(),L("br",Hu)):Te("",!0),(T(!0),L(F,null,Pe(_(s),(h,u)=>(T(),L(F,{key:"selector_"+u},[Z(U(u)+" {",1),Nu,(T(!0),L(F,null,Pe(h,f=>(T(),L(F,{key:u+"_"+f},[Z("\xA0\xA0"+U(f)+";",1),ju],64))),128)),Fu,zu,Bu],64))),128)),Z(" "+U(_(t).selector)+" {",1),Du,(T(!0),L(F,null,Pe((d=((l=_(t).cssRules)!=null?l:{})[_(t).selector])!=null?d:[],h=>(T(),L(F,{key:_(t).selector+"_"+h},[Z("\xA0\xA0"+U(h)+";",1),qu],64))),128))]}),"code-after":Le(()=>[Wu,Uu]),_:1})],64))}});const Ku=he(Yu,[["__scopeId","data-v-4691c48a"]]),Vu={class:"left-col"},Gu={class:"left-panel"},Xu=ee({__name:"LeftCol",setup(e){const t=ce(()=>{if(C.progress.currentLevel===0)return sh;switch(C.progress.currentChapter){case 1:return mh;case 2:return Zh;case 3:return pu;case 4:case 5:case 6:return $u;case 7:case 8:return Ku}});return(s,i)=>(T(),L("div",Vu,[W(Xp),m("div",Gu,[(T(),Ge(wa(_(t))))]),W(qp)]))}});const Ju=he(Xu,[["__scopeId","data-v-12bae500"]]),Qu={class:"chapter-header"},Zu=ee({__name:"ChapterHeader",setup(e){const t=ce(()=>et[C.progress.currentChapter-1]);return(s,i)=>(T(),L("h1",Qu,"Chapter "+U(_(C).progress.currentChapter)+": "+U(_(t).name),1))}});const ef=he(Zu,[["__scopeId","data-v-e62a0f1e"]]),tf={class:"level-text"},sf={key:0,class:"checkmark"},nf={class:"level-nav"},of={key:1,class:"level-progress"},af=ee({__name:"LevelHeader",setup(e){const t=ce(()=>Me.value.levels),s=ce(()=>Ln(C.progress.currentChapter,C.progress.currentLevel));function i(n="next",o){const a=o.target;a.classList.add("link-jiggle"),setTimeout(()=>{a.classList.remove("link-jiggle")},1e3),n==="next"?Ht(C.progress.currentChapter,C.progress.currentLevel+1):Ht(C.progress.currentChapter,C.progress.currentLevel-1)}return(n,o)=>(T(),L(F,null,[_(C).progress.currentLevel>0?(T(),L("h2",{key:0,class:ye(["level-header",{completed:_(s)}])},[m("span",tf," Level "+U(_(C).progress.currentLevel)+" of "+U(_(t).length),1),_(s)?(T(),L("span",sf,"\u2714\uFE0F")):Te("",!0)],2)):Te("",!0),m("div",nf,[m("a",{class:"previous",href:"#",onClick:o[0]||(o[0]=Vs(a=>i("previous",a),["prevent"]))}),m("a",{class:"next",href:"#",onClick:o[1]||(o[1]=Vs(a=>i("next",a),["prevent"]))})]),_(C).progress.currentLevel>0?(T(),L("div",of,[m("div",{class:"progress",style:tt({width:_(up)(_(C).progress.currentChapter)+"%"})},null,4)])):Te("",!0)],64))}});const rf=he(af,[["__scopeId","data-v-80b5bec5"]]),wi=e=>(He("data-v-01318d24"),e=e(),Ne(),e),lf={class:"level-menu"},cf=wi(()=>m("h2",null,"Choose a level",-1)),df={class:"chapters-list"},pf={class:"chapters"},hf=["onClick"],uf={class:"chapter-number"},ff=wi(()=>m("div",{class:"chapter-toggle"},null,-1)),gf={key:0,class:"levels"},mf=["onClick"],bf=wi(()=>m("span",{class:"checkmark"},"\u2714\uFE0F",-1)),yf={class:"level-number"},vf=wi(()=>m("div",{class:"level-menu-toggle"},null,-1)),wf=[vf],xf=ee({__name:"LevelMenu",setup(e){const t=Oe(C.progress.currentChapter);function s(n){n===t.value?t.value=0:t.value=n}function i(){C.menuOpened=!C.menuOpened}return(n,o)=>(T(),L(F,null,[m("div",lf,[cf,m("div",df,[m("ul",pf,[(T(!0),L(F,null,Pe(_(et),(a,r)=>(T(),L("li",{key:"chapter_"+a.name},[m("a",{class:ye([{current:r+1===_(C).progress.currentChapter,opened:r+1===t.value},"chapter-name"]),onClick:l=>s(r+1)},[m("span",uf,U(r+1),1),Z(" "+U(a.name)+" ",1),ff],10,hf),r+1===t.value?(T(),L("ul",gf,[(T(!0),L(F,null,Pe(a.levels,(l,d)=>(T(),L("li",{key:"level_"+l.name},[m("a",{class:ye({current:d+1===_(C).progress.currentLevel,completed:_(Ln)(r+1,d+1)}),onClick:h=>_(Ht)(r+1,d+1)},[bf,m("span",yf,U(d+1),1),Z(" "+U(l.name),1)],10,mf)]))),128))])):Te("",!0)]))),128))])]),m("a",{class:"reset-progress",href:"#",onClick:o[0]||(o[0]=Vs((...a)=>_(tn)&&_(tn)(...a),["prevent"]))},"Reset Progress")]),m("div",{class:"level-menu-toggle-wrapper",onClick:i},wf)],64))}});const _f=he(xf,[["__scopeId","data-v-01318d24"]]),kf=e=>(He("data-v-d12db1bc"),e=e(),Ne(),e),Tf=kf(()=>m("hr",null,null,-1)),$f={class:"instructions"},Cf=["innerHTML"],Sf=ee({__name:"ChapterInstructions",setup(e){function t(){Ht(C.progress.currentChapter,1)}return(s,i)=>(T(),L(F,null,[Tf,m("div",$f,[m("div",{innerHTML:_(Me).intro},null,8,Cf)]),m("div",{class:"actions"},[m("button",{onClick:t},"Next")])],64))}});const Pf=he(Sf,[["__scopeId","data-v-d12db1bc"]]),Lf=e=>(He("data-v-ae17a712"),e=e(),Ne(),e),Af={class:"instructions"},Rf=["innerHTML"],If=Lf(()=>m("hr",null,null,-1)),Of={class:"title"},Ef=["innerHTML"],Mf={class:"actions"},Hf=ee({__name:"LevelInstructions",setup(e){const t=ce(()=>C.level);return(s,i)=>(T(),L(F,null,[m("div",Af,[_(Me).instructions?(T(),L(F,{key:0},[m("div",{innerHTML:_(Me).instructions},null,8,Rf),If],64)):Te("",!0),m("h3",Of,U(_(t).name),1),m("div",{innerHTML:_(C).level.instructions},null,8,Ef)]),m("div",Mf,[_(t).skippable?(T(),L("button",{key:0,onClick:i[0]||(i[0]=(...n)=>_(Zt)&&_(Zt)(...n))},"Next")):Te("",!0)])],64))}});const Nf=he(Hf,[["__scopeId","data-v-ae17a712"]]),jf={class:"display-help"},Ff={class:"title"},zf={key:0,class:"syntax"},Bf=["innerHTML"],Df={key:1,class:"examples-title"},qf={class:"examples"},Wf=["innerHTML"],Uf=ee({__name:"SyntaxLevelInstructions",setup(e){const t=ce(()=>C.level);return(s,i)=>(T(),L("div",jf,[m("h3",Ff,U(_(t).helpTitle||_(t).name),1),_(t).syntax?(T(),L("p",zf,[m("pre",null,U(_(t).syntax),1)])):Te("",!0),m("div",{class:"hint",innerHTML:_(t).help},null,8,Bf),_(t).examples&&_(t).examples.length>0?(T(),L("h4",Df,"Examples")):Te("",!0),m("div",qf,[(T(!0),L(F,null,Pe(_(t).examples,n=>(T(),L("div",{class:"example",key:n,innerHTML:n},null,8,Wf))),128))])]))}});const Yf=he(Uf,[["__scopeId","data-v-cf836146"]]),Kf={class:"doc-wrapper"},Vf=ee({__name:"RightCol",setup(e){const t=ce(()=>{if(C.progress.currentLevel===0)return Pf;switch(C.progress.currentChapter){case 2:case 4:case 5:case 6:case 7:case 8:return Yf;case 1:case 3:default:return Nf}});return(s,i)=>(T(),L("div",{class:ye(["right-col",{"menu-open":_(C).menuOpened}])},[m("div",Kf,[W(ef),W(rf),(T(),Ge(wa(_(t))))]),W(_f)],2))}});const Gf=he(Vf,[["__scopeId","data-v-f319e6bc"]]),Xf=ee({__name:"App",setup(e){return Oi("Escape",t=>{t.preventDefault(),cr()}),Oi("PageUp",t=>{t.preventDefault(),Ht(C.progress.currentChapter,C.progress.currentLevel-1)}),Oi("PageDown",t=>{t.preventDefault(),Ht(C.progress.currentChapter,C.progress.currentLevel+1)}),fp(),dr(),(t,s)=>(T(),L(F,null,[W(Ju),W(Gf)],64))}});ja(Xf).use(cp).mount("#app");
