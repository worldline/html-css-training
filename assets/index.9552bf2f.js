...
<plate></plate>
    ...
    <p>To help you, here is a <a target="_blank" href="img/specifishity.png">cheat sheet on specificity explained with fish</a>.</p>`,levels:rp,onLevelStart(){Je(()=>$s())}};function ts(e){var a,l,r,d;const t=P.level;if(!t)return;const s=Me.value.wrapperClass?`.${Me.value.wrapperClass}`:"",i=new Set([t.selector,...Object.keys((a=t.cssRules)!=null?a:{}),...Object.keys((l=t.cssRulesHidden)!=null?l:{})]);let n="";for(let h of i)n+=`
${s} ${h} {
